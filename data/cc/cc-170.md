...
As soon as the >28 dayer looks ill - all bets are OFF and need a full septic workup with empiric antibiotics {that’s the textbook Point, anyway}
...
### 1. Provide a differential diagnosis for fever (review Point)
