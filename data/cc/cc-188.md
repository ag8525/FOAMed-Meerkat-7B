...
Point: An EMS medical director is a physician with a specialized interest and knowledge of patient care activities unique to the out-of-hospital environment. Medical oversight must extend from the communications centre through all components of field care.
...
Point: This is a complex decision. Largely, you need to make a decision based on a number of factors. These factors are discussed below.
