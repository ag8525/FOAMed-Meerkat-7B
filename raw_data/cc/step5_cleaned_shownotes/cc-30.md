---
title: "CrackCast Episode 30: GI Bleeding"
url: "https://canadiem.org/crackcast/"
date: 2016-06
source: "CanadiEM – CrackCast"
original_file: Ch.30 GIB.pdf
summary: |
  Gastrointestinal bleeding (GIB) is a significant clinical concern, with over a million admissions annually in the US. It is classified anatomically into upper (UGIB) and lower (LGIB) based on the location relative to the ligament of Treitz, with UGIB having a higher mortality rate. Key risk factors include medication use (e.g., NSAIDs, anticoagulants), history of peptic ulcer disease, liver disease, and advanced age. UGIB often presents with hematemesis and melena, while LGIB presents with hematochezia. Management of severe UGIB involves stabilization, including airway protection, volume resuscitation, and potentially endoscopic intervention. The Blakemore tube is a critical tool for managing variceal bleeding, requiring careful insertion and monitoring. Low-risk criteria for discharge include stable vitals, normal lab results, and good support systems. The Rockall and Glasgow-Blatchford scores are used to assess the severity and guide management. False positives in stool guaiac tests can occur due to dietary factors and certain medications.
...
- More than 1 million admissions in the US per year.
...
Above the ligament of Treitz (distal duodenum) is upper gastrointestinal bleed (UGIB) with a mortality rate of 12-14%. Below the ligament of Treitz is lower gastrointestinal bleed (LGIB) with a mortality rate of 4%.
...
See [emcrit.org](http://emcrit.org/procedures/blakemore-tube-placement/)

How to Do it:
1. Patient should be intubated and the head of the bed up at 45 degrees.
2. Test balloons on Blakemore and fully deflate. Mark Salem sump at the 50 cm mark of the Blakemore with the tip 2 cm above the gastric balloon and then 2 cm above the esophageal balloon.
...
4. Stop at 50 cm. Test with slip syringe while auscultating over the stomach and lungs. Inflate gastric port with 50 ml of air or saline.
5. Get a chest x-ray to confirm placement of the gastric balloon in the stomach.
6. Inflate with an additional 200 ml of air (250 ml total).
...
10. If bleeding continues, you will need to inflate the esophageal balloon.
...
- [emcrit.org](http://emcrit.org/procedures/blakemore-tube-placement/)
```