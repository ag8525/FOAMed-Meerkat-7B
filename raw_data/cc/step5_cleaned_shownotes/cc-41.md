---
title: "CrackCast Episode 186: Head Trauma"
url: "https://canadiem.org/crackcast/"
date: 2016-09
source: "CanadiEM – CrackCast"
original_file: "Ch.41 Head Trauma.pdf"
summary: |
  The document provides a comprehensive overview of head trauma, focusing on traumatic brain injuries (TBI) and their management. It discusses the anatomy and physiology of the scalp and cranium, emphasizing the importance of recognizing primary and secondary brain injuries. Key management strategies for TBI include maintaining adequate cerebral perfusion pressure, preventing secondary systemic insults such as hypotension and hypoxia, and using interventions like hyperventilation and osmotic agents to manage increased intracranial pressure. The document also outlines the Canadian CT Head Rule and New Orleans CT Head Rule for assessing the need for CT imaging in minor head trauma. Additionally, it covers the management of concussions, including the risks of second impact syndrome and the importance of return-to-play protocols. Critical complications such as seizures, CNS infections, and medical complications like DIC and cardiac dysfunction are highlighted, along with the indications for seizure prophylaxis and antibiotic use in TBI. The document concludes with a discussion on the clinical features of basal skull fractures and CT imaging tips for differentiating between subdural and epidural hematomas.
...
- Scalp and Cranium: “SCALP MAP”
  - Scalp components:
    ...
    - Subcutaneous tissue: hair follicles, and BLOOD supply
    - Galea: tough fascia
...
- Primary and secondary brain injuries:
  - Primary:
    - Mechanical damage occurring at the time of head trauma -- brain lacerations, hemorrhages, contusions, tissue avulsions.
    ...
    - Only interventions: able to evacuate traumatic hematomas and reverse these injuries
      - Goal should be to promote primary prevention (avoid crashes, stop violence, prevent falls)
  - Secondary
...
2. Hypoxia
   ...
   - Due to:
     ...
     - Ineffective airway management (poor BVM, poor intubation)
...
- Congestive brain swelling
  - Increased intracranial blood volume due to hyperemia caused by vasodilation needed to maintain increased metabolic needs of damaged brain tissue
- Cerebral edema
...
- Consciousness (awareness of SELF and the Environment) requires a functioning RAS and cerebral cortices.
- Etiologic factors:
  - Hypoxia
  - Hypoglycemia
  - Post-seizure
...
### 2) List five herniation syndromes.

#### Herniation Types

First three are all transtentorial herniation types

- Think of the Cartesian plane, these things shift the cerebrum <÷> or ^ or front-back
...
4. Cerebellar-Tonsillar herniation
   ...
   - Signs:
     - Sudden respiratory / cardio collapse, pinpoint pupils, flaccid quadriplegia (corticospinal tracts are compressed)
...
- Signs: anisocoria, ptosis, impaired EOMs, sluggish pupil on the ipsilateral side
  ...
  - CONTRALATERAL: positive Babinski’s sign (upward going big toe and outward fanning of the other toes)
    - Contra-lateral hemiparesis
    - Then may progress to bilateral decerebrate posturing
...
### 3) Describe the effect on cerebral blood flow in relationship to the following parameters: PO2, PCO2, MAP, and ICP.
...
- Cerebral vasoCONstriction:
  - Hypertension, alkalosis, hypocarbia
    - This is why we hyperventilate coning or severely head-injured patients showing signs of brain herniation -- to vasoconstrict (pg. 341) -- 1 mmHg of CO2 change can decrease cerebral diameter by 2-3%
...
### 4) The CT head rules for MINOR head trauma
...
- Is a complicated minor TBI
  - Commonly Occurring in collision sports
  ...
  - Functional PET scanning is the only imaging that shows signs of damage
- Post-concussive syndrome
  ...
  - People with dizziness, headache, and nausea early after head trauma may have a 50% chance of having symptoms at 6 months
...
GCS<8 or intra-cranial contusion/hematoma by CT

Out of hospital care:

- Necessary airway mgmt and IV access to treat hypotension and hypoxia
  - There is a risk-benefit debate in the literature about the safety of out of hospital intubation - requires good protocols and training to do safely
- Neuro exam
- Treatment of scalp bleeding
- Sedatives/paralytics for agitated patients

Notes:

- 10% of TBI’s in the ED are severe
- 25% of these need neuroSx
- ***initial GCS or CT does NOT reliably predict prognosis**
  - Depends on:
  - Age, combx, initial motor activity, pupil response, secondary insults
- 35% mortality rate

Emergency department care:

- Airway
  - Pre-intubation neuroexam: and then RSI +/- lidocaine
- Ancillary evaluation:

Hypotension

- Identify the cause**
  - Bleeding, high spinal cord injury (hypotension despite fluids and inappropriate bradycardia)
- Keep systolic BP > 90 mmHg
- No consistent benefit from hypertonic saline

Hyperventilation

- An acute life-saving intervention. Goal is to get PCO2 to 30-35 mmHg. Causes vasoconstriction - onset 30 seconds and peaks at 8 mins. SHOULD NOT be used flippantly or prolongedly

Osmotic agents

- Mannitol (0.25 - 1 g/kg) - mixed evidence. Draws tissue water into the vascular space -- to reduce brain volume/edema. Peak effect in 60 mins
  - Reserve for lifesaving situations - or rapidly deteriorating neuro exam.
  - Helpful in hypotension and may help CBF by reduced blood viscosity and resistance
- Hypertonic saline: reduces ICP, but can cause other complications (renal failure, rebound ICP increase)
  - Variable evidence for and against it...

Barbiturates

- Used to “reduce cerebral metabolic demands of injured brain tissue”
- Rarely used in the ED...Pentobarbital may be used in ICU?

Steroids

- NO benefit to giving steroids in head injury
- Show INCREASED mortality

Hypothermia

- Inconclusive evidence: no clear benefit for improving morbidity or mortality in for mod/severe TBI
- Some studies show promising results...but are underway still...as of 2016..

Cranial decompression

- For those with signs of herniation, who don’t respond to other means of decreasing ICP.
- Emergency trephination/burr holes: for people who “talk then deteriorate” *
- Emergency decompressive craniectomy: must be done EARLY

Seizure prophylaxis

- Post-traumatic seizures (12% blunt trauma, 50% in penetrating trauma)
- Cause:
  - Hypoxia, hypercarbia, increased ICP and worsen secondary neuro injury
- See table 41-2: for prophylactic indications
  - Depressed skull #
  - paralyzed/intubated pt.
  - Any seizure at any time (or hx of same)
  - PENETRATING brain injury
  - Any brain bleed (epi, SDH, ICH)
- Benzo’s for immediate seizures
- Phenytoin, fosphenytoin, for long-term mgmt.
...
- Not for mere otorrhea/rhinorrhea

Misc:

- Give recombinant complex concentrated factors for people with ICH and anticoagulant use, but not for all comers with ICH

Lab tests

- Urine tox, blood alcohol level
- CBC, lytes, glucose
- Coagulation studies
...
- Non-con CT head
- MRI for more definitive evaluation once patient is stabilized.

Disposition

Consultation

- Neurosurg. Consult ASAP post CT
- Transfer to neuro surgical centre

Priority management

- Some patients need general surgery STAT for abdominal or chest wounds -- so urgent ventriculostomies or bilateral trephinations are done concurrently if possible!
...
- Change in LOC, progressive headache, post-trauma seizures, vomiting
- Confusion, somnolence, but can still obey
- Often due to MVCs

Damage:

- Neuronal cell membrane dysfunction and a mild depletion of ATP
- **watch for the “talk and deteriorate” patient** within 48 hrs - due to epidural/subdural hematoma

Management:

- Close observation for changing mental status!
- Urgent CT with neurosurgery with any new focal findings or change in GCS
- Skull radiographs are rarely helpful - unless no CT available

Disposition:

- All should be admitted for observation, even if a normal CT scan

Complications:

- 20% mortality!
- At 3 months 70% are unable to return to work
- HUGE long term morbidity
- 50% are left with long term disabilities

Most changes are reversible, if secondary injury is avoided

“When no neurosurgeon is available and a pt. Develops an acute herniation syndrome which does not respond to hyperventilation and mannitol, ED trephination and hematoma evacuation should be considered”

Some may need follow-up MRI to look for lesions not seen on CT

**Mild* TBI**

Brief and temporary Interruption of neurologic function

- Neurobiological damage, with no damage to microstructures
- GCS 14-15 - **GCS is not sensitive enough to prognosticate minor TBI - it misses subtle alertness and Neuro changes
  > this is a CLINICAL diagnosis
  > requires high acceleration-deceleration or rotary forces to the head (whiplash should not cause this injury)

Clinical and historical features:

- Headache, Nausea, disorientation, confusion, amnesia,
- Signs:
  - Imbalance, impaired verbal memory, slowed speech, amnesia, inability to perform tasks of memory and concentration, retrograde amnesia
  - post-traumatic amnesia = impaired information encoding. This is the best predictor of the severity of injury
- High-risk Features:
  - Focal findings, signs of trauma above clavicles, worsening symptoms intoxication, age >60 or <2

5-15% of people who come to the ED with mild TBI may have an abnormal CT scan; but < 1% need neurosurgery

Low-risk - factors: - see box 41-3

1. Accurate Hx, trivial mechanism
2. Asymptomatic now; no or mild headache, no vomiting
3. No other injuries and no focal findings
4. Normal pupils
5. Intact orientation and memory
6. Initial GCS of 15
7. < 24 hrs since injury

Delayed complications likely to occur in:

- Anticoagulated pts.
  - All head injury rules exclude these populations - so the threshold to scan them is very low
- VP shunts
...
- Large body of variable research based on study populations, methods and definitions, and outcomes
- ACEP clinical policy: see box 41-4
  - CT head only indicated in adults with LOC or posttraumatic amnesia if they meet one of the other risk factors/clinical features
- “The final choice of which clinical decision rule to apply - rests on the clinician's attitude toward uncertainty”

Best approach: selective CT scanning vs. Observation based on risk stratification

- No role for skull radiography
- MRI is the test for:
  - DAI, ischemia, hemorrhagic lesions, posterior fossa
  - Will show things that a normal CT head misses

Ancillary studies:

- Consider toxic screens if a patient remains altered
- No biomarkers have shown promise in predicting long-term outcome

Disposition:

- Based on risk stratification: d/c, d/c with close observation and follow-up; ED observation for 4-24 hrs;
- Clinical sobriety should be achieved before discharge
...
1. Penetrating TBI
2. Depressed skull #
3. Complex, contaminated, deep scalp lacerations
4. Fever in someone with a basilar skull #
...
- CNS infections
  ...
  - Brain abscess
    ...
    - Common bugs: gram -ve anaerobes and staph aureus.
...
- Disseminated intravascular coagulation
  ...
  - Trxt:
    ...
    - ****patients should receive prophylactic LMWH to prevent VTE - they do not worsen ICH hematoma expansion
- Cardiac dysfunction
...
- Neuro-cardiogenic pulmonary edema
  ...
  - Pathophysiology hypothesis:
    ...
    - blasts of elevated hydrostatic forces and increased capillary permeability due to the primary brain injury
    - A systemic inflammatory reaction
  - Key goal is to lower ICP
  - CLOSE ventilator management is essential

### 7) Name 7 clinical features of basal skull #
...
#### What is Kernihan’s Notch, and How Does This Syndrome Present?
...
- *Kernohan’s notch syndrome* false localizing of motor findings due to contralateral cerebral peduncle compression (midbrain) by the tentorium cerebelli.
  - It is a FALSE localizing sign: ie. the patient has a left SDH causing an uncal herniation to the right, producing decreased LOC and LEFT (rather than right) sided hemiparesis.

## References

- [CrackCast](https://canadiem.org/crackcast/)
- [The SGEM](http://thesgem.com/2015/02/sgem106-o-canada-canadian-ct-head-rule-for-patients-with-minor-head-injury/)
