---
title: "CrackCast Episode 182: Drug Therapy in the Geriatric Patient"
url: "https://canadiem.org/crackcast"
date: 2017-06
source: "CanadiEM – CrackCast"
original_file: "CC-Ep.-182-Drug-Therapy-in-the-Geriatric-Patient-Ch-185-Rosens-9th-Ed..-.pdf"
summary: |
  The document discusses the complexities of drug therapy in geriatric patients, emphasizing the need for careful consideration of pharmacokinetic and pharmacodynamic changes due to aging. It highlights the importance of assessing organ function, comorbidities, and functional status to guide drug dosing, advocating for a "start low, go slow" approach to minimize toxicity. Polypharmacy is prevalent among older adults, increasing the risk of adverse drug effects and interactions, with warfarin-induced bleeding being notably common. The document underscores the significance of recognizing drug-related causes of altered mental status and the cautious use of opioids for pain management in this population. It also stresses the utility of tools like the Beers List and STOPP criteria to identify potentially inappropriate medications, and the role of pharmacists in optimizing drug therapy in geriatric emergency departments.
...
- Polypharmacy is common in older adults and predisposes them to adverse drug effects, drug interactions, and functional/cognitive impairment.
- There are published lists of potentially inappropriate medications, such as the Beers List and the STOPP and START criteria, but there are limited studies to enable extrapolation to the ED setting.
- Of all drug-related presentations to the ED, warfarin-induced bleeding has been shown to be the most common in older adults.
- The use of newer oral anticoagulants, such as direct thrombin inhibitors and factor Xa inhibitors, has been increasing. These newer agents undergo renal elimination; thus, drug accumulation is a concern in older adults.
...
- Geriatric patients with pain-related complaints are less likely to receive analgesics in the ED compared to younger adults, placing them at risk for poor pain control. Dosing of opioids should be cautious, with frequent monitoring and titration.
- A growing number of institutions have pharmacists practicing in the ED. In geriatric ED’s, there is a great opportunity to integrate and consult with pharmacists, given the myriad drug therapy issues that can lead to suboptimal care.
...
### 3. Which 8 medications are most responsible for adverse events in the elderly?
...
### 4. List 5 harmful drug interactions in the elderly
