---
title: "CrackCast Episode 124: Acid Base Disorders"
url: "https://canadiem.org/crackcast"
date: 2017-11
source: "CanadiEM – CrackCast"
original_file: "CrackCast-Shownotes-Episode-124-Acid-Base-Disorders.pdf"
summary: |
  The document provides a comprehensive overview of acid-base disorders, focusing on the diagnosis and management of metabolic and respiratory acidosis and alkalosis. Key diagnostic principles include the use of the anion gap and delta gap to identify mixed acid-base disorders, and the importance of assessing respiratory compensation in acute metabolic acidosis. Management strategies emphasize the need for appropriate ventilation support and caution against the empirical use of sodium bicarbonate, except in life-threatening acidemia. The document also outlines differential diagnoses for various acid-base disturbances, such as respiratory acidosis due to hypoventilation and metabolic acidosis from intrinsic or extrinsic acids. Additionally, it highlights the potential complications of bicarbonate therapy and the physiological effects of altered blood pH on calcium binding, which can lead to symptoms like paresthesias and muscle cramps in hyperventilation.
...
- Patients who have a chronic respiratory acidosis (e.g., in chronic obstructive pulmonary disease) are at risk for dangerous alkalemia if they are ventilated with routine parameters. Blood gas analysis in these cases should be performed frequently and settings titrated to the serum pH.
...
Simple acid-base disorders are categorized by the serum pH, Paco2, and HCO3− concentrations. When the primary disturbance is identified, the next step is to determine its cause and whether an appropriate compensation has occurred. An inappropriate compensation suggests that the process underlying the primary disturbance has hindered an appropriate response or that more than one primary disturbance is present.
...
Metabolic alkalosis occurs from loss of H+ or retention of HCO3−. It is usually a consequence of prolonged vomiting or nasogastric suction or a compensation for chronic respiratory acidosis.
...
- Acidic products of exogenous toxins (e.g., the toxic alcohols)
...
### 2. Why do patients with hyperventilation have lip and extremity paresthesias, carpal pedal spasm, muscle cramps, lightheadedness, and syncope?
...
- [Life in the Fast Lane - Acid-Base](https://lifeinthefastlane.com/investigations/acid-base/)
```