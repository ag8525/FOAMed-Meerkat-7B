---
title: "CrackCast Episode 165: Sedative Hypnotics"
url: "https://canadiem.org/crackcast/"
date: 2023
source: "CanadiEM – CrackCast"
original_file: "CC-EP-165-Sedative-Hypnotics-Ch.-159-Rosens-9th-Ed.-.pdf"
summary: |
  The document provides a comprehensive overview of sedative-hypnotic drugs, focusing on barbiturates, benzodiazepines, chloral hydrate, gamma-hydroxybutyrate (GHB), and over-the-counter sleep aids. It highlights the rarity of barbiturate intoxication and the supportive care required, noting that hemodialysis is reserved for severe cases. Benzodiazepine overdose management typically avoids flumazenil due to seizure risks, especially in chronic users. Chloral hydrate toxicity is characterized by sedation and cardiotoxicity, treatable with beta blockers. GHB overdose often necessitates intubation due to CNS depression, while withdrawal requires high-dose benzodiazepines or barbiturates. The document also discusses the GABA receptor's role in sedative-hypnotic effects, the sedative-hypnotic toxidrome, and the management of barbiturate and benzodiazepine overdoses, including the use of flumazenil and the risks of withdrawal. Additionally, it addresses the clinical presentations and management of chloral hydrate and GHB toxicity, emphasizing the need for careful monitoring and supportive care.
...
- Act directly on the medulla = respiratory depression.
...
- Serial phenobarbital levels can monitor effectiveness of treatment. Other than phenobarbital, barbiturates have high volumes of distribution, so serum levels do not accurately reflect CNS concentrations or correlate with clinical severity.
...
- Isolated benzodiazepine overdose in non-habituated user (e.g., Accidental pediatric)
- Reversal of procedural sedation

**Absolute Contraindications**

- Suspected co-ingestion lowering seizure threshold
- Patient taking medicine to control life-threatening condition (e.g., Seizures)
...
- This can progress to confusion, delirium, overt psychosis, paranoid ideation, hallucinations (visual, aural, or tactile), and autonomic instability.
...
Basically comes down to these drugs not being metabolized to oxazepam glucuronide:
