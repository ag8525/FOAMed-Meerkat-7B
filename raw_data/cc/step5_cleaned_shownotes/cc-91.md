---
title: "CrackCast Episode 91: Pancreas"
url: "https://canadiem.org/crackcast"
date: 2017-07
source: "CanadiEM – CrackCast"
original_file: CCE091-Pancreas.pdf
summary: |
  The document provides a comprehensive overview of pancreatitis, focusing on its pathophysiology, causes, management, and complications. Acute pancreatitis is primarily caused by gallstones and chronic alcohol consumption in adults, while trauma is the leading cause in pediatrics. Management priorities include aggressive fluid resuscitation, pain control, correction of electrolyte imbalances, and early enteral feeding. Complications can be acute, such as SIRS and organ failure, or chronic, leading to conditions like diabetes and pancreatic cancer. Diagnostic criteria include clinical features, elevated lipase or amylase, and imaging, with CT and MRCP being key tools. Chronic pancreatitis management involves supportive care, including pain relief and nutritional support. Pancreatic cancer, with a poor prognosis, is diagnosed via CT and endoscopic ultrasound, with management focusing on palliative care. The document also highlights the importance of differentiating pancreatitis from other conditions and the limited utility of certain diagnostic tests like amylase.
...
The pancreas - divided into head, body, and tail - lives in the retroperitoneum. The head abuts the duodenum, where the tail crosses midline and abuts the spleen.

- Exocrine functions: secretion of digestive enzymes (e.g., lipase, amylase, trypsinogen, and other proteases)
- Endocrine functions: secretion of insulin, glucagon, and somatostatin

## Core Questions

### 1) List 10 differential diagnoses for acute pancreatitis
...
1. Gallstones (40%–70%)
2. Chronic alcohol consumption (25%–35%)
3. Endoscopic retrograde cholangiopancreatography (ERCP)
4. Drugs
5. Trauma
6. Idiopathic (up to 10-30% of the time; may be due to microlithiasis?)
...
4. Trauma
5. Steroids
6. Mumps and other viruses (EBV, CMV, HIV)
7. Autoimmune diseases (SLE, polyarteritis nodosa, pregnancy)
8. Scorpion stings
9. Hypercalcaemia, hyperlipidaemia, hypothermia, hypotension (ischemia)
10. ERCP, emboli
11. Drugs (SAND + MR VET)
...
1. Volume resuscitation - ideally with Ringer's Lactate
...
2. Pain control
   - Narcotics are safe!
3. Correct any absolute electrolyte deficits:
   - Low ionized calcium
   - Hypomagnesemia
   - Hypokalemia
4. Correction of hyperglycemia (insulin deficiency)
5. Treat nausea
6. Initiate oral or enteral feeding ASAP
...
7. Consider early U/S post-diagnosis and then → ERCP for anyone with cholangitis or biliary obstruction (jaundice, elevated bilirubin, sepsis)
8. Consider antibiotics only if:
...
### 5) Describe Ranson’s criteria and the Atlanta criteria
...
1. Clinical features (see textbook for a description)
2. Laboratory results (lipase or amylase > 3x ULN)
3. Imaging tests (not a requirement!)
...
### 6) List causes of chronic pancreatitis. What is the best diagnostic tool? What 4 findings can be seen in chronic pancreatitis?
...
### 8) What is the 5 year survival rate for pancreatic cancer? Describe typical clinical findings. How is it diagnosed? What is the management?

- This is a terrible disease, because it often goes undetected until later stages and has very poor survival
  - 5% at 5 years from the time of diagnosis - with high risk of metastasis to the liver and lungs
- Clinical findings:
...
### Question 1) Specifically list 10 drug causes of pancreatitis.
...
### Question 2) List 5 causes of false-positive amylase elevation.
...
That’s why we use lipase more often - because it's predominantly produced by the pancreas. And more sensitive.
...
### Question 3) List 4 peripancreatic/local complications of pancreatitis that may be visualized on CT
