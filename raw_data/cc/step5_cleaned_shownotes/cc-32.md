---
title: "CrackCast Episode 32: Constipation"
url: "https://canadiem.org/crackcast/"
date: "2016-07"
source: "CanadiEM – CrackCast"
original_file: "Ch.32 Constipation.pdf"
summary: |
  Constipation is a common condition characterized by straining, hard or infrequent stools, and pain during bowel movements, with chronic cases lasting over three months. It is prevalent among women, the elderly, and those with low socioeconomic status, high BMI, low fiber intake, and sedentary lifestyles. The diagnostic approach involves distinguishing between primary causes like congenital anomalies and IBS, and secondary causes such as neurologic, metabolic, structural, medication-related, and psychological factors. Key diagnostic steps include a thorough history, physical examination, and selective ancillary testing, with a focus on ruling out serious conditions in patients over 50 or those with alarm symptoms. Management involves addressing underlying factors, ensuring adequate fiber, fluids, and exercise, and using treatment agents like bulking agents, osmotic salts, sugars, stool softeners, stimulant laxatives, and enemas. Special medications may be required for chronic cases, particularly in patients on necessary medications or those in palliative care.
...
Constipation has lots of different definitions:
- Straining
...
The GI tract normally sees 10 L of fluids and secretions. The small intestine absorbs all but 500 ml.
- The colon uses these residues from the ileum to ferment and salvage nutrients and water.
- Stool evacuation and transport depend on:
  - Neurotransmitters
  - Colonic reflexes
...
Pivotal findings:
- History
  - Usually tells you the diagnosis
  - Alarm symptoms:
    - Fever, anorexia, vomiting, blood in stool, weight loss
    - Onset in age > 50 yrs
...
- Ancillary testing
  - Usually need advanced imaging if abdominal pain is significant - x-ray not useful
...
- Treatment agents:
  ...
  2. Osmotic salts
     ...
     - Mag. citrate - milk of magnesia - 30-45 ml daily
  3. Sugars
     - Lactulose
     - PEG 3350 - 17 g BID
       - Golytely or Miralax
...
- In palliative patients use of:
  - Methylnaltrexone for blocking the opioid receptors in the gut
```