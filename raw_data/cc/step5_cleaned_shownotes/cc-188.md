---
title: "CrackCast Episode 188: EMS Overview and Ground Transport"
url: "https://canadiem.org/crackcast"
date: 2018-06
source: "CanadiEM – CrackCast"
original_file: "Ep.-188-EMS-Overview-and-Ground-Transport-Ch.-190-Rosens-9th-Ed-.pdf"
summary: |
  The document provides an overview of Emergency Medical Services (EMS) systems, highlighting the various designs and levels of care, from basic to advanced, and the roles of different prehospital providers such as EMRs, EMTs, AEMTs, and paramedics. It discusses the importance of medical oversight, both offline (protocol development, education, quality improvement) and online (real-time interaction), in ensuring effective EMS operations. The document also contrasts rural and urban EMS systems, noting differences in staffing, transport times, and trauma incidence. Key prehospital interventions for emergencies like cardiac arrest, trauma, shock, respiratory distress, drug overdoses, and seizures are outlined, emphasizing the use of AEDs, CPR, airway management, and medications like epinephrine and naloxone. Additionally, it addresses complex scenarios such as patient refusal of transport, termination of resuscitation, and the involvement of physicians on scene, underscoring the need for clear communication, capacity assessment, and adherence to ethical principles and local protocols.
...
- There are multiple designs for EMS systems, including public and private services, those operating at basic and advanced levels of care, and those that include single or multiple tiers of response capability.
...
- A community paramedic provider focusing on population health issues, such as access, chronic disease, and decreasing utilization, and readmission is now being considered by many communities.
...
- Direct medical oversight involves real-time interaction with prehospital providers via face-to-face or radio communications.
- Indirect medical direction involves off-line processes such as protocol development, quality improvement, and education.
- Advances in prehospital care of medical patients have included analgesics and anxiolytics that can be administered intranasally negating intravenous routes, non-invasive measures to support patients in respiratory distress, alternative adjuncts in place of endotracheal intubation for managing airways, and tourniquets for controlling hemorrhage. More advanced diagnostics (such as 12-lead electrocardiography and use of stroke screens) have assisted in transporting patients to appropriate facilities based on their illness and acuity.
...
This is not an exhaustive list; we tried to organize it from the ‘top” down.

1. Federal and local government
   - Funding models: public vs. private
2. Governing body / state or provincial office
...
3. Administrative office
   ...
   - Finances
   - Operations
4. Public information and on-field communication program (calling 911 in North America)
   - Including field communication between paramedics and hospital staff for pre-arrival notification
5. Dispatching system
   - Catchment area
   - Call prioritization
   - Management of available resources
   - Protocols for proving on-scene care before EMS arrival
     - Opening and clearing an airway, performing CPR, controlling hemorrhage, and assisting with childbirth.
   - Education program for telecommunicators
   - Quality improvement process
6. Transportation / facilities
7. Medical direction / medical oversight board
   - Offline vs. online medical control
8. First responders (police / firefighters)
9. BLS / ALS providers
...
- Protocol development
  - Guidelines for triage and care of specific populations of patients, including trauma patients, newborns, and children.
- Patient care guidelines
- Medico-legal policies
  - Hospital designation and destination policies, termination of resuscitation, patient transport refusal
- Personnel education, courses, lectures, direct field observation
- Prospective and retrospective patient care review
- Quality and performance improvement processes

**Online Medical Control**
- Real-time interaction between a physician/designee and a field provider (phone or video)
- Real-time patient care review and decision making
...
- Long transport times to hospitals
- Extreme environments (think about the Canadian shield or a rural winter setting)
- Trauma is over-represented
...
- Community involvement is crucial (witnesses, bystanders)
- Variable standards of care
- Difficult to ensure skill retention in low-volume settings
...
- **First Responder of EMR**
  ...
  - These individuals are able to perform CPR, provide basic airway management, control hemorrhages, immobilize patients with suspected or potential spinal injury, and use AED’s
...
- **EMT- I ACP**
  ...
  - In most EMS systems, ACP’s are able to initiate IV’s, use defibrillators (auto or semiautomatic), use limited advanced airway devices, and administer some medications
- **EMT-P CPC**
...
Some medications that may be administered by PCPs:
...
- Does the patient outrightly refuse to communicate with you and undergo a capacity assessment?
...
Another complex decision which depends on YOUR local EMS policies and whether or not you have off-line vs. on-line medical control.
...
1. Event not witnessed by emergency medical services personnel
...
4. Arrest not witnessed by bystander and
...
- Is this doctor actually qualified, and the most appropriate person to help?
  - A psychiatrist offering to help intubate on the scene of an accident
...
- Is this physician trying to deviate from standard protocols or guidelines?
  ...
  - Will the physician accept responsibility and accompany the patient to the hospital?
    - (If physician assists with treatment that conforms to EMS protocols then not required to accompany patient to hospital)
```