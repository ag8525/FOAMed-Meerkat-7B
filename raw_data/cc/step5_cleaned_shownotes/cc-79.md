---
title: "CrackCast Episode 079: Dysrhythmias"
url: "www.crackcast.org"
date: 2017-05
source: "CanadiEM – CrackCast"
original_file: "CC.EP079Dysrhythmias-1.pdf"
summary: |
  The document provides a comprehensive overview of cardiac dysrhythmias, focusing on their classification, pathophysiology, and management. Dysrhythmias are categorized by their electrophysiologic origin, ECG appearance, and ventricular rate, with a primary distinction between bradycardias, extrasystoles, narrow-complex, and wide-complex tachycardias. Key diagnostic principles include recognizing the clinical stability of patients, as unstable patients exhibit severe hypoperfusion symptoms. Management strategies vary based on stability, with empirical treatment for unstable patients and a systematic approach for stable ones. The document also details the mechanisms of dysrhythmia formation, including enhanced automaticity, triggered activity, and re-entry, and discusses the use of antidysrhythmic classes, such as Na+ channel blockers and beta-adrenergic antagonists. Specific conditions like AV nodal re-entry tachycardia, sick sinus syndrome, and Wolff-Parkinson-White syndrome are explored, highlighting their ECG features and treatment protocols. The document emphasizes the importance of understanding the underlying etiology of dysrhythmias to avoid inappropriate treatments that could harm patients.
...
Shown here are the phases of the cardiac action potential cycle:
...
### [1] What is the blood supply of the following parts of the conduction system: SA and AV nodes?

Anatomy and conduction:
- SA - impulse generating @ RA and SVC
  - 55% of people: blood flow from RCA
  - 45% people = left circumflex
  - 60-90 bpm
  - Hypothermia and vagal stimulation slow the rate
  - Hyperthermia and sympathetic stimulation increase rate
- AV node: 45-60 bpm
...
### [3] What causes & how does AV nodal re-entry tachycardia occur?
...
- Class I: fast Na+ channel (slow conduction atria, AV, His-P, etc.)
  - Other drugs: carbamazepine, TCA, neuroleptics, citalopram, antihistamines, cocaine, pufferfish toxin, shellfish toxin
- Class II: beta-adrenergic ANTagonists: suppress SA automaticity and slow AV node conduction
- Class III: prolong repolarization and refractory period (K+ channels)
  - Other drugs: TCA's, antipsychotics, citalopram, venlafaxine, antihistamines, antimicrobials
- Class IV: Ca+ channel blockers (slow AV node conduction) for SVT's
  - Verapamil
  - Diltiazem
- Other
  - IA: PROCAINAMIDE 20-30 mg/min (total dose 12-20 mg) or ~1g. risk of Hotn, 5% dysrhythm
  - IB: LIDOCAINE useful in VT suppresses SA and AV function, does not limit accessory pathways
  - IC: flecainide, PROPAFENONE only oral use >15% increased vent. dysrhythmias
  - Amiodarone: multiple class effects, long half life
  - Sotalol.
  - Digitalis: Na/K ATPase blocker: multiple effects (see tox) used in SVT, Afib/flutter 0.25.0.5 mg IV interactions when electrolytes are off!
  - Adenosine: slows AV conduction diagnostic agent.

“The subclasses IA, IB, and IC are distinguished on the basis of differential effects on depolarization, repolarization, and conduction.”
...
Ø Orthodromic AV- re-entry tachycardia (more common > 70% of cases of WPW)
...
Copied from: [Emergency Medicine Cases](https://emergencymedicinecases.com/episode-20-atrial-fibrillation/)
...
……….now let's move on to the wide complex tachycardias…
- ANY dysrhythmia with QRS > 0.12 sec.
...
a. Age>50, hx of any heart disease
b. QRS>0.14sec
c. Originates below or at the HIS bundle
d. Non sustained: < 30sec
- Monomorphic
  a. Rates 150-200
- Polymorphic VT =
  a. Bidirectional Vtach = ***digitalis toxicity*****
  b. Torsades de pointe
- DX:
  a. "Brugada four step approach" see pg. 1058 (very impractical..92% sensitivity.). ALL questions: any questions answered "yes" suggests VT
    ...
    - ?VT morphologic criteria:
      - Notched S in V1
      - QR or QS in V6
  b. Griffith approach. 92% sens
    - No classic RBBB/LBBB morphology
    - Presence of AV dissociation (i.e., p-waves are not all preceding the Ventricular depolarization)
- Trxt:
  a. Stable
...
- [Emergency Medicine Cases](https://emergencymedicinecases.com/episode-20-atrial-fibrillation/)
...
Highly recommend: [Emergency Medicine Cases](https://emergencymedicinecases.com/episode-57-stiell-sessions-2-update-atrial-fibrillation-2014/)
...
Stroke risks (copied information from: [Emergency Medicine Cases](https://emergencymedicinecases.com/episode-20-atrial-fibrillation/))
...
- Use heparin (UFH or LMWH) if patient has arrhythmia of >48hrs or unknown duration and hemodynamically unstable needing emergent cardioversion, or if Canadian Cardiovascular Society recommends using CHADS2 score to predict risk of CVA
...
### [4] List Causes of acquired pause-dependent QT prolongation causing TdP & adrenergic dependent TdP?
...
………...remember that this is the acquired type!
...
- [Emergency Medicine Cases](https://emergencymedicinecases.com/episode-20-atrial-fibrillation/)
- [Emergency Medicine Cases](https://emergencymedicinecases.com/episode-57-stiell-sessions-2-update-atrial-fibrillation-2014/)
```