---
title: "CrackCast Episode 149: ASA and NSAIDs"
url: "https://canadiem.org/crackcast/"
date: 2017-01
source: "CanadiEM – CrackCast"
original_file: "00CC-EP-149-ASA-and-NSAIDs-Ch.-144-ASA-and-NSAIDS-9th-Ed..pdf"
summary: |
  The document discusses the toxicity and management of salicylates, particularly aspirin (ASA), and non-steroidal anti-inflammatory drugs (NSAIDs). Salicylate toxicity is severe and can be fatal, requiring active assessment and treatment, with key management steps including urinary alkalinization, correction of hypovolemia, and glucose supplementation for CNS changes. Hemodialysis is indicated in severe cases, such as high salicylate levels or organ failure. NSAID overdoses are generally less severe, with supportive care being the mainstay of treatment. The document emphasizes the importance of frequent monitoring of salicylate levels and careful management of acid-base disturbances, particularly avoiding mechanical ventilation unless absolutely necessary due to the risk of worsening acidosis.
...
1. Respiratory alkalosis - direct stimulation of the medullary respiratory center.
2. Metabolic acidosis - multifactorial, loss of bicarb, ASA itself that is a weak acid, impaired Kreb cycle, impaired ability to excrete acids in urine, ketones, lactic acidosis
...
3. Respiratory acidosis - from cerebral toxicity, neuroglycopenia, salicylate induced pulmonary edema
4. Metabolic alkalosis from GI loss

a) How does this change in pediatrics?  
Children can't compensate as well as adults.

### 3. List 4 mechanisms for induction of Hypokalemia in ASA toxicity.

1. GI distress (vomiting) - stimulation of the medullary chemoreceptor trigger zone (CTZ)
2. Respiratory alkalosis - hyperventilation (direct stimulation of respiratory centre)  
   - Increased renal excretion of Na, HCO3-, K
3. Salicylate-induced increased permeability of the renal tubules with further loss of potassium
4. Intracellular accumulation of sodium and water
...
1. Reduce absorption with activated charcoal
...
3. Glucose, potassium and magnesium repletion  
   - IV
   - PO
4. Consider advanced elimination  
   - Hemodialysis  
...
- Image from: [Tulane University Pharmacology Wiki](http://tmedweb.tulane.edu/pharmwiki/doku.php/alcohol_alcohol_addiction)
```