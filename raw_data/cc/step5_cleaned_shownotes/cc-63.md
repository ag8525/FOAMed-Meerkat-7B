---
title: "CrackCast Episode 63: Thermal Burns"
url: "https://canadiem.org/crackcast/"
date: 2017-02
source: "CanadiEM – CrackCast"
original_file: "CC.EP63ThermalBurns.pdf"
summary: |
  Thermal burns, resulting from heat, electrical, radiation, or chemical exposure, are a significant clinical concern, with 450,000 cases treated annually in the U.S. and a 95% survival rate. Key diagnostic principles include assessing burn depth, which ranges from first-degree (epidermal) to fourth-degree (involving muscle or bone), and estimating total body surface area (TBSA) affected using the Rule of 9s or Lund-Browder chart for children. Critical management steps involve fluid resuscitation, often using the Parkland or Galveston formulas, and addressing airway injuries, with intubation indicated for upper airway obstruction or hypoxemia. Burn dressing management emphasizes infection prevention and pain control, while escharotomy may be necessary for circumferential burns impairing circulation or ventilation. Major warnings include the risk of inhalational injuries and the need for early airway management in at-risk patients.
...
- Burn progression is a result of both necrosis and apoptosis of damaged cells.
  - The necrosis is a passive process denaturing the lipid bilayer and ATP enzymes, leading to cell swelling, loss of energy stores, and massive release of inflammatory mediators.
- Epidemiology:
  - Young and old have thinner skin and fewer sweat glands/hair follicles, hence more susceptible to injury.
  - 450,000 burn injuries treated in the United States each year, 3,500 deaths.
...
Three concentric zones of a burn used to explain the pathophysiology of a burn. Listed from the center out they are:

1. Irreversible coagulation and necrosis, formed immediately.
2. Ischemia with impaired microcirculation. This tissue is at risk of subsequent necrosis - this is what we want to increase the perfusion to! Unfortunately, none of the researched therapies have proven to be beneficial in vivo… yet!
...
6. Hypoventilation (PCO2 > 50 mmHg and pH < 7.2)
...
- Consider intubating early in patients who may look otherwise well but who are at high risk of developing complications of airway burns.
  - i.e., patients with oropharyngeal swelling and a hoarse voice.
...
- In BC we use a modification of the Parkland formula:
  ...
  - [Provincial Clinical Practice Guidelines for Management of Major Burn Trauma](http://www.bcmj.org/articles/provincial-clinical-practice-guidelines-management-major-burn-trauma)
- Galveston formula - preferred for pediatrics.
  - Lactated Ringers at 5000 cc / m2 TBSA burned + 2000 cc/m2 BSA.
  - E.g. 10% TBSA burns in a 100 cm child, weighing 15 kg has a body surface area of: 0.64 m2.
  ...
  - THEN 800 cc in 16 hrs = 50 cc / hr for 16 hours.
  - Use a tool to estimate skin surface area.
  - Over the following 24 hours, 3750 cc/m2 TBSA burned + 1500 cc/m2 TBSA.
- Pearls:
  - Infants should also receive 5% glucose in their maintenance fluid as they lack carbohydrate reserves.
...
3. Third Degree
   ...
   - Stiff, white or tan color, dry, leathery and insensate.
...
- The true diagnosis requires: direct visualization with fibroscopy before / after intubation….showing:
...
- Dressings for partial-thickness burns.
  ...
  - The second method for burn management is with occlusive dressings.
    ...
    - Dressing such as Mepilex or a nano-crystalline silver-containing occlusive dressing should be applied and left in place for approximately 1 week.
...
1. Intubation
   ...
   - While succinylcholine is commonly avoided in burn patients, recall from Chapter 1 that it is only contraindicated in patients who are 5 or more days post-burn.
