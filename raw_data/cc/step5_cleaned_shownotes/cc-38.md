---
title: "CrackCast Episode 186: Pediatric Trauma"
url: "https://canadiem.org/crackcast/"
date: 2016-08
source: "CanadiEM – CrackCast"
original_file: "Ch.38 Pediatric Trauma.pdf"
summary: |
  Pediatric trauma management requires understanding key anatomical and physiological differences from adults, such as larger abdominal organs and flexible ribs, which can lead to internal injuries without external signs. Airway management is complicated by anatomical differences like a larger tongue and a cephalad larynx, necessitating specific intubation techniques. Fluid resuscitation in hemorrhagic shock involves crystalloids and blood products, with intraosseous access being crucial when IV access is challenging. Elevated intracranial pressure (ICP) in children presents with distinct signs like full fontanel and altered consciousness, requiring management strategies including mannitol and hypertonic saline. Pediatric-specific injury patterns, such as those from lap belts or sports, necessitate careful assessment and management, with a focus on serial examinations and appropriate imaging to guide interventions like laparotomy.
...
9. List the 5 layers of the scalp and describe 3 types of extracranial bleeding in pediatrics
...
- Pediatric shock:
  - Cool distal extremities, decreases in peripheral vs. central pulse quality, delayed cap refill
  - Altered sensorium

#### FAST and Family

- Ultrasound for blood
- Allowing family to be present during the resuscitation
  - Informing them of what happened
  - Utilizing social work and child life specialists

#### Secondary Survey

- AMPLE history
- Tasks to complete
  - Continuous repeated vital signs
  - Provision of analgesia
  - Antibiotics and tetanus
  - Monitor urine output
  - Post-intubation sedation and medication
  - Don’t forget adequate analgesia!

#### Physical Examination

- Head to toe exam: pit to finger exam
- Remove the kid off backboard
- Many orthopedic injuries are missed

#### Diagnostic Evaluation

##### Labs

- Initial hemoglobin is usually unreliable: do serial measurements
- Glucose level
...
- Skeletal survey in young children suspected of having NAT

#### Formulas to Know

- Cuffed ET: age in years/4 + 3.5
- Uncuffed ET: age in years/4 + 4
- Tube depth: age in years/2 + 12
  - Appropriate tube size X 3 = number of cm at the teeth that the ETT should be taped at.
- Chest tube size: 2 x ETT size
- Femoral line: 3-6 F.
...
1. More widely distributed forces in a child = multiple injuries more likely to occur due to structural differences
   ...
   - SCIWORA injuries occur due to an elastic vertebral column and tenuous blood supply

2. Larger surface area = prone to heat loss ---> hypothermia = negative effect on cardiac function, inotropy, LV contractility, platelet function, renal and hepatic drug clearance, metabolic academia

3. Higher, proportional requirements for free water, electrolytes, minerals due to higher metabolism

4. Higher O2 consumption and glucose utilization per kg = need energy and calories sooner - due to increased metabolism

5. Great capacity to maintain BP despite 25-30% blood loss
   - Little role for inotropy: mostly dependent on chronotropy and SVR
   - **Compensated shock (TachyC and slow cap. refill) are warnings that the kid is about to crash!**

### 2. List 8 airway differences between pediatrics and adults with their relevant implications

| Differences | Implications |
|-------------|--------------|
| Physiologic | Increased vagal response to laryngoscopy |
| Bradycardia - have atropine on hand! | |
| Anatomic | Larger tongue |
| #1 cause of airway obstruction; need better head positioning +/- OPA/NPA | |
...
- 10-20ml/kg of crystalloid IV bolus repeated up to three times then:
  - PRBCs: 10 ml/kg
  - FFP: 25 ml/kg
  - Platelets: 10 ml/kg
...
Need to use the mantra “1-2-IO” - get access ASAP

- IV access: if not do an IO
...
- The problem with the peds GCS is that it DOESN'T help you prognosticate neurological outcome as the adult GCS score (no validation) and has poor inter-rater reliability
...
Signs of increased ICP in infants - Rosen’s Box 38-8
...
Signs of increased ICP in children - 38-9 pg. 312
...
- Important anatomic differences
  - Larger, heavier cranial vault
    - High amount of torque on the C spine axis in toddlers and infants
  - Malleable sutures
...
- Impact seizure: a seizure with immediate return to normal mental status after the postictal period: usually NOT associated with parenchymal injury.
...
- ABC's interventions
  ...
  - Euvolemia
  - CPP = MAP - ICP
  - No matter what a child's neuro presentation in the ED try to resuscitate
...
- Key differences in the peds: C spine:
...
| Central cord | Anterior cord | Brown-Sequard | Complete |
|--------------|---------------|---------------|----------|
| Extension injury | Flexion injury | Hemisection of the cord | Cut |
| Arm tone < leg tone | | | |
| Distal symptoms > proximal | | | |
| **Burning dysesthesias in fingers and hands** | Complete motor paralysis, loss of pain and temperature sensation | Position and vibration is preserved | |
...
- Two phases of SCI
  ...
  - Spinal shock
    ...
    - Resolves in hours to 1 day
  - Neurogenic shock
    - Injury above T6
    - Loss of sympathetic tone and have UNOPPOSED parasympathetic tone: hypoTN and Bradycardia
...
- Need close hospital observation, serial exams and Hgb.
...
- Image retrieved from bestpractice.bmj.com August 5th, 2016
- www.crackcast.org
```