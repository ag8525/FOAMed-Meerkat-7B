```yaml
title: "CrackCast Episode 58: Ankle and Foot"
url: "https://canadiem.org/crackcast"
date: 2017-01
source: "CanadiEM – CrackCast"
original_file: "CrackCast-Shownotes-Episode-58-Ankle-and-Foot-PDF.pdf"
summary: |
  The document provides a comprehensive overview of ankle and foot injuries, focusing on the anatomy, diagnostic principles, and management strategies. Key conditions discussed include various fractures (e.g., Weber classification for ankle fractures, Hawkins classification for talar neck fractures, and Lisfranc injuries), tendon ruptures (e.g., Achilles and tibialis posterior), and stress fractures. Diagnostic tools such as the Ottawa Ankle Rules and specific stress tests (e.g., anterior drawer, inversion stress test) are highlighted for their utility in clinical assessment. Management strategies emphasize the importance of appropriate imaging, reduction, immobilization, and surgical intervention when necessary, with specific attention to complications like avascular necrosis and compartment syndrome. The document also underscores the need for orthopedic referral in cases of significant displacement, instability, or complex fractures.
```
...
### Describe the bones of the foot and important joints/ligaments
...
Physical exam: LOOK; FEEL pulses/max tenderness areas/sensation; MOVE + weight bear
...
See: [Ottawa Ankle Rule](http://www.mdcalc.com/ottawa-ankle-rule/)
...
- Do NOT apply to hind or forefoot injuries.
...
- Tendon injuries
  - Achilles Rupture: "the middle-aged man"
    ...
    - "Loud pop", weakness with plantar flexion (action compensated by tibialis posterior, toe flexors and peroneal muscles)
    - Up to 25% of cases are missed!!!
...
- High incidence of complications post ORIF
  - Osteochondral lesions: "persistent ankle pain after a sprain"
    ...
    - Commonly occur with ankle sprains: gross edema + effusion --> Chronic ankle pain
    - Dx: with MRI, showing bone marrow edema and cartilage injury
...
For a discussion of the different types: [Fifth Metatarsal Fractures](http://www.wikiradiography.net/page/Fifth+Metatarsal+Fractures)
...
- Stress fractures:
  ...
  - Plain x rays normal up to 4-6 weeks!
...
Copied from: [Fifth Metatarsal Fractures](http://www.aofas.org/PRC/conditions/Pages/Conditions/Fifth-Metatarsal-Fractures.aspx)

### 14) Describe 4 plain-film radiographic abnormalities for stress fracture

“Plain radiographs have poor sensitivity in detecting stress fractures, as positive findings may take months to appear. During the first few weeks after the onset of symptoms, x-rays of the affected area may look normal. Positive findings include:
1. Sclerosis,
2. Periosteal reaction/elevation,
3. Cortical thickening
4. Fracture line.”

Copied from: [Stress Fractures](https://radiopaedia.org/articles/stress-fractures)

### 15) Describe the Tillaux fracture and pathophysiology

From: [Tillaux Fracture](http://orthoinfo.aaos.org/topic.cfm?topic=A00632)
    ...
    - Allows for partial joint function:
      ...
      - Phase 2-3:
        ...
        - Disposition:
          ...
          - Long term functional/mechanical instability; chronic pain; stiffness, and recurrent swelling or popping need f/u and imaging
...
- [Ottawa Ankle Rule](http://www.mdcalc.com/ottawa-ankle-rule/)
- [Fifth Metatarsal Fractures](http://www.wikiradiography.net/page/Fifth+Metatarsal+Fractures)
- [Fifth Metatarsal Fractures](http://www.aofas.org/PRC/conditions/Pages/Conditions/Fifth-Metatarsal-Fractures.aspx)
- [Stress Fractures](https://radiopaedia.org/articles/stress-fractures)
- [Tillaux Fracture](http://orthoinfo.aaos.org/topic.cfm?topic=A00632)
```