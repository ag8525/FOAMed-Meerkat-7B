```yaml
title: "CrackCast Episode 54: Back Pain"
url: "https://canadiem.org/crackcast"
date: 2016-12
source: "CanadiEM – CrackCast"
original_file: CCEp54.BackPain.pdf
summary: |
  The document focuses on the clinical evaluation and management of back pain, emphasizing the importance of distinguishing between functional and organic causes. Key conditions discussed include fractures, cauda equina syndrome, spinal infections, vertebral malignancy, and simple radiculopathy. Diagnostic principles involve recognizing red flag symptoms, utilizing imaging judiciously, and employing specific physical tests like the Straight Leg Raise to assess nerve root involvement. Management strategies highlight the need for urgent surgical intervention in cases like cauda equina syndrome, appropriate use of imaging, and conservative treatments for non-specific back pain. The document also underscores the significance of patient education and the cautious use of medications, including NSAIDs and steroids, while avoiding unnecessary narcotics.
```
...
2. List 4 Red Flag diagnoses including history and physical exam findings
3. Describe Straight Leg Raise (SLR), crossed-SLR, flip-test, reverse SLR and their implications
...
4. Malignancy - primary vs. secondary
...
1. Bowstring sign: reproduced pain with deep palpation of the taut posterior tibial nerve in the midline at the popliteal fossa
2. Foot dorsiflexion test
...
Functional
- Clues from history:
  1. Prolonged hx of non-anatomic pain complaints
  2. Vague pain descriptions and no localization
  3. Multiple lawsuits over similar problems
  4. Multiple narcotic prescriptions
  5. Multiple different prescribers
  6. Lack of coordinated care for a problem that dominates a person’s entire life
- In search of secondary gain

Organic
- Anatomic, life-altering, physiologic complaints
- In search of diagnosis and treatment

Clues from physical examination:
1. Negative Sitting SLR (aka “flip back test”)
2. Extreme superficial tenderness
3. Non-dermatomal sensory loss
4. Axial load on the cervical spine (head) causing pain
5. Over-reaction during physical assessment
