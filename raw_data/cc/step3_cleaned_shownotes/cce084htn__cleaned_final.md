```yaml
title: "CrackCast Episode 84: Hypertension"
url: "https://canadiem.org/crackcast"
date: 2017-06
source: "CanadiEM – CrackCast"
original_file: "CCE084.HTN_.pdf"
summary: |
  Hypertension is a prevalent condition with significant implications for cardiovascular health, defined as blood pressure exceeding 140/90 mmHg in the general population, with lower thresholds for those with chronic kidney disease or diabetes. In emergency medicine, it is crucial to distinguish between hypertensive emergencies, characterized by acute target-organ dysfunction, and poorly controlled chronic hypertension, which is asymptomatic and lacks end-organ damage. Management of hypertensive emergencies involves careful selection of intravenous antihypertensives, such as esmolol or nicardipine, tailored to specific clinical scenarios like intracerebral hemorrhage or aortic dissection. The document emphasizes the importance of avoiding unnecessary acute blood pressure reduction in chronic hypertension due to potential risks of hypoperfusion. Additionally, it highlights the need for appropriate follow-up and management strategies for patients without established care, underscoring the shift from cosmetic blood pressure reduction to interventions based on clinical disease presence.
```
...
- Definition:
  - > 140/90 in the general population
    - Cut off of 135/85 mmHg in patients who have their BP measured using automated BP devices in a relaxed, quiet, alone environment.
...
i. Hypertensive emergency: “acute target-organ dysfunction, manifesting with newly developed clinical sequelae or consequential diagnostic test abnormalities.”

ii. Poorly controlled chronic HTN: known HTN patient with asymptomatic elevated BP without end organ dysfunction.

- Watch out for the following drugs as they can muddy the waters by increasing BP: NSAIDs/steroids/decongestants/appetite suppressants/over-the-counter stimulants/oral contraceptives/TCAs or rebound from short-acting antihypertensives (e.g., clonidine).

iii. Elevated BP without prior history of HTN: can’t be diagnosed with HTN in ED (think white coat) but 70% of these patients go on to be diagnosed after appropriate workup by GP or outpatient clinic.

### 2. List 10 possible etiologies for hypertension

- Remember that hypertension is either primary or secondary.
- We always need to think “why” are they hypertensive:
...
- **Macrocirculation**
  - High SVR (due to peripheral arteriole backup from SNS and RAAS activation) increases LV mass.
...
- Post injury, a major vascular smooth muscle relaxant (Nitric Oxide) is decreased.
...
First, let's talk injury pattern: see 84-2:
...
### What are the management targets / indications for treatment in the following patients:
...
- Magnesium sulfate: Controversial; prevents vasospasm acting as NMDA antagonist and a calcium channel blocker; maintain between 2-2.5 mmol/L.
...
- Avoid beta-blockers in early treatment before reperfusion as can precipitate cardiogenic shock by dropping CO.
...
Check out this great EMCases post here.
...
- Esmolol 0.5mg/kg bolus then 50-300 mcg/kg/min or Labetalol 10-20mg bolus then 0.5-2mg/min.
...
#### 7. 62 yo female with ICH, ↓ GCS, shift on CT scan.
...
- Standard herniation syndrome tx stuff.
  ...
  5. Treat w/ Mannitol or Hypertonic.
  6. Hyperventilation to PCO2 30-35.
  7. Neurosx Stat.
  8. Reverse anticoags.

#### 8. 55 yo female with multiple vague complaints (dizziness, headache, weakness, and hand numbness)
...
- Observe in a quiet area (...doesn’t anyone know of such a place in the ER?). Then reassess. There is no target BP that dictates a safe discharge, and acutely lowering the BP with a drug such as hydralazine is “without rationale or benefit.”
