```yaml
title: "CrackCast Episode 118: SLE and Vasculitides"
url: "https://canadiem.org/crackcast/"
date: 2023
source: "CanadiEM – CrackCast"
original_file: "CC.-Ep118-SLE-and-the-Vasculitides-Ch.-108-Rosens-9th-Ed.-AT.pdf"
summary: |
  The document provides a comprehensive overview of Systemic Lupus Erythematosus (SLE) and vasculitides, focusing on their pathophysiology, diagnostic criteria, and management. SLE is a multisystem autoimmune disease with a significant risk of coronary artery disease and venous thromboembolism, necessitating careful evaluation of chest pain in affected patients. Key diagnostic criteria include clinical manifestations such as cutaneous lupus and serositis, alongside immunological markers like ANA and anti-Sm antibodies. Management primarily involves glucocorticoids and immunosuppressants. Vasculitides are characterized by systemic symptoms and can lead to severe complications like massive hemoptysis and renal failure. The document also highlights the importance of recognizing drug-induced lupus and the need for rheumatological consultation in complex cases. Additionally, it discusses antiphospholipid syndrome, a common comorbidity in SLE, and provides diagnostic criteria for various vasculitides, including temporal arteritis and Behçet’s disease.
```
...
### [1] What is the pathophysiology of lupus?
...
- 90% of cases are women = strong role of estrogen? Throw on top of that the importance of HLA alleles giving lots of overlap, making genetics a strong risk factor.
- SLE is the “prototype of all systemic autoimmune disease.” Long story short, the body starts producing antibodies via B-Cells directed towards host antigens, i.e., starts attacking itself.
...
1. Symptoms related to SLE that is not yet diagnosed (e.g., idiopathic pericarditis, new rash)
2. Progression or acute deterioration due to known SLE (e.g., progressive nephritis, lupus enteritis)
3. Complications of immunosuppression from treatment of SLE (e.g., opportunistic infection)
4. Complaints or disease unrelated to SLE (e.g., trauma, pregnancy).
...
- Shortness of breath: PNA, anemia, pericarditis +/- effusion, pleuritic +/- effusion, ILD, shrinking lung syndrome
...
1. Elevated PTT in the setting of a normal PT/INR
...
5. Penicillins
6. Sulfonamides
7. Oral contraceptive medication
8. Phenytoin
9. IBD
10. SLE
11. Histoplasmosis
...
|------------------|----------------|-----------------------------|
| **Pathophysiology** | Small / medium arteries and veins of the extremities | Immune complex deposition in blood vessel walls | Small vessel |
| **Associated exposures** | Heavy cigarette smoking, Cold exposure | Foreign protein or serum, Penicillin-based antimicrobials, Sulfa drugs | NSAIDs, Beta-lactam abx, NSAIDs, Diuretics |
| **Common symptoms** | Pain, paresthesias, claudication, rest pain | Fever, arthralgias, diffuse lymphadenopathy. | Pruritic skin lesions, Typically confined to skin (vs. serum sickness) |
| **Physical exam findings** | Poorly healing wounds, Ulcerations, Splinter hemorrhages, Digital ischemia and necrosis, Distal to proximal progression | Urticaria, Purpuric skin lesions, Scarlatiniform rash, Erythema multiforme, Azotemia, proteinuria, Myocarditis, pericarditis | Palpable purpura in dependent regions including legs and buttocks, Urticarial vasculitis, Livedo reticularis, Skin nodules and ulcers |
| **Diagnosis** | Angiography: demonstrates Corkscrew pattern of collateral vessels – rule out other ischemia causes | Clinical | Clinical |
| **Management and outcome** | Smoking cessation, Meticulous wound care, Protection from trauma and thermal injury | Supportive, Systemic steroids if severe, Recovery generally 4-6 weeks | Supportive, Systemic steroids if severe |
...
### [4] Spot Diagnosis: A 36-year-old female stock trader presents with what appears to be necrosis of the nose and ears…
...
5. Buffalo Hump
6. Striae
7. Poor wound healing / ulcers
8. Muscle weakness
9. Osteoporosis
10. Avascular necrosis
11. Immunosuppression & recurrent infections
12. Hyperglycemia
13. Hypertension
```