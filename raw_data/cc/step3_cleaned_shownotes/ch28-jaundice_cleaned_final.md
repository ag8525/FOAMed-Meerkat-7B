```yaml
title: "CrackCast Episode 28: Jaundice"
url: "www.crackcast.org"
date: 2016-06
source: "CanadiEM – CrackCast"
original_file: Ch.28 Jaundice.pdf
summary: |
  The document provides a comprehensive overview of jaundice, focusing on the metabolism of heme and the pathophysiological processes leading to elevated bilirubin levels. It categorizes the causes of jaundice into pre-hepatic, hepatic, and post-hepatic, with specific conditions such as hemolysis, hepatocellular dysfunction, and biliary obstruction being highlighted. Key diagnostic principles include the differentiation between conjugated and unconjugated bilirubin and the use of laboratory tests like GGT, reticulocyte count, and liver function tests. Critical management strategies are tailored to the underlying cause, such as the use of N-acetylcysteine for acetaminophen toxicity and antibiotics for ascending cholangitis. The document also emphasizes the importance of recognizing jaundice in pregnancy as pathological, with conditions like acute fatty liver of pregnancy and intrahepatic cholestasis requiring specific interventions.
```
...
- Heme products (red blood cells) breaking down → bilirubin
  - A very small portion of bilirubin comes from myoglobin (muscles) or maturing erythroid cells
- Heme products are oxidized into biliverdin → bilirubin
...
- Colonic bacteria metabolize most conjugated bilirubin to urobilinogen and stercobilin
...
### List common pre-hepatic/hepatic/post-hepatic causes of jaundice
...
2. Failure of conjugation - hepatocytes unable to take up, conjugate, and excrete bilirubin
   - Hepatocellular dysfunction
     ...
     - Inflammatory/infectious: Virus - hepatitis, autoimmune
...
### What laboratory tests can be useful in a jaundiced patient?
...
### List the triad of acute hepatic failure

- Jaundice
- Encephalopathy
- Coagulopathy (INR > 1.5)

### List and describe 6 critical causes of jaundice
...
### What are 3 causes of jaundice in pregnancy?
...
- Pregnancy and jaundice = pathology
  ...
  - 1) Hyperemesis gravidarum
    ...
    - Treatment: fluids and antiemetics and admission if biochemically deranged
  - 2) Acute fatty liver of pregnancy
    ...
    - Treatment: delivery, patients may need liver transplant!
