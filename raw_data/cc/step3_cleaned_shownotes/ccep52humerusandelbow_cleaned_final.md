```yaml
title: "CrackCast Episode 52: Humerus and Elbow"
url: "https://canadiem.org/crackcast"
date: 2016-12
source: "CanadiEM – CrackCast"
original_file: CCEp52.HumerusandElbow.pdf
summary: |
  The document provides a comprehensive overview of the management and classification of various elbow and humeral injuries, particularly in pediatric populations. It discusses the approach to pediatric elbow injuries, emphasizing the importance of radiographic evaluation and the identification of fat pad signs for diagnosing fractures. Supracondylar fractures in children are classified using the Gartland system, with management strategies varying from immobilization to surgical intervention based on the fracture type and displacement. Complications such as brachial artery injury, compartment syndrome, and nerve injuries are highlighted. The document also covers the management of humeral shaft fractures, distinguishing between displaced and non-displaced types, and stresses the importance of monitoring for radial nerve injury. Additionally, it addresses common injuries in Little-leaguer's elbow, the classification and management of radial head fractures, and the reduction techniques for posterior elbow dislocations. The indications for x-ray in cases of radial head subluxation and the management of olecranon bursitis, including the differentiation between septic and non-septic causes, are also detailed.
```
...
5. Describe the management of:
   - Humeral shaft fractures – displaced and non-displaced
...
The ulnar nerve:
- Runs parallel to the median nerve until halfway down the humerus, and then it moves medially
...
The Approach:
1. Right patient, views, etc.
2. Gross deformity
3. Soft tissue assessment
   - Fat pads
     - Watch out for the missed radial head fracture (look at the radial head and fat pads)
     - Watch out for subtle changes in the elbow fat pads as they may be the only sign of a fracture
...
1. Brachial artery injury
   - Usually a temporary loss of the radial pulse due to swelling
     - Avoid flexion the reduced fracture more than 90 degrees, keep the arm elevated, gentle reduction
2. Compartment syndrome
   - Leading to Volkmann’s ischemic contracture from prolonged forearm ischemia - is rare <0.5%
3. Loss of the normal carrying angle
...
- Classification types:
  - I. Undisplaced
  - II. Marginal fracture, < 30% of the articular surface, with > 2mm displacement, including angulation and displacement
  - III. Comminuted of the ENTIRE radial head
  - IV. Any of the above WITH an elbow dislocation
...
Reasons to image:
1. Ecchymosis, swelling, deformity
2. Tenderness to wrist, forearm, humerus, clavicle on palpation
3. No return of function in 24 hrs
