```yaml
title: "CrackCast Episode 113: Somatoform Disorders"
url: "https://canadiem.org/crackcast"
date: 2017-09
source: "CanadiEM – CrackCast"
original_file: "CC.-Ep113-Somatoform-Disorders-Ch.-103-Rosens-9th-Ed.-.pdf"
summary: |
  Somatoform disorders, now termed somatic symptom disorders (SSDs), represent a challenging intersection of psychiatry and medicine, characterized by patients presenting with multiple physical symptoms without detectable physical disease, leading to significant distress and social dysfunction. Key disorders in this category include somatic symptom disorder, illness anxiety disorder, functional neurological symptom disorder, factitious disorder, and psychological factors affecting other medical conditions. Diagnosis hinges on the presence of persistent, clinically significant physical complaints accompanied by excessive health-related thoughts and behaviors. Management focuses on validating the patient's experience, minimizing unnecessary diagnostic testing, and fostering a therapeutic alliance to address functional impairments. Differential diagnoses include major depressive disorder, anxiety disorders, and various organic diseases such as multiple sclerosis and systemic lupus erythematosus, necessitating a thorough history and physical examination to guide appropriate testing.
```
...
### 1) List 5 somatic symptom and related disorders
...
### 2) List 5 common presentations of conversion disorders

Subcategorized into:
1. Weakness or paralysis
2. Abnormal movements
3. Swallowing symptoms
4. Dysphonia or slurred speech
5. Attacks or seizures
6. Anesthesia
7. Visual, olfactory, or hearing disturbances
...
### 3) List 6 ddx of somatic symptom disorder
...
### 1. List 6 organic diseases that may be mistaken for somatoform disorders

So, to recap! There are several medical diagnoses that can have very subtle presentations with multiple physical symptoms, including multiple sclerosis, porphyria, hyperparathyroidism, systemic lupus erythematosus, thyroid disorders, Wilson’s disease.
...
### 2. Describe the treatment goals of somatoform disorders
...
The priority is to listen and communicate an understanding of what the patient is feeling and the extent of the functional impairment that they are experiencing.
...
- [Patient-Centered Care](https://emergencymedicinecases.com/episode-49-patient-centered-care/)
- [Effective Patient Communication: Managing Difficult Patients](https://emergencymedicinecases.com/episode-51-effective-patient-communication-managing-difficult-patients/)
```