```yaml
title: "CrackCast Episode 164: Plants, Mushrooms, and Herbals"
url: "https://canadiem.org/crackcast/"
date: 2018-03
source: "CanadiEM – CrackCast"
original_file: CCE162-Plants-Mushrooms-Herbals-1.pdf
summary: |
  The document provides a comprehensive overview of toxicities associated with various plants, mushrooms, and herbal medicines. It highlights that most botanical exposures result in minimal toxicity, with serious cases often involving anticholinergic, antimitotic, cardiovascular, or convulsive properties. Key plants discussed include Jequirity pea and Castor beans, which contain toxalbumins like abrin and ricin, leading to severe systemic toxicity if ingested improperly. Other plants like Oleander and Foxglove contain cardiac glycosides, causing digitalis-like toxicity. The document also categorizes mushrooms by their onset of toxicity, with early-onset types like Psilocybin causing hallucinogenic effects, and late-onset types like Amanita phalloides leading to potentially fatal hepatotoxicity. Herbal medicines pose risks due to unregulated use, with potential for inherent toxicity and interactions, emphasizing the need for caution and expert consultation in cases of exposure.
```
...
1. For each of the following, describe the expected toxicity:
   - Jequirity pea, Rosary
   - Umbrella tree, Dieffenbachia, Dumb cane
   - Capsicum annum
   - Water Hemlock
...
- Ancient Greeks recognized the lethal effects of plants, e.g., sentencing Socrates to death by ingestion of a hemlock-based liquid.
- 65% of plant exposures involve children younger than 6 years old.
- The majority of plant exposures result in minimal toxicity, and death is exceedingly rare.
- The most common severe and occasionally fatal poisonings are due to anticholinergic, antimitotic, cardiotoxic, or convulsive properties.
...
- These plants are commonly found in homes/offices - hard to kill and look good.
...
- Treatment is supportive, including maintenance of a patent airway.
- Corticosteroids and antihistamines are adjunctive therapies.
- Diphenhydramine (25 to 50 mg intravenous push [IVP]) and dexamethasone (4 to 8 mg IVP).

**Capsicum annum aka all those peppers you love (jalapeno, bell, cayenne)**
...
- High doses of eucalyptol = ingestion, skin contact, or inhalation
...
- Presents with GI symptoms, hypersalivation, diaphoresis, and cardiac effects.
...
- Hypotension
- Seizures
- Treatment with fluids, atropine & pacing
...
- Poisonous fruit from the Karwinskia humboldtiana commonly seen in SW USA and Mexico.
- Toxicity:
  - Exposure: Ingestion
