```yaml
title: "CrackCast Episode 186: Multiple Trauma"
url: "https://canadiem.org/crackcast/"
date: 2016-08
source: "CanadiEM – CrackCast"
original_file: "Ch.36 Multiple Trauma.pdf"
summary: |
  The document focuses on the management of multiple trauma, emphasizing the importance of regionalized trauma systems in reducing mortality. It outlines the indications for trauma team activation based on physiological, anatomical, mechanistic, and logistical criteria. The general approach to a multi-trauma patient follows the ATLS protocol, prioritizing airway, breathing, circulation, disability, and exposure, with a strong emphasis on controlling deadly bleeding and early blood transfusion. The document also discusses the indications and contraindications for emergency department thoracotomy in blunt and penetrating trauma, highlighting the importance of signs of life and the duration of CPR. Permissive hypotension is addressed as a controversial strategy primarily for penetrating trauma, with contraindications in head injuries and possibly blunt trauma. Key pitfalls include failure to secure the airway, bind the pelvis, and control bleeding effectively.
```
...
- The general goal is scoop and run, but this can result in over and under-triaging patients.
- Each system has a complex decision scheme to aid EMS and dispatchers in healthcare resources.

#### Principles of Disease

- Mechanism of injury provides general info on what injuries may be present.
  - E.g., head-on MVC (aortic tear) vs. rear-end collision (central cord syndrome).
  - Penetrating trauma vs. blunt trauma.
  - High velocity/caliber penetrating injury vs. knife.
- Other considerations:
  - Pediatric/infant patients.
  - Geriatric trauma (medical comorbidities, medications like blood thinners/beta blockers, etc.).
...
- **Mechanistic**
  ...
  - Special considerations:
    ...
    - Pregnancy
- **Logistical**
  - If the emergency physician needs more help and resources

### 2) What is the general approach to a multi-trauma patient?

After receiving information about an incoming trauma patient, this is one possible approach to prepare the team (from EM cases episode 83):

1. What do we know?
2. What do we expect to see? What are the possibilities?
3. What do we do and the contingency plans?
4. Role assignments
5. Rally point / check-in at 5 mins
...
1. Prepare your team!
2. Control deadly bleeding - TQs, bind pelvis, scalp lacerations
3. Resuscitate before you intubate
   - Decompress the chest
   - Bind the pelvis
4. Give blood ASAP in the bleeding trauma patient!
...
- **Breathing**
  ...
  - Chest trauma signs
  - Treat as appropriate: intubation, finger thoracotomy, chest tubes, cricothyrotomy
- **Circulation**
...
- Generally order minimal imaging tests: CXR, pelvic x-ray, eFAST: although may be excluded with advanced ultrasound in patients going to CT scanner
...
5. Penetrating wounds in axillae/buttocks/groin

### 4) ED thoracotomy indications and contraindications for blunt and penetrating trauma

[Life in the Fast Lane - Emergency Thoracotomy](http://lifeinthefastlane.com/ccc/emergency-thoracotomy/)
...
- Based on the idea that if you resuscitate someone to their normal blood pressure - you may INCREASE bleeding from a site that has stopped bleeding leading to more hemorrhage.
- The idea wasn’t supported or refuted according to a Cochrane review cited in Rosen’s.

For more information:

[Life in the Fast Lane - Permissive Hypotension](http://lifeinthefastlane.com/ccc/permissive-hypotension/)
...
- Allow SBP to fall low enough to avoid exsanguination but keep high enough to maintain perfusion - titrate to mentation.
...
- Haemorrhage control is the goal, once this achieved (e.g., haemostasis and surgery) normalization of haemodynamics is appropriate.
...
- A: Treat tension pneumothorax, possible intubation
...
- Use of excessive spinal immobilization
