```yaml
title: "CrackCast Episode 194: Pain Management"
url: "https://canadiem.org/crackcast"
date: 2018-10
source: "CanadiEM – CrackCast"
original_file: "CRACKCast-E194-Ch-3-9th-Ed-Pain-Managementtt.pdf"
summary: |
  The document focuses on pain management in the emergency department (ED), emphasizing the distinction between acute and chronic pain treatment. Key management strategies include the use of titrated IV opioids for moderate to severe acute pain, with oral opioids as an alternative for moderate pain when IV access is unnecessary. Non-opioid analgesics like acetaminophen and NSAIDs are recommended for their additive effects, barring contraindications. The document advises against outpatient opioid prescriptions beyond the acute pain period, typically suggesting a 3-5 day supply. It highlights the importance of avoiding meperidine and the safe use of morphine in conditions like biliary colic. The document also covers opioid toxicity management, emphasizing naloxone use, and discusses the safety profiles of NSAIDs, noting their potential adverse effects in specific populations. Additionally, it outlines the use of local anesthetics, their toxic doses, and techniques to minimize injection pain, while cautioning against certain agents like tramadol and demerol due to their adverse effects and interactions.
```
...
1. Acute pain is an urgent condition requiring rapid assessment and treatment.
2. Treatment of acute pain is different than treatment of chronic pain. Management of chronic pain should be done in consultation with the provider responsible for the patient’s long-term management.
3. Titrated opioid IV analgesics are the main treatment approach for moderate and severe acute pain. SC administration is preferable to IM administration when IV access is not established, and if the patient is not tolerating oral routes.
4. Oral opioids can be used for moderate pain when the IV route is not otherwise needed.
5. Outpatient opioids should be confined to the period of acute pain. Consider a 3-5 day supply after which the patient should be reassessed and/or transitioned to non-opioid analgesia for most uncomplicated acute painful complaints with a natural history of expected resolution.
6. Acetaminophen and NSAIDs should be used for pain therapy, when not contraindicated. The analgesic effects are additive to the effects of opioids and to each other.
7. Morphine, fentanyl, and hydromorphone are the preferred parenteral opioids for use in the ED. Do not use meperidine.
8. There is no evidence to support that administration of analgesia impairs diagnostic accuracy of physical exam findings.
9. There is no evidence to suggest that morphine causes more smooth muscle spasm than other opioids. Morphine is a safe drug for patients with biliary colic and nephrolithiasis.
10. Patients who are known to be diverting or abusing opioids should not be prescribed opioids for use as outpatients. When possible, opioids should be avoided in chronic pain.
11. Topical and local anesthetics can be used to treat pain associated with most ED procedures.
12. Low tissue pH (5 or 6) in infected tissue impairs local anesthetic function.

### Rosens in Perspective

Pain is something we deal with on a daily basis in the ED. This is something that we need to be really damn good at managing. As we mentioned above, acute pain is an emergent condition for the patient that requires rapid assessment and management. Tylenol, NSAIDs, and opioids form the basis for ED management of acute pain. Additionally, we have access to a whole armamentarium of local and topical anesthetics, and we need to be well-versed in their use.

We’ll try and keep the pathophysiology to a minimum, but there’s a few things we should cover:

1. Describe how a pain signal travels to the brain (Fig 3.1, 3.2, 3.3)

   See figure 3.1, 3.2, and 3.3 in Rosen’s 9th Edition Chapter in Pain Management
   - Spinal tracts associated with pain transmission are spinothalamic, spinomesencephalic, spinoreticular tracts, located in the anterolateral aspect of the cord.

2. Describe the 6 types of opioid receptors (Table 3.2)
   ...
   |-----------------------|---------|---------------------------------|
   | Mu 1                  | Euphoria, supraspinal analgesia, confusion, dizziness, nausea, low addiction potential | Beta-endorphin |
...
3. Types of peripheral nerve fibers can be found in table 3.1 in Rosen’s 9th Edition Chapter in Pain Management. We won’t go through these for the sake of time.
...
- Noxious stimulus – stimulus that is damaging or potentially damaging and results in the sensation of pain
...
Tylenol and NSAIDs (providing there are no contraindications) are reasonable first steps. If this is not sufficient, consider the addition of PO opiates.

For Severe Pain - parenteral opioids are the mainstay of treatment.
There are specific situations where adjuncts or regional anesthesia may be appropriate for your patient (e.g., fascia iliac block in hip fracture).
...
- Suboxone - stronger affinity for mu opioid receptors means that conventional opioids will likely have little to no effect (this is why it’s useful for treating opioid abuse, but poses interesting issues if a suboxone patient comes into the ED with an acutely painful condition)
...
- Aside – See box 3.5 in Rosen’s 9th Edition Chapter in Pain Management
  - Disadvantage of Intramuscular Opioid Administration
    ...
    3. Inability to predict therapeutic effect
    4. Inability to titrate dosage
    5. Diurnal variation in level achieved
    6. Disease state may affect level achieved
    7. Level dependent on intramuscular injection site
...
- ABC’s plus naloxone!
- IV, IM, SubQ: Initial: 0.4 to 2 mg; may need to repeat doses every 2 to 3 minutes. A lower initial dose (0.1 to 0.2 mg) should be considered for patients with opioid dependence to avoid acute withdrawal or if there are concerns regarding concurrent stimulant overdose (Mokhlesi 2003). After reversal, may need to re-administer dose(s) at a later interval (i.e., 20 to 60 minutes) depending on type/duration of opioid. If no response is observed after 10 mg total, consider other causes of respiratory depression. Note: May be given endotracheally (off-label route) as 2 to 2.5 times the initial IV dose (i.e., 0.8 to 5 mg) (AHA [Neumar 2010]).
...
- Patients at Risk for Adverse Events During Nonsteroidal Anti-Inflammatory Drug (NSAID) Therapy
  ...
  - Patients with liver disease or CHF – in particular, those who already taking ACEi, ARBs, or diuretics – in whom liver or heart conditions may worsen
  - Older patients are at enhanced risk for GI and renal events
  - Patients with asthma and known aspiration hypersensitivity are at increased risk of bronchospasm
...
- Esters and Amides - Local anesthetics work by reversibly blocking sodium channels in the nerve cell membrane which prevents the generation of action potentials
  - Amides - Lidocaine, bupivacaine, and co. Hepatic metabolism
...
Don’t podcast but have as add’l example for shownotes
Max dose of 1% lidocaine with epinephrine for 20kg child
Step 1 - max dose = 20kg x 7mg/kg = 140mg
Step 2a - 1% lidocaine = 10mg/mL (1% x 10)
Step 2b - 140mg x 1mL/10mg = 14mL of 1% lido with Epi
...
- Mucous membrane
  - Cocaine. Potent vasoconstrictor along with anesthetic activity. Generally, avoid doses >200mg and avoid in patients with known CAD (we know all about that vasospasm)
...
### 1. What agents can be used as a substitute in cases of anaphylaxis to local anesthetic?
