```yaml
title: "CrackCast Episode 49: General Principles of Orthopedic Injuries"
url: "www.crackcast.org"
date: 2016-11
source: "CanadiEM – CrackCast"
original_file: "CC.Ep49.GeneralOrthoPrinciples.pdf"
summary: |
  The document provides a comprehensive overview of general principles in managing orthopedic injuries, emphasizing the importance of urgent consultation for specific fracture types, such as long bone and open fractures, and those with neurovascular compromise. Key diagnostic principles include obtaining thorough patient history, conducting a detailed physical exam, and ensuring adequate imaging, with a focus on treating clinically suspected fractures even if initial imaging is negative. Critical management steps include assessing neurovascular status during interventions, providing clear discharge instructions, and recognizing complications like compartment syndrome, which requires prompt fasciotomy. The document also outlines the classification and management of open fractures, the association of specific nerve injuries with particular fractures, and the diagnostic criteria for complex regional pain syndrome (CRPS). Additionally, it highlights the management of fat embolism syndrome and differentiates between conditions such as sprains, strains, tendonitis, and tendonosis.
```
...
- Principles
  - Get key information from the patient regarding age, mechanism of injury, chief complaint, medical history
  - Do a physical exam to predict the injury and what additional imaging is needed
  - If imaging shows no fracture, but the patient examines as clinically having a fracture → TREAT as a fracture
...
- Sacral: Cauda equina syndrome
- Acetabular fracture: Sciatic nerve
- Hip fracture: Femoral nerve
- Femoral shaft fracture: Sciatic nerve
- Knee dislocation: Tibial or peroneal nerve
- Lateral tibial plateau fracture: Common Peroneal nerve
...
- Reduced arterio-venous gradient at the tissue level
- Mismatch between a closed, non-expandable space and its contents
...
- Fat globules in the lung or peripheral circulation after a LONG bone fracture or major trauma
- Often subclinical
- Signs: Respiratory distress, hypoxemia, ARDS, confusion, mental status change suddenly, thrombocytopenia, petechial rash, fever, tachycardia, jaundice
...
- Bursitis: Inflammation of a bursa, usually due to overuse or trauma

### 5. Please differentiate between tendonitis and tendonosis

- Tendonitis: Inflammatory condition characterized by pain at tendinous insertions into bone, occurring in the setting of overuse
- Tendonosis: Chronic condition describing degenerative changes, chronic tendinopathy, or partial rupture

## References

- www.crackcast.org
- See Table 49-1 for a list of >40 fracture eponyms
- See Box 49-3 for a huge list of compartment syndrome causes
- See table 49-4 for nerve injury details
- See table 49-6 for CRPS diagnostic criteria
```