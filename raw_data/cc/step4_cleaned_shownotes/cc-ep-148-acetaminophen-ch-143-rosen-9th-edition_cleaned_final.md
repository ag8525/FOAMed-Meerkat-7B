---
title: "CrackCast Episode 148: Acetaminophen"
url: "https://canadiem.org/crackcast"
date: 2018-01
source: "CanadiEM – CrackCast"
original_file: "CC-EP-148-Acetaminophen-Ch-143-Rosen-9th-edition.pdf"
summary: |
  Acetaminophen overdose is a critical condition that requires prompt recognition and management due to its potential to cause severe hepatocellular toxicity. The document emphasizes the importance of understanding acetaminophen metabolism, where the toxic metabolite NAPQI is formed and usually detoxified by glutathione. In overdose situations, glutathione stores are depleted, leading to liver damage. The management of acetaminophen toxicity involves assessing the risk using the Rumack-Matthew nomogram, conducting diagnostic testing, and administering N-acetylcysteine (NAC) as an antidote. NAC works by replenishing glutathione, directly reducing NAPQI, and stabilizing hepatocytes. It is crucial to initiate NAC within 8 hours of ingestion for optimal outcomes. The document also outlines the stages of acetaminophen toxicity, criteria for liver transplant consideration, and the impact of co-ingestants like diphenhydramine on overdose management. Additionally, it discusses the protocols for NAC administration and the indications for dialysis in severe cases.
...
- In patients with elevated liver enzymes/abnormal liver function and with or without renal failure, think:
  ...
  - Cyclopeptide-containing mushroom toxicity (e.g., Amanita Phalloides)
  - Viral hepatitis
  - Wilson disease
  - Other hepatic toxicities (e.g., valproic acid, isoniazid [INH], statins, herbal medications, vinyl chloride, and polychlorinated biphenyls)

## Core Questions

### 1) Describe the metabolism of acetaminophen
...
- Where it all goes bad for the body:
  - N-acetyl-P-Aminophenol (aka Tylenol) gets oxidized via CYP2E1 to N-acetyl-p-benzoquinone imine NAPQI
...
- Anyone with previous liver dx for whom an APAP level cannot be measured within 8 hrs
...
But when is it useful to check an APAP level in chronic ingestion? See table 143.2.
...
Note: typical therapeutic dose of acetaminophen = serum acetaminophen concentration peaks below 30 μg/ mL and is less than 10 μg/mL at 4 hours.

### 6) What are common reactions to the PO and IV NAC? How are these managed?

- Most common side effects are vomiting & mild anaphylactoid reactions
- Treat these with reducing rate of infusion and antihistamines
- Rare severe anaphylactic reaction, treat by usual kitchen sink approach (fluids, stop drug, epi to support hypotension, antihistamines, steroids)

Note*** as per Jesse: “PO NAC is essentially never used in a Canadian context... more of an American thing.

Interestingly anaphylactoid reactions are more common in patients with negative acetaminophen levels.”

See Table 143.3 for Side effect profile for NAC formulations.

### 7) Describe a NAC protocol for IV administration

*** Always check with your local institution's protocol and always call your local tox centre!***
...
- Contraindications =
  ...
  - Chronic ingestion (i.e., over 8 hrs)
  - Co-ingestions w/ drugs that affect gut motility (e.g., anticholinergics)
...
### 2) Define a massive acetaminophen overdose

a) How does this affect the NAC protocol
