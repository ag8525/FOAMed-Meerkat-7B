---
title: "CrackCast Episode 072: Otolaryngology"
url: "https://canadiem.org/crackcast/"
date: 2017-04
source: "CanadiEM – CrackCast"
original_file: CCEP072.Otolaryngology.pdf
summary: |
  The document provides a comprehensive overview of otolaryngology topics relevant to emergency medicine, focusing on conditions such as otitis media, otitis externa, Ramsay Hunt syndrome, sudden sensorineural hearing loss, epistaxis, neck masses, and sialolithiasis. Otitis media is classified into acute, chronic, and recurrent forms, with diagnosis based on signs of middle ear inflammation and effusion, and treatment involving antibiotics and symptom management. Complications can be intratemporal or intracranial, including hearing loss and meningitis. Otitis externa, often caused by Pseudomonas and S. aureus, is treated with cleansing and topical antibiotics, while malignant otitis externa requires imaging and prolonged antibiotic therapy. Ramsay Hunt syndrome, a reactivation of VZV, presents with facial paralysis and vesicles, treated with antivirals. Sudden hearing loss is an ENT emergency, with treatment options including steroids and antivirals. Epistaxis management involves resuscitation, anterior and posterior packing, and potential use of antibiotics. Sialolithiasis, primarily affecting the submandibular gland, is managed with massage, sialagogues, and possibly surgical intervention.
...
The head and neck is home to some very important structures. Those painful ears are going to be a common presentation for any emergency room physician’s practice. 80% of kids will have a case of AOM in their life, with 40% having up to three episodes by age 3.

## Core Questions

### 1) Define Otitis Media

a) Acute - signs and symptoms of an infection with evidence of effusion

Note: also called acute suppurative or purulent otitis media

b) Chronic - Also called chronic suppurative OM, refers to chronic discharge from perforated tympanic membrane

c) Recurrent - >3 episodes of AOM over 6 months or >4 in one year

Note: Otitis Media with effusion is effusion WITHOUT signs and symptoms of infection. Also described as serous, non-suppurative, or secretory OM.

### 2) Describe the diagnosis and treatment of Otitis Media

Essentially, the diagnosis requires two components:

1) Signs and symptoms of middle ear inflammation
...
- Cholesteatoma
  - An abnormal growth of squamous epithelium in the middle ear +/- mastoid, can lead to:
...
a) Differentiate from malignant otitis externa

Spectrum of disease: think cellulitis of the external auditory canal. Most likely causative agents: Pseudomonas and S. Aureus. Can be polymicrobial. Swimmer’s ear is a form of OE.
...
- Topical antibiotics: cure rate 80% within 10 days.
...
- Oral or IV cipro is the way to go: great penetration into bone. Treatment duration for 6-8 weeks.
...
This is Herpes zoster oticus. Think viral infection of the auricle. Classic reactivation of VZV in the 8th cranial nerve, can lead to hearing and vestibular problems. Can involve the facial nerve (CN 7) leading to facial paralysis. Thought to be worse than Bell’s palsy from HSV.
...
Here we are worried about sudden sensorineural hearing loss (SSNHL). Usually idiopathic hearing loss of >30db. This is an ENT emergency! Usually seen in 40s-50s, male:female.

Can be as simple as difficulty with conversation to complete hearing loss. Outcome is based upon the severity of hearing loss. Look for accompanying tinnitus for a clue. Make sure you don’t miss a central (stroke) cause.

Examine tympanic membrane and auditory canal (cerumen impaction or FB). Solid neuro exam including Weber and Rinne’s test.

Treatment: Mainstay but unsupported by literature is antivirals and steroids. Other treatments with mixed results include:
...
- Leave packs in for 2-5 days as per ENT. Antibiotics here are important (Keflex or Amox-Clav)
...
Treatment:
- Massage/heat
- Sialagogues (e.g., lemon candies to promote salivation)
- Antibiotics if infection suspected (fever, increasing pain, purulent discharge)
- Lithotripsy as per ENT
- Treatment failure may end with surgical removal of entire gland

ENT follow-up is important immediately if the stone cannot be removed in ED, or within 4-5 days if it can be.

## References

- Content supplemented with UpToDate: Otitis Media, check it out for more!
- Images and additional content sourced from Wikipedia and Rosens Emergency Medicine.
