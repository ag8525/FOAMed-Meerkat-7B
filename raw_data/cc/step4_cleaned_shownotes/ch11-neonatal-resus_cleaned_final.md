---
title: "CrackCast Episode 11: Neonatal Resuscitation"
url: "www.crackcast.org"
date: 2016-03
source: "CanadiEM – CrackCast"
original_file: "Ch.11 Neonatal Resus.pdf"
summary: |
  The document provides a comprehensive guide on neonatal resuscitation, emphasizing the unique physiological challenges newborns face, such as hypoxia, hypothermia, and hypoglycemia. Key diagnostic and management principles include the use of the APGAR score for initial assessment, with a focus on heart rate and respiratory effort. The management of meconium involves selective tracheal suctioning based on respiratory effort and heart rate. Oxygen should be used cautiously, starting with room air, to avoid potential toxicity. CPR is indicated if the heart rate remains below 60 bpm despite adequate ventilation. The document outlines the equipment needed for resuscitation, the steps of the neonatal resuscitation algorithm, and specific considerations for preterm infants. It also discusses the indications for intubation and reasons not to resuscitate, such as extreme prematurity or certain congenital anomalies. The document concludes with a review of specific neonatal disorders and a case study to illustrate practical application.
...
1. Newborns have rapidly changing cardiopulmonary physiology, and as such have:
   - Their own unique vital signs
   - Unique stress responses
2. Focus entirely on respiratory management (not cardiovascular)
...
Pathophysiology of the transition from intra to extrauterine life:
...
- May be asymptomatic!
- Symptoms:
  - Apnea, color changes, resp. distress, lethargy, jitteriness, seizures, acidosis
...
1. PPE equipment – gown, gloves, mask, etc.
2. Blankets to warm and dry the neonate
3. Radiant warmer
4. Airway stuff
...
5. Airway securing gear: tape, scissors
6. Confirmation equipment:
   - CO2 detector
   - Stethoscope
   - Chest x-ray machine
7. Equipment for umbilical vein catheterization
...
5. Were medications given during delivery or drugs taken intrapartum?
...
- Supplemental oxygen is thought to be toxic to neonatal lungs, brains, and eyes so don’t routinely give it
- After 15-20 min SP02 goal is 90-95% NOT 100%

### 6) What is the indication for CPR in a neonate?

CPR is started if the HR is < 60 bpm **despite adequate ventilation for 30 seconds**

### 7) Describe how to perform CPR on a neonate

Either the encircling hands technique or two fingers on the lower ⅓ of the sternum. But the encircling hands generates higher systolic and coronary perfusion pressures. Don’t forget the 5 Ps! Ratio is 3:1.
...
1. <23 weeks gestational age
2. <400 g birthweight
3. Confirmed anencephaly
4. Trisomy 13
5. Trisomy 18
...
- ***Any neonate with HR <60 despite adequate oxygenation and ventilation for at least 30 seconds should get CPR
...
2. Epinephrine
   - Indications:
     1. Asystole
     2. HR < 60 despite effective ventilations with 100% O2 and CPR
   - Ideally administered IV
     1. Dose:
        - 0.01 to 0.03 mg/kg OR
        - 0.1 ml to 0.3ml/kg of 1:10000
     2. Repeat q3-5mins
   - If the ET route is used a higher dose is needed (0.1mg/kg)
3. Naloxone
   - Only for the neonate who is adequately ventilated
   - Great for the mother who received opioids during labor
   - Shouldn’t be used for the narcotic-addicted mother:
     1. It may precipitate withdrawal seizures
...
4. Glucose
   ...
   - Treatment:
     ...
     2. Higher concentrations of glucose should be avoided because they are hyperosmolar
     3. **Encourage breast or bottle feeds**
...
- Ventilation distends the stomach and worsens respiratory distress because it is in the chest cavity

Meningomyelocele/Omphalocele:

- Should not be placed on their backs:
...
[CrackCast Show Notes – Neonatal Resuscitation – March 2016](www.crackcast.org)
```