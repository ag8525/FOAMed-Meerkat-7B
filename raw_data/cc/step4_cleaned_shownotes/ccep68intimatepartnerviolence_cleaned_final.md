---
title: "CrackCast Episode 68: Intimate Partner Violence"
url: "https://canadiem.org/crackcast"
date: 2017-03
source: "CanadiEM – CrackCast"
original_file: "CCEp68.IntimatePartnerViolence.pdf"
summary: |
  The document focuses on Intimate Partner Violence (IPV), highlighting its prevalence, risk factors, and the critical role of emergency physicians in identifying and managing IPV cases. Key risk factors for IPV victimization include being female, younger age, exposure to childhood violence, and lower socioeconomic status. Physicians are encouraged to maintain a high index of suspicion and use universal screening tools to identify IPV, as victims often present with unrelated complaints. Management involves safety planning, respecting patient autonomy, and meticulous documentation, especially given the potential for legal proceedings. Ethical considerations include confidentiality and informed consent, with mandatory reporting laws varying by jurisdiction. The document emphasizes the importance of physician behaviors that encourage disclosure, such as attentive listening and nonjudgmental attitudes, and outlines specific interventions based on the type and severity of IPV exposure.
...
1. List 7 risk factors for Intimate Partner Violence (IPV) victimization as well as list 3 concerning presentations for IPV
2. List the 3 typologies of the perpetrators generally seen
3. List 5 clues on history and physical exam of IPV
4. List 4 features of physician behaviors that encourage disclosure of IPV
5. List 4 historical features for strangulation. List 6 physical examination findings of strangulation.
...
1. Woman with injuries to head, face, or neck (most common injury type)
...
2. Antisocial or generally violent individual
3. Non-violent outside home with no psychopathology. Often evidence of passive dependency or Obsessive Compulsive Personality Disorder

### 3) List 5 clues on history and physical of IPV
...
1. Centrally located injury (i.e., trunk, breasts)
...
Note: Gender of physician does not appear to be a factor in disclosure.
...
- Strangulation occurs in upwards of 40% of IPV patients and is the most common predictor of homicide. A woman is murdered by her current/ex-partner every 6 days in Canada.
  a. Hoarse voice
  b. Dysphagia or odynophagia
  c. Difficulty breathing
  d. LOC
  e. Incontinence
  f. Confusion
  g. Chronic concussive symptoms (from “shaken adult syndrome”)

### 6) Describe one tool for intimate partner violence screening
...
See page 880 for a short list of these questions. Assessing risk factors for possible lethal outcome is crucial. Based on one study, 50% of women did not accurately perceive their risk of being killed by their partner.

### 7) Describe the role of the physician in the management of disclosed IPV
...
Remember that fear keeps many individuals in these violent situations - and the cost of disclosure or making a change may simply seem to exceed the benefits. (e.g., risk of deportation, poverty, abandonment from their social circles, child well-being). Giving the person detailed informed choice and respecting that may leave the door open in the future for reconsideration. Re-abuse using our professional power by making disparaging remarks is not helpful. Helping the patient plan for safety - especially if the patient is in the precontemplation/contemplation stages - is important. Such as getting into a protected room (with an escape) while the person has an outburst, having a “go-bag,” having a safety plan, etc.

### 8) List 5 types of IPV exposure and corresponding appropriate interventions

1. No history of suspicion of IPV
2. Prior history but no current exposure
   - Add history of IPV to medical record
3. Recent or current abuse but no injuries and no elements of danger on assessment
   - Add IPV to problem list and give educational materials
4. Current abuse with injuries on findings on danger assessment
   - Complete history, involve third parties as required (police, social services, IPV advocate)
5. Suspicion but denies IPC
   - Consider involving social services or IPV advocate and give educational materials

### 9) List 2 ethical considerations in IPV

1. Confidentiality
   - For our US friends: HIPAA you can release information to government authorities or social service however patients may specifically request non-release. It’s complicated, know your local laws.
     - This is especially tricky when the abuse is sheltered under the abuser’s health insurance...How does the victim obtain treatment and counseling without their partner being notified?
2. Informed consent and autonomy
   - IPV victims are free to disclose or not
   - However, some states (California) require physicians to report patients with injuries suspected to be assault-related to law enforcement

### 10) Describe the key elements in documentation for IPV patients.

- Like sexual assault patients, these have a high likelihood of going to court and have to be meticulously documented. It is also really important to list IPV as the discharge diagnosis. The preferred CDC term is “intimate partner violence”; whereas “adult maltreatment” is used by ICD - whether suspected or confirmed
