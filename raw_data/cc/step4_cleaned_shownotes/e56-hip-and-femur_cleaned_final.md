---
title: "CrackCast Episode 56: Hip and Femur"
url: "https://canadiem.org/crackcast"
date: 2017-01
source: "CanadiEM – CrackCast"
original_file: "E56 Hip and Femur.pdf"
summary: |
  The document focuses on hip and femur pathologies, emphasizing the high incidence and significant morbidity associated with hip fractures, particularly in osteoporotic postmenopausal women and certain pediatric conditions like Perthes disease and SCFE. It outlines the anatomy of the hip, including the vascular and nerve supply, and discusses the pathophysiology of hip fractures and osteoarthritis. Diagnostic strategies include the use of hip radiography, with MRI as the gold standard for occult fractures. The document also details the causes of avascular necrosis (AVN) and lists common primary cancers that metastasize to bone. Management of hip dislocations is highlighted, with reduction techniques and the importance of timely intervention to prevent complications like AVN. Pediatric considerations include the risk of growth arrest with hip trauma and the classification of femur fractures, with a focus on the Delbet classification system.
...
- Hip fractures account for 70% of the medical costs associated with fractures!
  - 4:1 women to men
- Mostly osteoporotic, postmenopausal women
- May also affect 2-14-year-olds
  - Perthes disease
    - AVN of the femoral head (more common in boys)
  - Slipped capital femoral epiphysis (SCFE)
    - Peaks at 13.5 years (more common in boys!)
...
- Pathophysiology
  - Hip fractures:
    - 20% of people die in the year after a hip fracture due to osteoporosis
  - Hip osteoarthritis
...
### 4) List 15 causes of hip pain without an obvious fracture

1. Referred pain - lumbar/spine/knee
   - Diskitis
   - Lumbar disk herniation
   - Knee pathology
2. Hip bone pathology
...
### 5) List 6 techniques for reduction of the hip

- Huge force is needed to dislocate the hip - so look for a fracture (70% of the time) and other multisystem injuries
- Examination:
...
From: [edprocedures.com](http://edprocedures.com/hip-reduction-whistler-technique/)

4. Rochester method (similar to Whistler method)
   - Patient is placed supine with uninjured hip and knee flexed (this knee acts as a pivot point for the surgeon's hand);
   - One of the surgeon's hands is placed underneath the injured knee and over top of the uninjured knee;
   - This maneuver flexes both the patient's injured hip and knee;
...
From: [wheelessonline.com](http://www.wheelessonline.com/ortho/closed_reduction_of_posterior_hip_dislocation)

5. Traction-countertraction method

6. And many others

See: [ncbi.nlm.nih.gov](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4821229/) for an exceptional list of 12 different techniques with figures
...
#### c) 6 causes of a child with a limp
  ...
  - Etiologies:
    - Inflammation / infection - look for a joint effusion on ultrasound
      - Transient synovitis
        ...
        - Usually boys 3-10 years old
      - Septic arthritis
        - KOCHER criteria:
          - [mdcalc.com](http://www.mdcalc.com/kocher-criteria-septic-arthritis/)
    ...
    - SCFE
      ...
      - Boys > girls, usually age 10 years
    ...
    - Avulsion injuries
      - Leading to isolated fracture of the lesser/greater trochanter
