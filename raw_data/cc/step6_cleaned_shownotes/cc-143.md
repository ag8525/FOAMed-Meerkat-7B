---
title: "CrackCast Episode 143: Diving Injuries and Dysbarism"
url: "https://canadiem.org/crackcast/"
date: 2018-01
source: "CanadiEM – CrackCast"
original_file: "CCE143-Diving-Injuries-and-Dysbarism-1.pdf"
summary: |
  The document discusses diving injuries and dysbarism, focusing on conditions such as decompression sickness (DCS), arterial gas embolism (AGE), and barotrauma. Key diagnostic principles include the importance of a focused dive history and physical examination, with imaging and laboratory studies being less useful for ruling in decompression illness. Critical management steps involve immediate administration of 100% oxygen and recompression therapy for DCS and AGE. The document highlights the significance of understanding gas laws like Boyle's and Henry's laws in explaining the pathophysiology of diving-related conditions. It also emphasizes the need for rapid intervention in cases of AGE, which is the most common cause of death in divers, and outlines the management of DCS, including pre-hospital and emergency department care. Major warnings include the risks associated with rapid ascent and the importance of recognizing symptoms early to prevent severe outcomes.
...
- International numbers by country: [DAN International](https://www.diversalertnetwork.org/about/international)
...
Since the invention of SCUBA (self-contained underwater breathing apparatus) gear, people are able to use compressed air or gas mixes to dive even deeper and gain increasing popularity.

Diving-related injury incidence varies from 0.01%-0.02%, and mortality is 1-9 per 100,000 dives.
...
- Water = denser than air
  - E.g., An alpinist needs to ascend 18,000 ft to reduce atm pressure by 50%, but a diver only needs to descend 33 ft in seawater to double atmospheric pressure.
...
### 1. List 5 potential injuries in scuba diving other than dysbarisms
...
...let's talk about some laws of physics - defining the behavior of liquids and gases…This first one is easy, think of it like a tube of toothpaste. Since most of our body is made of water……
...
- Therefore, with heat, the volume of a gas will increase.

#### d. General Gas Law

P1 x V1/T1 = P2 x V2/T2
- This law combines Charles’ and Boyle’s gas laws. It relates pressure, volume, and temperature in one equation when they aren’t constant.
...
| Middle Ear Barotrauma (consider ruptured TM) | Inner Ear Barotrauma | Alternobaric Vertigo | Middle Ear Decompression Sickness |
|----------------------------------------------|----------------------|----------------------|----------------------------------|
| Very common                                  |                      |                      | Dive occurs near compression limits |
| Transient and self-limited                   |                      |                      | **Most common complaint of scuba divers** - 10-30% experience this |
...
|                                              |                      |                      | If it suddenly equilibrates with a valsalva can lead to inner ear hemorrhage or labyrinthine window tear. |
|                                              |                      |                      | Due to an inability to equalize pressure within the middle ear during ascent (usually this happens naturally on ascent). This error is due to mucosal edema. |
...
|                                              |                      |                      | Further pressure may lead to TM rupture, nystagmus, vertigo, and CN VII palsy |
|                                              |                      |                      | Hearing loss, severe vertigo, nausea, tinnitus, fullness. |
|                                              |                      |                      | Severe nystagmus, positional vertigo, ataxia, vomiting. |
|                                              |                      |                      | PERSISTENT symptoms: +ve Romberg, persistent hearing loss |
|                                              |                      |                      | Nystagmus, emesis, TM injury, nausea |
|                                              |                      |                      | Usually self-limited. |
| Descent                                      | Descent              |                      | At depth OR During ascent |
|                                              |                      |                      | Ascent - or soon after surfacing |
...
- Signs and Symptoms
  - Euphoria, false well-being, confusion, poor judgment/skill, disorientation, laughter, diminished motor control, paresthesias/numbness in lips/gums/legs.
...
- Risk factors:
  - Patient:
    ...
    - Presence of a Patent Foramen Ovale
      - Most sport divers aren’t screened for this - and some may even have normal bubble-ECHO studies: suggesting that the PFO may only open at high ambient pressures
  - Energy:
...
“The 1’s”
- MSK system, skin, lymphatics

#### Type II DCS

The “doubles”; the SERIOUS stuff is SECOND
- CNS, ear, lungs, heart

| Symptoms | Diagnosis |
|----------|-----------|
| Periarticular pain in the arms, and legs. Elbow and shoulder pain most common. | Can be confirmed by placing a BP cuff on an affected joint and inflating it to 150-200 mmHg with pain relief! |
| Watch for cutis marmorata - patchy cyanotic marbling of the skin (trunk and torso) - may first show up as pruritus, then erythema, then mottling. This is due to venous stasis. | CT and MRI may identify the gas bubbles in the brain/spinal cord |
| Lymphatic obstruction presents with edema. | ECG may show right-sided heart strain in pulmonary DCS |

Don’t forget that DCS I-II-& AGE can coexist

### 9. List 5 potential pathologies associated with pulmonary barotrauma

A diver who takes a full breath at 33 fsw (feet below seawater), will have TWICE the volume of air in their lungs at the surface (according to Boyle’s law).
...
ALL types of decompression illnesses require recompression - with the goal of washing out nitrogen, compressing air bubbles, deliver oxygen to ischemic tissue. Recompression therapy is the only definitive treatment for DCS and AGE - even if spontaneously resolved.

Recompression therapy may still be helpful, even if delayed up to 10-14 days.
...
#### a. How would you manage a patient requiring recompression in the pre-hospital and ED environment (pre-HBO treatment)?

While resuscitating in the ER:
...
- **Most common cause of death in divers**
  - Especially with cerebral or coronary embolization
...
| DCS | AGE |
|-----|-----|
| Pulmonary DCS due to rapid ascent without proper exhalation | Gas bubbles enter the pulmonary vein due to a ruptured alveoli that leaks air into the pulmonary vein |
| Type 2 DCS - the more severe type | Venous gas emboli develop due to barotrauma or DCS that overwhelms the pulmonary circulation |
| Rare, can progress to AGE | Venous emboli sneak through a patent foramen ovale |
| Symptomatic venous gas embolism to the lungs → chest pain, wheezing, dyspnea, pharyngeal irritation | Embolization causes the most serious effects when it spreads to the brain or coronary arteries |
| “Air lock” is another potential risk in pulmonary DCS where the RV outflow tract is obstructed leading to circulatory collapse and death (or progressing to AGE if there is a PFO) | Symptoms of altered mental status/stroke or cardiac ischemia/arrhythmias |

The 10-minute rule of thumb:
“Any diver breathing compressed air at any depth underwater who surfaces unconscious or who loses consciousness within 10 minutes of reaching the surface should be assumed to be suffering from AGE.”

DCS typically presents after 10 minutes and may present up to 24 hrs.

## Wisecracks

### 1. Describe memory aids for the gas laws

- Pascal’s law - Tube of Toothpaste: A pressure applied to any part of a liquid is transmitted equally throughout.
- Boyle’s law - Syringe aspirating fluid: At work, you draw up local anesthetic or any drug by withdrawing a plunger on a syringe (decreasing the pressure inside the chamber and increasing the volume of the chamber) thereby creating an area of less negative pressure and more volume for the drug or liquid to enter! The incremental changes in pressure (and therefore volume) are greatest at the surface, so barotrauma most commonly occurs near the surface (either at the beginning or at the end of a dive). Long or deep dives are not required for barotrauma.
...
See: [DAN Breathing Gas Mixture](https://www.diversalertnetwork.org/medical/faq/Breathing-gas-mixture)
...
- [Divers Alert Network](https://www.diversalertnetwork.org/about/international)
- [DAN Breathing Gas Mixture](https://www.diversalertnetwork.org/medical/faq/Breathing-gas-mixture)
- Wikipedia
```