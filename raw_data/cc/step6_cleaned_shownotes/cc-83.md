---
title: "CrackCast Episode 83: Infective Endocarditis and Valvular Pathology"
url: "https://canadiem.org/crackcast"
date: 2017-06
source: "CanadiEM – CrackCast"
original_file: "CCEp83.InfectiveEndocarditisandValvularPathology.pdf"
summary: |
  This document provides a comprehensive overview of infective endocarditis (IE) and valvular pathology, focusing on risk factors, common causative organisms, and diagnostic criteria, particularly the Duke Criteria. It highlights the importance of blood cultures and echocardiography in diagnosis and outlines the treatment strategies, including empirical antibiotic therapy with vancomycin and ceftriaxone, and surgical interventions for severe cases. The document also discusses the complications of IE, such as heart failure and embolic events, and the management of acute and chronic valvular conditions like mitral regurgitation and aortic stenosis. Additionally, it covers the Jones Criteria for diagnosing acute rheumatic fever and the management of rheumatic fever with antibiotics and anti-inflammatory agents. The document emphasizes the need for careful management of valvular diseases to avoid complications, particularly in patients with prosthetic valves.

# Chapter 83 – Infective Endocarditis and Valvular Disease
...
1. List 6 risk factors for bacterial endocarditis
...
9. List the indications for infectious endocarditis prophylaxis. What are the empiric antibiotics used for patients with suspected infectious endocarditis?
...
13. How is acute mitral regurgitation managed?
...
18. What is critical aortic stenosis? Outline the ED management for a patient with critical aortic stenosis with CHF and hypotension.
...
- Predisposing factors for bacterial IE (Box 83-4):
  ...
  - Congenital cardiac lesions either repaired or unrepaired (VSD, pulm stenosis, Tet. of Fallot, palliative conduits)
...
- Break this list down into:
  - Cardiac
  - Non-cardiac: IVDU, indwelling IV catheters, immunosuppression, recent dental/surgical procedure.
...
- Clinical Features:
  ...
  - Non-specific: weakness, myalgias, back pain, dyspnea, chest pain, cough, headache
  - Murmur usually absent in EARLY disease, present in < 30%
...
- Major Criteria:
  1. >2 cultures positive for typical pathogens
  2. ECHO findings
...
- Minor Criteria:
  ...
  5. Micro. evidence
  6. Echo. findings other than above

- Caveats: they were designed for people with native heart valves; thus they are less sensitive in prosthetic valve IE, right-sided IE, or cardiac devices.
...
- Native valve endocarditis is usually caused by a gram +ve organism; people with prosthetic valves require more elaborate antimicrobial regimens (i.e., involve ID and the cardiac surgeon!)
  - Empirical ED therapy:
    - Vancomycin 15 mg/kg IV q12hrs
      - Especially with history of IVDU!
    - Ceftriaxone 2 g IV
      - Can also be exchanged with ampicillin and Gentamicin 1mg/kg IV q8hrs
...
- Because the evidence for antibiotic prophylaxis is weak, the UK no longer recommends it. See: [Heart Journal](http://heart.bmj.com/content/103/12/937)

- However, Rosen’s doesn’t cover it in much detail. They state that:
  - All procedures routinely performed in the ED unless obviously stimulating an abscess or infection do NOT require prophylactic ABX in patients with prosthetic heart valves.
...
- So, we're shifting pace to talk about Rheumatic fever….let’s take a quick dive into this rare disease before discussing the Jones criteria.
...
- Principles of Disease
  ...
  - Anyone with a hx of ARF is predisposed to recurrent infections and heart damage
...
### 13. How is acute and chronic MR managed?
...
- Mitral Stenosis
  - #1 cause is Rheumatic Heart disease (>85%)
...
- Aortic insufficiency
  ...
  - Pathophysiology
    - LV compliance decreases, and LV pressure increases --> pulmonary congestion
...
- Compensated LVH can maintain CO until the stenosis becomes too severe!
  - Then patients become
    ...
    - Need to delicately balance myocardial O2 supply and demand
- Management:
...
- Hemolysis
  - Hemolytic anemia due to shear forces
...
- Non-tender erythematous macules on the palms and soles. They are micro-abscesses. Much more common than Osler's and Roth's spots (these were described in the pre-antibiotic era).
...
### 2. What are the HACEK organisms, and what is their significance in patients with IE?

- HACEK
  - Haemophilus, actinobacillus, cardiobacterium, eikenella, kingella
- These are rare <5-10%. They are fastidious gram-negative bacilli
...
- Aortic regurg/insufficiency
  - Can acutely present in cardiovascular collapse and CHF - think about florid infective endocarditis or aortic dissection. These people need surgery! (Diuretics, and vasodilators in the meantime, maybe dobutamine!)
- Aortic stenosis:
...
- [Heart Journal](http://heart.bmj.com/content/103/12/937)
- CanadiEM – CrackCast: [https://canadiem.org/crackcast](https://canadiem.org/crackcast)
```