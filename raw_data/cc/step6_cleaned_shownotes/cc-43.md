---
title: "CrackCast Episode 186: Spinal Trauma"
url: "https://canadiem.org/crackcast/"
date: 2016-10
source: "CanadiEM – CrackCast"
original_file: "Ch.43 Spinal Trauma.pdf"
summary: |
  The document focuses on spinal trauma, particularly cervical spine injuries, detailing mechanisms, diagnostic approaches, and management strategies. It outlines the three-column model of spinal anatomy and categorizes cervical spine injuries by mechanism, indicating their stability. Key diagnostic tools include the Canadian C-Spine Rule and Nexus Rule, which guide imaging decisions. The document also describes incomplete cord syndromes, such as central cord, anterior cord, and Brown-Sequard syndromes, and highlights the importance of recognizing unstable injuries like Jefferson and odontoid fractures. Management considerations include the controversial use of steroids, indications for surgical intervention, and the differentiation between neurogenic and spinal shock. The document emphasizes the need for CT-A in certain injuries to rule out vascular damage and discusses the increased risk of cervical injury in conditions like Down's Syndrome and Rheumatoid Arthritis due to ligamentous laxity.
...
- MVC’s are 40% of spinal injuries
  - Rf’s speeding, ETOH, and failure to use restraints
...
### 2) List cervical spinal injuries for the following mechanisms, and indicate whether they are stable or unstable
...
- **Flexion-Rotation x 2**
  - Rotary atlantoaxial dislocation - best visualized with an open-mouth odontoid view as lateral asymmetry between odontoid and the base of C2.
    - Unstable
  - Unilateral facet dislocation - Flexion rotation injury where the facet acts as a fulcrum, causing contralateral facet to dislocate. The key in the ED is often torticollis, as the patient neck is mechanically locked in a twisted position
    - Stable
...
Second: ABC’s of lateral C/S films
...
Forth: AP view - less useful
- Alignment - lateral edges of the C-spine and spinous process should form straight line
- Bony abnormalities - look at each vertebra for fracture lines

### 5) Describe Canadian C-Spine Rule + Nexus Rule

CCS: prospective cohort study in Canadian adults presenting to tertiary care hospitals with acute trauma to the head or neck with GCS 15. Required one of the following: neck pain, or no neck pain + all of (injury above clavicles, non ambulatory and dangerous mechanism). Ian Stiels group generated a decision rule with sensitivity of 99.7% and specificity of 50.7 %.
...
- **Horners Syndrome**
  - Miosis, ptosis, anhydrosis. Damage to ipsilateral sympathetic cervical chain.
- **Cauda Equina**
...
5. Thyroid masses or removal
6. Trauma to base of neck
7. Pancoast tumor
8. Thoracic aneurysm
9. Sympathectomy
...
1. C1-C3 #
2. Any vertebral body fracture
3. Transverse foramen fracture
4. Facet sub/dislocation
...
1. Any cervical spine fracture
2. Unexplained neurological deficit incongruous with imaging
3. Basilar cranial fracture into carotid canal
4. Le Fort II or III fracture
5. Cervical haematoma
6. Horner syndrome
7. Cervical bruit
8. Ischaemic stroke
9. Head injury with Glasgow Coma Scale score<6
10. Hanging with anoxic injury
```