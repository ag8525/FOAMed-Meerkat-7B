...
**Clinical Point:** Does the addition of a serratus anterior plane block to a protocolized bundle of care in the emergency department improve pain control?
...
- **3. Sample Size:** This was a relatively small study with challenges in patient recruitment during the COVID-19 pandemic. However, it has promising results that need to be replicated in a larger sample size to provide more confidence in making conclusions. Nonetheless, it is promising in terms of efficacy and will hopefully encourage larger studies to be undertaken.
