...
**Background:** Up to 25% of patients presenting to the ED with acute vestibular syndrome (AVS) have a central cause of their vertigo – commonly posterior stroke. Posterior circulation strokes account for approximately up to 25% of all ischemic strokes. MRI diffuse-weighted imaging (DWI) is only 77% sensitive for detecting posterior stroke when performed within 24h of symptom onset. As an alternative diagnostic method, the HINTS exam was first established in 2009 to better differentiate central from peripheral causes of AVS.
...
**Clinical Point:** Can emergency physicians accurately rule out a central cause of vertigo using the HINTS examination?
