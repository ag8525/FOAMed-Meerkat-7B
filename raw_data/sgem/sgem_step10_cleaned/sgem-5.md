---
url: https://thesgem.com/2012/09/podcast5-does-johnny-kneed-an-x-ray/
title: "SGEM#5: Does Johnny “kneed” an X-ray? (Ottawa Knee Rule)"
date: 2012-09-30
download_date: 2025-08-11
summary: |
  The document discusses the application of the Ottawa Knee Rule (OKR) in assessing knee injuries in children, specifically its ability to exclude knee fractures. The OKR, originally validated in adults, requires x-rays only if specific criteria are met, and has shown 100% sensitivity in detecting fractures. A systematic review and meta-analysis involving 1130 children with a fracture prevalence of 8.4% suggests that the OKR can be safely applied to children over 5 years old, reducing unnecessary radiographs. However, there is insufficient evidence to support its use in children under 5 years. The study highlights the potential of the OKR to decrease x-ray usage by 28% in appropriate pediatric populations.
---

**Case Scenario:** Ten-year-old Johnny was playing hockey last night. He twisted his knee but could not finish the game. His mom brings him in after asking for an x-ray.

**The Ottawa Knee Rule (OKR):** These were also developed by Dr. Ian Stiell. The rule states that x-rays are only required if the patient has one or more of the following:
...
Dr. Stiell’s article on the OKR was published in the Ann Emerg Med 1995. There were 127 patients in this prospective study. It showed that the application of the OKR was 100% sensitive and 54% specific. So, it picked up all of the true positives or fractures. Applying the OKR would have decreased x-rays by 28%.

**Point:** Can the Ottawa knee rules safely exclude knee fractures in children?
