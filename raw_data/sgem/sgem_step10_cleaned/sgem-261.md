...
summary: |
  The document discusses the validation of the CriSTAL tool, designed to predict short-term mortality in elderly patients admitted to the emergency department, with a focus on facilitating end-of-life care discussions. The study involved patients over 65 from Australia and Ireland, excluding those with severe cognitive impairment or critical illness without a surrogate. The tool demonstrated good discriminant power, with suggested cut-offs of seven for Australia and six for Ireland, based on AUC statistics. However, concerns about inter-rater reliability, overfitting, and external validity were noted, and the tool's clinical utility compared to clinician judgment remains uncertain. The study emphasizes the importance of accurate prognosis in guiding end-of-life discussions, though further validation and comparison to clinician gestalt are needed.
---
...
**Background:** Discussion about goals of care at the end of life is an essential component of emergency medicine. Such discussions are aided by accurate prognosis, so that life-saving interventions can be provided to those in need, but hopefully without providing overly aggressive management in patients with little hope of recovering. Such prognosis is difficult, especially in the chaotic and time-limited environment of an emergency department. An accurate decision tool would be welcomed. Unfortunately, available tools are only modestly accurate and have not been rigorously validated. Basic demographic data alone are insufficient to predict individual patient risk. Therefore, the purpose of this study was to validate a personalized risk score – the Criteria for Screening and Triaging to Appropriate aLternative care (CriSTAL) – in older patients presenting to the emergency department.

**Clinical Point:** To establish the predictive ability of individual and combined parameters in the CriSTAL tool to predict short-term post-discharge death in an elderly population.

**Reference:** Cardona et al. Prospective Validation of a Checklist to Predict Short-term Death in Older Patients After Emergency Department Admission in Australia and Ireland. AEM June 2019.
...
Individual components of the score with significant odds ratios for death from the derivation and validation cohort with both frailty scales included: advanced malignancy, nursing home residence, abnormal oxygen saturation (<90%), and frailty.

**Commentary:** 
1. **Exclusions:** Three key groups of elderly patients were eliminated from this study. Those with severe cognitive impairment and no available surrogate, critically ill patients, as well as those patients discharged the same day from the emergency department. This represented more than 60% of patients from the Australian cohort. This may have impacted the study results.
...
9. **Clinician Gestalt:** In order to be helpful clinically, we like to see decision tools that improve on the accuracy of clinician gestalt. It would have been great to have data on this tool as compared to physician judgment or gestalt.
...
**Clinical Application:** We are unable to apply the CriSTAL tool at this time. We would like to see further trials looking at its validation, implementation, and comparing it to clinician gestalt.

**What Do I Tell My Patient:** You probably have an infection in your urine. Given your age and all of your other medical conditions, it could be serious. By serious, I mean you could die from the infection. Have you ever thought about or talked about end-of-life care? We want to make sure we respect your wishes. If your heart or lungs stopped, would you like us to do CPR, put a tube down your throat to help you breathe, shock your heart if necessary, and admit you to an intensive care unit? Or would you like us to allow a natural death?