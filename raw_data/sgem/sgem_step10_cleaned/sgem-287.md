...
summary: |
  In the evaluation of community-acquired pneumonia (CAP), biomarkers such as C-reactive protein (CRP), procalcitonin (PCT), and white blood cell count (WBC) can aid in diagnosis, with CRP being the most accurate among them. CRP levels below 10 mg/L are useful for ruling out pneumonia, while levels above 50 mg/L are indicative of pneumonia. However, reliance solely on biomarkers in the emergency department is cautioned against, as they should not replace clinical judgment and imaging, such as chest x-rays, which remain the standard for diagnosing CAP. The study emphasizes the integration of CRP into clinical workflows due to its availability and cost-effectiveness, but highlights the necessity of clinical correlation and imaging for accurate diagnosis and management.
---
...
**Background:** Community-acquired pneumonia (CAP) is a significant source of morbidity and mortality in adults. There is evidence that an accurate diagnosis of CAP may lead to earlier treatment while avoiding unnecessary antibiotics for patients who do not have CAP. Previous research has demonstrated that individual signs and symptoms have limited accuracy in the diagnosis of CAP. The diagnosis of CAP is usually based on an abnormal chest x-ray in a patient with signs and symptoms of a lower respiratory tract infection. White blood cell count (WBC), C-reactive protein (CRP), and procalcitonin are biomarkers associated with an increased likelihood of CAP. There are also clinical prediction rules that include CRP for the diagnosis of CAP. Procalcitonin is another potential biomarker that may help in the diagnosis of bacterial pneumonia. Guidelines such as the National Institute for Health and Care Excellence (NICE) recommend the use of CRP at the point of care to reduce inappropriate antibiotic use when diagnosing CAP. These various biomarkers are readily available in the ED setting in the US, as well as in the primary care setting in other countries in Europe.

**Clinical Point:** What is the accuracy of biomarkers for the diagnosis of community-acquired pneumonia?
...
**Comment on Authors’ Conclusion Compared to SGEM Conclusion:** We agree that biomarkers "can" be useful for the diagnosis of CAP in the outpatient setting but are skeptical of their impact on the diagnosis of ED patients.
...
**Case Resolution:** You order CXR which is reported by the radiologist as a "right lower lobe infiltrated consistent with early pneumonia, clinical correlation required". You prescribe the antibiotic doxycycline and provide appropriate follow-up and discharge instructions.
