---
url: https://thesgem.com/2015/11/sgem135-the-Point-my-friend-is-blowin-in-your-nose-high-flow-nasal-oxygen/
title: "SGEM#135: The Point My Friend is Blowin’ in your Nose – High Flow Nasal Oxygen"
date: 2015-11-08
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM135.mp3
download_date: 2025-08-11
summary: |
  In a study examining the efficacy of high-flow nasal oxygen (HFNO) versus non-invasive ventilation (NIV) and standard oxygen therapy in adult ICU patients with acute hypoxic respiratory failure, no significant difference was found in intubation rates at 28 days among the three groups. However, HFNO showed a significant reduction in 90-day mortality compared to standard oxygen and NIV, though the study was not powered for mortality outcomes. The trial faced limitations such as potential selection bias, lack of blinding, and group contamination, which may affect the validity of the findings. Despite these issues, HFNO remains a viable option for patients unable to tolerate NIV, although it does not demonstrate superiority over standard care or NIV in this context.
---
...
- **Outcome:** 
  ...
  - **Secondary:** Mortality in the ICU, mortality at 90 days, duration of ICU stay and number of ventilator free days.
...
**Talk Nerdy:** This was a multicenter trial attempting to ask an important Point in critical care medicine. However, there were a number of concerns/limitations in this study that threaten the validity of the conclusions.
...
2. **Not Blinded –** This could have introduced some bias into the results by influencing the treating staff not to intubate the intervention group compared to the control. However, they did have pre-specified criteria for endotracheal intubation, some of which was objective while other criteria were subjective (copious tracheal secretions).
...
**Clinical Application**: I am comfortable using NIV and will probably continue doing this given the good evidence to support this practice. However, for those patients not able to tolerate NIV, high flow nasal oxygen would be a reasonable option to try.
