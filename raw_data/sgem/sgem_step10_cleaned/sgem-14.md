...
summary: |
  Bell's palsy, characterized by idiopathic unilateral facial nerve paralysis, is commonly managed with corticosteroids, which have been shown to significantly improve recovery outcomes. A Cochrane review demonstrated that steroids reduce the risk of incomplete recovery of facial motor function at six months, with a risk ratio of 0.71, indicating a clear benefit. Conversely, antiviral treatments have not shown significant efficacy in improving recovery from Bell's palsy, as evidenced by another Cochrane review. Therefore, the recommended management for Bell's palsy includes corticosteroids, while antivirals are not advised unless the condition is suspected to be Ramsay Hunt Syndrome. In the presented case, the patient was appropriately treated with a 10-day course of oral steroids, with expectations of complete recovery.
---

**Case Scenario:** 35yo healthy awakes with unilateral facial droop. Triage nurse brings promptly this case to your attention for query CVA. 

**Point:** Steroids Y/N, Antivirals Y/N or both?

**Background:** “Bell’s palsy is a form of facial paralysis resulting from a dysfunction of the cranial nerve VII (the facial nerve) that results in the inability to control facial muscles on the affected side. Named after Scottish anatomist Charles Bell, who first described it, Bell’s palsy is the most common acute mononeuropathy and is the most common cause of acute facial nerve paralysis. Bell’s palsy is defined as an idiopathic unilateral facial nerve paralysis, usually self-limiting. The hallmark of this condition is a rapid onset of partial or complete paralysis that often occurs overnight. In rare cases (<1%), it can occur bilaterally resulting in total facial paralysis. It is thought that an inflammatory condition leads to swelling of the facial nerve. The nerve travels through the skull in a narrow bone canal beneath the ear. Nerve swelling and compression in the narrow bone canal are thought to lead to nerve inhibition, damage or death. No readily identifiable cause for Bell’s palsy has been found.”

**Reference:** Corticosteroids for Bell’s palsy (idiopathic facial paralysis). Salinas et al. Cochrane 2010

- **Population:** 1569 adults in eight trials.
...
**Commentary:** “Relative risk or risk ratio (they mean the same thing and are both abbreviated as RR) is simply the risk of the event in one group divided by the risk of the event in the other group. The most common way to go about calculating the risk ratio (and nearly all other statistics from dichotomous data) is to start by presenting your results in a 2×2 table, where each cell in the table contains the number of participants in each category. Now, if you think through what you are comparing (risk in the treated group with risk in the control group), the risk ratio is easy to calculate. If an experimental intervention has an identical effect to the control, the risk ratio will be 1. If it reduces the chance of having the event, the risk ratio will be less than 1; if it increases the chance of having the event, the risk ratio will be bigger than 1. The smallest value the risk ratio can take is zero when there are no events in the treated group.”
...
- **Population:** 1987 adults in seven trials.
...
**BEEM Bottom Line:** Antivirals for the treatment of Bell’s Palsy – **NO** – But if the diagnosis is Ramsay Hunt Syndrome the treatment does include antivirals –
