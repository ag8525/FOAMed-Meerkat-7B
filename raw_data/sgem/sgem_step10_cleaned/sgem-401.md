...
title: "SGEM #401: Hey Ho! High Flow vs Standard Oxygen Therapy for Hospitalized Children with Respiratory Failure"
date: 2023-04-22
...
**Background:** Respiratory illnesses remain one of the most frequent causes of admission for children less than 5 years. Some of these illnesses result in acute hypoxemic respiratory failure. Historically, there were not many treatments for these children, and they were admitted for observation or intubated and started on mechanical ventilation. High flow nasal cannula (HFNC) started gaining popularity in the early 2000s as an option of noninvasive ventilation. Previous research has shown that HFNC can lower the rate of escalation of care but showed no impact on admission to the intensive care unit (ICU) or length of stay.

**Clinical Point:** Does the early use of HFNC reduce the length of hospital stay in pediatric patients with acute hypoxemic respiratory failure compared with standard oxygen therapy?
...
Children with bronchiolitis can have transient desaturations into the 70s or 80s without significant clinical consequence. Additionally, research suggests that there may be racial bias in the use of pulse oximeters as the readings in darker-skinned individuals may be inaccurate. In summary, using oxygen saturations alone to make clinical decisions is imperfect.
