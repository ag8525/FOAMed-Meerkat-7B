...
summary: |
  In the management of out-of-hospital cardiac arrest (OHCA) with shock-refractory ventricular fibrillation or pulseless ventricular tachycardia, the administration route of antiarrhythmic medications such as amiodarone and lidocaine (intravenous [IV] vs. intraosseous [IO]) does not significantly impact survival to hospital discharge or favorable neurologic outcomes. The ALPS trial and subsequent analyses suggest that while IV administration of amiodarone showed a statistically significant benefit over placebo, no such benefit was observed with IO administration. Despite these findings, the evidence remains insufficient to prioritize IV over IO access, especially given the practical challenges in pre-hospital settings. The focus should remain on interventions with proven benefits, such as high-quality CPR and defibrillation, rather than the specific route of drug administration. EMS providers are encouraged to use IO access when IV access is not readily achievable, as the overall impact on patient outcomes is minimal.
---
...
In recent years there has been an effort to lower the cognitive load in the pre-hospital setting and focus resources on the interventions that positively affect patient outcomes. There has been a trend to place supraglottic devices over intubation with some evidence to support this move. Another trend is to use IO access over IV access to free up pre-hospital providers to focus on more meaningful interventions.

**Clinical Point:** Does it matter if you give antiarrhythmic medications via IV or IO route in OHCA?
...
There was no statistical difference between Amiodarone (24.4%), lidocaine (23.7%) and Placebo (21.0%) in the ALPS study. There was also no statistical difference in favorable neurologic function at discharge between groups.
This was a pre-specified subgroup analysis of the 3,019 PP population. IV route was used 78% of the time and the IO route was used 22% of the time. The mean age of participants was 63 years, 80% were male, less than a 1/3 occurred in a public location, 60% had bystander-initiated CPR and a time to first arrival of EMS of 6 minutes.
