...
summary: |
  A recent trial, the WATERFALL study, evaluated fluid resuscitation strategies in acute pancreatitis, comparing aggressive versus moderate approaches. The study found that aggressive fluid resuscitation, defined as a 20 cc/kg bolus of lactated Ringer's followed by 3.0 cc/kg/hour, resulted in a higher incidence of fluid overload without improving clinical outcomes compared to a moderate strategy (10 cc/kg bolus followed by 1.5 cc/kg/hour). The trial, which was stopped early due to safety concerns, demonstrated a significant increase in fluid overload in the aggressive group (20.5% vs. 6.3% in the moderate group). The findings suggest that moderate fluid resuscitation should be preferred to avoid potential harm, as aggressive hydration did not reduce the progression to severe pancreatitis and was associated with increased fluid overload. This evidence supports a shift in clinical practice towards more conservative fluid management in acute pancreatitis.
---
...
**Background:** It’s interesting to see how fluid resuscitation has been debated over the years. This includes fluid type and rate for things like renal colic, pediatric diabetic ketoacidosis, hyponatremia, trauma, and critically ill adults. Standard management of acute pancreatitis has focused mainly on hydration, analgesia, and investigation for an underlying cause. Recent evidence has challenged the routine use of aggressive large volume fluid resuscitation with the potential to increase the severity of pancreatitis as well as fluid overload. High-quality evidence demonstrating harms of aggressive fluid resuscitation in acute pancreatitis have been lacking.

**Clinical Point:** Does the use of a moderate fluid resuscitation strategy in acute pancreatitis decrease the rate of progression to moderate/severe pancreatitis in comparison to aggressive fluid resuscitation?
...
**Commentary:**
1. **Trial Stopped Early:** This trial was stopped early due to an interim analysis demonstrating a significantly higher rate of fluid overload in the aggressive hydration group. Guyatt et al published an article in the BMJ 2012 describing the dangers of stopping trials early for benefit and Veile et al covered the issue in JAMA 2016. This trial was stopped early for harm after about 1/3 of the power calculation to include 744 participants. The investigators a priori specified what conditions would trigger the trial to be stopped in a publication by Bolando et al Front Med 2020.
...
4. **Volume of Fluids:** The authors did achieve separation between groups when looking at median fluids received in the first 48 hours. It was 7.8L in the aggressive group (range 6.5 to 9.8L) and 5.5L in the moderate group (range 4.09 to 6.8L).
...
**What Do I Tell My Patient?** You have acute pancreatitis. This is inflammation of your pancreas. We would like to admit you to the hospital and treat your condition with pain medication and IV fluids. The newest evidence suggests we should give you a moderate amount of IV fluids. If we are too aggressive with IV fluids it may cause you harm.