...
summary: |
  In this clinical scenario, a 53-year-old woman with a history of hypertension presents with chest pain, and initial evaluations including ECG and high sensitivity troponin T (hs-cTnT) are normal. The document discusses the utility of hs-cTnT in ruling out acute myocardial infarction (AMI) in patients without ECG ischemia, highlighting a study where a single hs-cTnT below the detection limit, combined with a non-ischemic ECG, showed a sensitivity of 99.1% and a negative predictive value of 99.6% for AMI. The study suggests that this approach could safely exclude AMI in a significant portion of patients, potentially reducing unnecessary admissions. However, the document emphasizes the importance of clinical judgment and patient preferences in decision-making, acknowledging a small residual risk of missed AMI and major adverse cardiac events (MACE) within 30 days. The case resolution involves offering the patient the option of further testing or discharge, with informed consent about the low but non-zero risk of adverse outcomes.
---
...
**Background:** Patients presenting to the emergency department with chest pain are a daily conundrum. There are a number of life-threatening conditions that must be efficiently ruled out. Unfortunately, for the most common acute coronary syndrome, there is no universally agreed-on algorithm. In addition to serial ECGs, a variety of different biomarkers are used and repeated at a variety of different intervals. These biomarkers may or may not be followed by admission or further outpatient provocative testing depending on where you practice. With the advent of high sensitivity troponin tests, it has been argued that there are probably some patients in whom we can exclude the diagnosis of myocardial infarction with just a single blood test. A recent systematic review determined that a single hs-cTnT below the level of detection resulted in a sensitivity of 97.4% and a specificity of 42.4% (Zhelev 2015). When a non-ischemic ECG is added to the single negative hs-cTnT, one retrospective study of more than 14,000 patients found a sensitivity for myocardial infarction of 98.3%, and a negative predictive value of 99.8% (Bandstein 2014). However, many of the existing studies are small, single-center, and/or retrospective.

**Clinical Point:** Can high sensitivity troponin T (hs-cTnT) levels below the limit of detection on arrival in the emergency department be used to safely exclude acute myocardial infarction in patients with no ECG ischemia?
