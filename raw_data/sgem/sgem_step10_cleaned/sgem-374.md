...
summary: |
  In the context of rising opioid overdose deaths, this document discusses the initiation of medications for opioid use disorder (MOUD) in the emergency department (ED) as a critical intervention point. It highlights the low uptake of buprenorphine post-ED discharge and explores patient perspectives on MOUD initiation, emphasizing the importance of shared decision-making (SDM) to enhance patient-provider interactions. The study reveals that while patients support offering buprenorphine in the ED, they also advocate for methadone options, stressing individualized treatment plans. Key factors influencing decision-making include logistical ease, withdrawal management, and the need for non-judgmental clinician interactions. The document underscores the necessity of integrating psychiatric care and peer support in OUD management, recognizing the varied definitions of recovery and the role of relapse in treatment journeys. The clinical application involves offering buprenorphine with clear instructions and coordinating follow-up care, aiming to tailor interventions to patient readiness and needs.
---
...
**Background:** Drug overdose deaths continue to rise in the United States with opioids being the number one cause. There are several medications available to treat Opioid Use Disorder, including methadone and buprenorphine, which are the most effective means to decrease future illicit opioid use and death. The ED has been identified as a low barrier environment where medications for OUD (MOUD) can be initiated, even in resource-constrained settings.

Despite the relatively easy availability of buprenorphine, less than 5% of patients discharged from the ED after a non-fatal opioid overdose fill a prescription for buprenorphine in the next 90 days. Past studies have focused on clinician-reported barriers to administering or prescribing buprenorphine in the ED.

However, the perspectives and preferences of patients have not been so thoroughly explored. Shared decision making (SDM) puts patients at the center of clinical decisions and has been shown to increase knowledge, trust, and adherence in other clinical decisions.

An SDM framework that fosters conversations and addresses common misconceptions around MOUD initiation may improve the patient-provider interaction and ultimately increase ED-based MOUD administration.

**Clinical Point:** What are patient’s perspectives regarding the initiation of medications for opioid use disorder in the ED?
...
Coordination with outpatient care was also identified as important, e.g., OUD clinic and outpatient resource list, psychiatric care, naloxone kit training, peer recovery coach contacts, and comfort medications such as clonidine or acetaminophen would all be useful.
