---
url: https://thesgem.com/2021/10/sgem347-it-dont-matter-to-me-balanced-solution-or-saline/
title: "SGEM#347: It Don’t Matter to Me – Balanced Solution or Saline"
date: 2021-10-03
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM_347x.mp3
download_date: 2025-08-11
summary: |
  In critically ill patients, particularly those at risk for acute kidney injury, the choice between balanced crystalloids (such as Plasmalyte 148) and 0.9% saline for fluid resuscitation has been debated. The BaSICS trial, a large, double-blind, multi-center randomized study, found no significant difference in 90-day mortality between patients receiving balanced solutions versus saline. Despite some secondary outcomes indicating potential harm with balanced solutions, these findings were considered hypothesis-generating rather than definitive. The study suggests that in ICU settings, the type of crystalloid solution and infusion rate may not significantly impact mortality outcomes, especially when administered in modest volumes. This aligns with the clinical application that, in emergency settings, the choice of crystalloid may not critically affect short-term survival, allowing for flexibility based on availability and clinical judgment.
---
...
The SALT-ED trial was also a single-center unblinded trial, but the primary outcome was hospital-free days. They reported no statistical difference between the two groups. Their secondary composite outcome of death, new renal-replacement therapy, or final serum creatinine >200% of baseline, was statistically better with balanced crystalloid vs saline. However, there was not a statistical difference in any of the individual components of the composite outcome.
The BaSICS trial attempts to Point whether balanced solutions are superior to saline using a large, double-blind, factorial, multi-center randomized trial.

**Clinical Point:** Does administration of a balanced solution (Plasma-Lyte 148) during intensive care unit (ICU) stay, compared with saline solution, result in improved 90-day survival in critically ill patients?
...
- **Population:** Adult patients admitted to the ICU for more than 24 hours, needing at least one fluid expansion and with at least one risk factor for acute kidney injury (age over 65, hypotension, sepsis, required mechanical ventilation or non-invasive ventilation, oliguria or increased serum creatinine level, cirrhosis or acute liver failure)
...
Funding and fCOIs are just additional data points that need to be considered. They occur on a spectrum from no industry involvement to being designed, conducted, analyzed, and written by employees of a company. None of that makes the information incorrect but our skepticism should be proportional to the degree of industry involvement.

**Comment on Authors’ Conclusion Compared to SGEM Conclusion:** We would have modified the conclusion to: “Among adult patients admitted to the ICU for more than 24 hours, needing at least one fluid expansion and with at least one risk factor for acute kidney injury use of a balanced solution compared with 0.9% saline solution did not significantly reduce 90-day mortality. The findings do not support the use of this balanced solution in this cohort of patients.”
