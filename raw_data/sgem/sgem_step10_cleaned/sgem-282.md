---
url: https://thesgem.com/2020/02/sgem282-its-all-bout-that-bayes-bout-that-bayes-no-trouble-in-diagnosing-pulmonary-embolism/
title: "SGEM#282: It’s All ‘bout that Bayes, ‘Bout that Bayes- No Trouble – In Diagnosing Pulmonary Embolism"
date: 2020-02-01
download_date: 2025-08-11
summary: |
  In the case of a 33-year-old female presenting with pleuritic chest pain, the clinical focus is on ruling out pulmonary embolism (PE) using a pretest probability-based approach. Despite an elevated d-dimer of 850 ng/ml, the patient is considered low risk according to the Well’s criteria, allowing for the application of the PEGeD strategy, which adjusts the d-dimer threshold to <1,000 ng/ml for low-risk patients. This approach, supported by the Kearon et al. study, suggests that imaging can be safely avoided in such cases, reducing unnecessary exposure to radiation and potential overdiagnosis. The study highlights the importance of Bayesian thinking in clinical decision-making, emphasizing that a combination of low clinical pre-test probability and an adjusted d-dimer can effectively rule out PE without imaging, thus aligning with the ADJUST PE and YEARS criteria. This strategy is particularly relevant in environments like Canada, where it can lead to a significant reduction in diagnostic imaging, though its applicability in different healthcare systems may vary due to differing medico-legal pressures.
---

**Case:** You are caring for a 33-year-old female who comes to your emergency department with chest pain. She was attending the incredible EM Vision 2020 conference and while listening to Dr. Alan Drummond talk about over-crowding, she developed sudden onset of pleuritic chest pain.
...
**Background:** There is a reason why pulmonary embolism is covered so often on The SGEM and other podcasts; it’s a diagnosis we are appropriately trained to always think of but it presents itself with symptoms that are common in a variety of other conditions.
Of course, how can we forget the DDD threat – the Dreaded D-Dimer. It is a highly sensitive test but with low specificity. For the longest time, we treated it like a binary test. If the DDD is positive (>500ng/ml), then further imaging (CTA or VQ). If the DDD is negative (<500ng/ml) we do our happy dance and no further testing.
...
We the ADJUST PE Study with Dr. Kirsten de Witt out of McMaster University. She is one of the authors on this study we are reviewing today.
...
**Clinical Point:** Can a clinical pretest probability-based D-dimer safely rule out the diagnosis of pulmonary embolism without imaging?
...
- **Intervention:** This was a diagnostic accuracy study of the risk of PE using the Well’s criteria to assess clinical pre-test probability
...
**What Do I Tell My Patient?** We were concerned you might have had a blood clot in your lung. This can be a very serious and even deadly problem. We ran some blood tests and they were normal. It’s very unlikely you have a blood clot. Now we need to look for other causes of your chest pain.