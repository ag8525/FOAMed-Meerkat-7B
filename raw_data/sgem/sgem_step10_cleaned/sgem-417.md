---
url: https://thesgem.com/2023/10/sgem-417-everybodys-changing-the-reference-ranges-for-pediatric-vital-signs/
title: "SGEM #417: Everybody’s Changing…the Reference Ranges for Pediatric Vital Signs"
date: 2023-10-14
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM417.mp3
download_date: 2025-08-11
summary: |
  A study examining pediatric heart and respiratory rates in emergency settings found that current APLS guidelines may underestimate normal heart rate ranges, potentially leading to overclassification of sepsis risk in children. The study analyzed data from 191,292 heart rate and 191,147 respiratory rate records, revealing that heart rates were generally higher than APLS standards, while respiratory rates aligned more closely. The findings suggest that vital sign ranges should be interpreted in the context of individual clinical presentations rather than strictly adhering to guidelines, as factors like anxiety, fever, and dehydration can influence these measurements. The study emphasizes treating the patient rather than relying solely on numerical thresholds, highlighting the need for context-specific assessment in pediatric emergency care.
---
...
**Background:** Vital signs can be an important objective measurement while assessing a patient. They are often incorporated into many early warning systems, risk-stratification systems, and treatment protocols. Abnormal vital signs may be indicators of potential decompensation. Specifically, heart rate and respiratory rates are used in early attempts to detect sepsis.
Children’s vital signs can differ based on age. However, there remains variation regarding what the “normal” ranges of vital signs can be for pediatric patients. Vital sign ranges from common guidelines such as Pediatric Advanced Life Support (PALS) or Advanced Pediatric Life Support (APLS) can differ.

**Clinical Point:** How does a derived distribution of heart and respiratory rates for children compare to APLS and other national guidance?
...
- **Population:** Children 0-16 years recruited consecutively from October 2017 to September 2020 from three emergency departments and one urgent care centre in England- serving populations with significant inequalities in health and life expectancy.
...
- **Outcome:** The authors had three aims with their study:
  ...
  - Proportion of patients from this study that would meet “severe” cut-off threshold compared to guidelines from the UK Sepsis Trust and National Institute for Health and Care Excellence (NICE)
  - Comparison of distribution of heart and respiratory rates from study to previously published, large data sets.
...
Additionally, it is not stated how the vital signs were recorded- was this done manually (counting HR and RR over 1 minute for example, or by monitor). Previous studies have shown that there is variability between clinical staff recording these numbers and would subsequently introduce another bias.

**Derivation Population:**
Previous studies looking at “normal” ranges for pediatric vital signs have been performed in different settings including patients in the ED and hospitalized patients. But is there really an ideal setting for obtaining this data? Is the ED the right place to draw this data from?
We mentioned previously that children who are in the ED may have many reasons for why their HR are elevated compared to their own baseline. They can be anxious or scared. They could be experiencing pain or presenting with dehydration. They could also have fever (a group which the authors chose not to exclude). All these factors may contribute to an increased heart rate.
...
There was a previous study that looked at return visits, admission, and adverse outcomes for children discharged with abnormal vital signs and found that few returned and required admission.
