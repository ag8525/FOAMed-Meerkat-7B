...
title: "SGEM#95: Paediatric Fever 2"
date: 2014-11-16
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM95-Fever.mp3
download_date: 2025-08-11
summary: |
  The document discusses the management of fever in children, emphasizing that fever itself is not harmful to generally healthy children and may be beneficial. The American Academy of Pediatrics advises that the primary goal of antipyretic therapy should be to enhance the child's comfort rather than to normalize body temperature. A systematic review and meta-analysis by Purssell and While examined whether antipyretics prolong febrile illness in children, concluding that there is no evidence to suggest that antipyretics delay fever resolution. However, the study had limitations, including a lack of generalizability due to the inclusion of studies on malaria and varicella, and methodological issues such as lack of blinding in some studies. The recommendation remains to use antipyretics for comfort rather than focusing on reducing fever, and parents should be informed that the use of these medications is to improve the child's comfort during illness.
---
...
**Point:** Will treating the fever make her sicker, longer?
...
- **Population:** RCT or quasi-randomized trials including children with febrile illness
...
- The clinical Point is sensible and answerable. Yes
- The search for studies was detailed and exhaustive. Unsure
...
- There was low statistical heterogeneity for the primary outcome. Yes
- The treatment effect was large enough and precise enough to be clinically significant. No

**Key Results:** Pooled mean difference in fever clearance was -4.16 hours in favor of antipyretics (95%CI -6.35 to -1.96hrs; P=0.002)

This is certainly an interesting Point to ask. Will treating a febrile child with antipyretics prolong their illness? This data suggests that treating the fever will NOT prolong their illness.
...
- The primary outcome examined by this study was time to resolution of fever, a surrogate for more important outcomes. In one study (Brandts 1997) there was a significant increase in malaria clearance time in the antipyretic group. In another study (Kramer 1991) less than 50% of parents were able to correctly identify that their child had received antipyretic/placebo.
