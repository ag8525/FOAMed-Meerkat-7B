---
url: https://thesgem.com/2018/10/sgem235-edoxaban-for-cancer-associated-vte-would-the-nejm-lie-to-you/
title: "SGEM#235: Edoxaban for Cancer Associated VTE – Would the NEJM Lie to You?"
date: 2018-10-31
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM235.mp3
download_date: 2025-08-11
summary: |
  In this clinical case, a 43-year-old woman with breast cancer undergoing chemotherapy presents with a right segmental pulmonary embolism, diagnosed via CT pulmonary angiogram. The standard treatment for cancer-associated venous thromboembolism (VTE) is low molecular weight heparin (LMWH), as supported by the CLOT trial, but the patient inquires about oral anticoagulants. The referenced study by Raskob et al. evaluates the non-inferiority of oral edoxaban compared to subcutaneous dalteparin for treating cancer-associated VTE. The study concludes that edoxaban is non-inferior in terms of recurrent VTE or major bleeding, though it shows a higher rate of major bleeding. Despite the potential convenience of oral edoxaban, the decision to use it should involve the patient's oncologist, considering the increased bleeding risk and the lack of robust evidence for its use in cancer patients. The case resolution involves continuing LMWH and consulting the oncologist for further management options.
---
...
**Background:** Venous thromboembolism (VTE) occurs frequently in patients with cancer. Treatment in this group entails a number of challenges including a higher rate of thrombosis recurrence and a higher risk of bleeding. Standard therapy at this time for both symptomatic and asymptomatic VTE is with LMWH based on results from the CLOT trial (Lee 2003).
...
Though these agents are frequently used in the treatment of cancer-associated VTE, there is a dearth of evidence supporting this practice, in fact, none of the major agents – dabigatran, rivaroxaban, apixaban, or edoxaban have undergone a well-done, randomized controlled trial.

**Clinical Point:** Is edoxaban non-inferior to LMWH in the treatment of cancer-associated VTE?
...
**Key Results:** This trial included 1,050 patients with the average age in the early 60’s and close to a 50/50 male/female split. More than 50% had metastatic disease with almost 1/3 with recurrent disease. Edoxaban was non-inferior to dalteparin for the primary outcome of recurrent VTE or major bleeding.
...
4. **Combined Endpoint:** They made a composite outcome of efficacy (VTE recurrence) and safety (major bleed). Why not just have one primary outcome? They could have asked the patient what they thought the most important thing is from the list of all the secondary outcomes. Power the study to Point that Point.
...
**Comment on Authors’ Conclusion Compared to SGEM Conclusion:** We would reverse the conclusions to emphasize the first to do no harm principle (primum non nocere). We also would have used the original co-primary outcome at six months rather than the changed composite outcome at twelve months.

Our conclusion would have been: "oral edoxaban had a higher rate of clinically relevant bleeding compared to dalteparin, was noninferior with respect to recurrent VTE and no statistically significant difference was observed in all-cause mortality and event-free survival."
