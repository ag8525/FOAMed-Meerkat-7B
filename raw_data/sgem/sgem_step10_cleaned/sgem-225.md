---
url: https://thesgem.com/2018/07/sgem225-nexus-ii-validation-of-the-pediatric-head-ct-decision-instrument/
title: "SGEM#225: NEXUS II – Validation of the Pediatric Head CT Decision Instrument"
date: 2018-07-17
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM225.mp3
download_date: 2025-08-11
summary: |
  The document discusses the use of the Pediatric NEXUS II Head CT Decision Instrument in evaluating pediatric patients with blunt head trauma to potentially reduce unnecessary CT imaging. The tool classifies patients as low-risk if they meet specific criteria, such as no skull fracture or neurological deficits, and has shown high sensitivity (100%) and negative predictive value (100%) for identifying those needing neurosurgical intervention. Despite its potential to decrease CT use by 25%, the study highlights concerns about spectrum and verification bias, and the need for a more robustly powered study to confirm these findings. In the presented case, the decision instrument indicated that a CT scan was not necessary, and the patient was managed with observation and parental guidance on symptoms to monitor.
---
...
**Background:** Blunt head trauma is a common presenting complaint in emergency departments, accounting for approximately two million visits per year in the US. CT imaging is often performed but comes with radiation risks and increased medical costs. Several decision instruments have been developed to assess the risk of significant intracranial injury in children with head trauma (CATCH, CHALICE and PECARN). The PECARN tool has been found to have a high sensitivity, but in one study was shown to increase CT use compared to physician judgement. The NEXUS Head CT decision instrument was developed as a "one way" instrument, which would hopefully serve to rule out those children who might otherwise receive imaging (as opposed to classifying many as "high risk"). In the original cohort, use of NEXUS Head CT decision instrument decreased the need for CT by 25%.

**Clinical Point:** In pediatric patients with blunt head trauma, can the NEXUS Head CT decision instrument be used to rule out the need for imaging in patients who otherwise would have received CT imaging?
...
**Commentary:**
1. **Secondary Analysis:** This was a pre-planned secondary analysis of the NEXUS Head CT decision instrument.
2. **Power:** The original NEXUS Head CT observational study was powered to have 368 patients with injuries requiring neurosurgical intervention. It was not powered for the subgroup of pediatric patients reported in this study. There were only 27 pediatric patients who required intervention in the cohort.
3. **Spectrum Bias/Verification Bias:** The original study did not enroll patients that did not have a CT scan performed. This can introduce spectrum bias and verification bias.
4. **Exclusions:** The author state that clinically significant intracranial injury excluded some intracranial hemorrhage, some skull fractures, and isolated pneumocephaly. In my experience, it’s standard practice that if these injuries are found on CT, the vast majority of these patients are admitted.
5. **Intra-Rater Reliability:** Clinical decision tools rely heavily on the ability of the individual components to be evaluated consistently by different clinicians.
7. **Confidence Interval:** The 95% confidence interval around a point estimate gives the precision of results. the 95% confidence interval around the primary outcome of need for neurosurgical intervention was wide (87% – 100%). This lack of precision and lower boundary of 87% is a concern given the serious patient-oriented outcome.
9. **One-Way Tool:** NEXUS is a "one-way" clinical decision instrument.

**Comment on Authors’ Conclusion Compared to SGEM Conclusion:** We agree with the authors’ conclusions.

**SGEM Bottom Line:** The Pediatric NEXUS II Head CT Decision Instrument can reliably categorize patients as low risk and may reduce CT imaging in these patients.
...
**Clinical Application:** A properly powered study with tighter confidence intervals around the point estimate for the patient-oriented outcome of need for neurosurgical intervention is desirable before the Pediatric NEXUS II Head CT Decision Instrument is widely adopted.
