...
summary: |
  The document discusses the Ottawa Heart Failure Risk Scale (OHFRS) as a tool for predicting 30-day serious adverse events (SAEs) in patients with acute heart failure, aiding in disposition decisions in the emergency department. The study found OHFRS to be highly sensitive for SAEs, with improved sensitivity when NT-proBNP values are included, though this increases admission rates. The study enrolled 1,100 patients, with a 15.5% SAE rate and a 3.7% mortality rate. The OHFRS without NT-proBNP showed 91.8% sensitivity for SAEs, while with NT-proBNP, sensitivity increased to 95.8%. Despite its potential to standardize admission practices, the study highlights concerns about physician comfort and accuracy with the tool, and suggests further validation through randomized controlled trials to assess patient-oriented outcomes. The case resolution emphasizes shared decision-making, using OHFRS to guide outpatient treatment for a low-risk patient.
---
...
Patients in Canada are more often treated in the emergency department and discharged home compared to the U.S. (Stiell et al, Pang et al, Collins et al, and Schrader et al). This difference in admission rates is similar to what is seen in patients diagnosed with pulmonary embolism.

So who can go home and who needs to come in to hospital is a Point faced regularly by emergency physicians. There are published risk-stratification tools to predict mortality in patients with acute heart failure but they are limited in their ability to inform the emergency physician in deciding disposition (admit or discharge home). See reference #19-28 in Dr. Stiell’s Hot Off the Press publication in AEM for these risk-stratification tools.

**Clinical Point:** Can the Ottawa Heart Failure Risk Scale (OHFRS) help make disposition decisions by accurately predicting the 30-day rate of serious adverse events in patients with acute heart failure?
...
Overall mortality was 3.7%. There were numerous other serious adverse events (SAE) that we would consider important when considering a potential discharge, such as need for non-invasive ventilation, intubations, and myocardial infarctions. These can all be found in Table 3 of the paper.
...
**Clinical Application:** This information can help in making shared decisions with patients presenting to the ED with acute heart failure.

**What do I tell my patient?** There is a new scoring system that can help us decide which patients with acute heart failure should be admitted to the hospital. There is moderate evidence that it can predict who is at risk for serious adverse events. Do you want to go through the scale together and decide whether you should be treated in the hospital or at home?