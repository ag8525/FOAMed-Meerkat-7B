...
summary: |
  The document discusses the management of supraventricular tachycardia (SVT) in children, focusing on the efficacy and safety of the upside-down position as a modified Valsalva maneuver. SVT is a common arrhythmia in children, and vagal maneuvers are the first-line non-invasive treatment. The study compared the upside-down position to the standard Valsalva maneuver, finding no statistically significant difference in cardioversion rates, although the upside-down position showed a trend towards greater effectiveness. The study was small, with 24 participants, and lacked sufficient power to assess safety, as no adverse events were reported. The authors' conclusion that the upside-down maneuver is safe and effective is disputed due to the study's limitations, including selection bias and inadequate monitoring for adverse events. The SGEM bottom line suggests that further research is needed before recommending the upside-down maneuver as a standard treatment for SVT in children.
---
...
**Background:** Supraventricular tachycardia (SVT) has a prevalence anywhere from 1 in 250 to 1 in 1,000 in children and is the most common arrhythmia in children. Forty percent of patients experience the first episode of SVT in the first month of life, and over 50% have their first episode in their first year of life. Vagal maneuvers are thought to be first-line treatment as they are non-invasive and can rapidly resolve the episode when successful. Several methods exist, such as carotid sinus massage, mammalian dive reflex, and the Valsalva maneuver.

**Clinical Point**: Is the upside-down position a safe and effective modified Valsalva maneuver?
...
6. **P-Values** – Dr. Ioannidis just published a paper suggesting we move the threshold for p-values to 0.005 (JAMA 2018). He is the same author who wrote a paper called "Why Most Published Research Findings Are False" (PLoS 2005). This caused a bit of a twitter storm about the misunderstanding and misuse of p-values. This study relied on p-values to interpret the data. P-values do not provide information on effect size, precision or clinical significance of a result. We need to move away from interpreting anything <0.05 as "significant" and anything >0.05 as "not significant." This is a much larger topic and I will put some links in the show notes to better understand this issue.
   ...
   - Letter to the Editor. P-values are misunderstood, but do not confound J Clin Epi 201100090-4/pdf
...
**What Do I Tell My Patient?** You inform the family that the upside-down technique is still under investigation and has not been demonstrated to be better than usual treatment. However, they can always discuss the modified Valsalva maneuver with their cardiologist at their next follow-up.