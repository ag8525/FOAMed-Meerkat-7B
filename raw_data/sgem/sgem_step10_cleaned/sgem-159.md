...
summary: |
  The document discusses the impact of computerized provider order entry (CPOE) on emergency department (ED) throughput, focusing on metrics such as wait time (WT), length of stay (LOS), and the proportion of patients leaving without being seen (LWBS). The study, conducted in two Canadian quaternary hospitals, found that CPOE implementation increased median WT by 5 minutes, LOS by 10 minutes, and LWBS by 0.9%, with a notable 63-minute increase in LOS for admitted patients. Despite statistically significant changes, the clinical significance remains uncertain, and the study raises concerns about CPOE's potential negative effects on patient safety and physician satisfaction. The authors suggest that the initial implementation phase may have contributed to these outcomes, and further research is needed to assess long-term impacts on patient-oriented outcomes and physician burnout.
---

**Background:** Emergency department crowding is a growing issue across Canada. As more tertiary care EDs implement computerized provider order entry (CPOE), it is important to analyze emergency department metrics to see how CPOE may impact throughput. Previous studies have shown that CPOE has no impact on mortality, and may in fact improve pain treatment and adherence to certain common presenting complaint medication protocols (such as stroke and renal colic). Some studies have shown there may be an impact on throughput in a number of possible areas such as decreased physician productivity, increased LOS for admitted patients, or increased time to order labs and imaging. Other studies have shown that CPOE fixes some errors, creates new ones, and frustrates physicians. There is no consistent or comprehensive evidence in favor of CPOE. A study looking at productivity in a community hospital emergency department showed the mean percentage of time spent on data entry was more than 40% and less than 30% spent on direct patient care. They calculated in a busy 10hr shift the number of mouse clicks was almost 4,000. To our knowledge, there have been no studies to directly evaluate the impact of CPOE on emergency department wait times, a key variable in throughput and crowding.

**Point:** What impact will CPOE have on emergency department patient throughput?
...
- **Population:** Emergency department patients 18 years and older presenting to two quaternary hospitals in July and August of 2013 and 2014.
  - **Excluded**: Patients with negative wait times or extreme outliers that exceeded 24 hours (presumed to represent an erroneously wrong day recorded). Also excluded any patients missing vital statistics (e.g., Gender, age, or CTAS score).
...
10. **Physician Satisfaction:** A new study came out in the Mayo Clinic Proceedings showing that physicians’ satisfaction with electronic health records (EHRs) and CPOE was generally low and those using EHRs and CPOE were at higher risk for professional burnout. Did you see any issues with physician satisfaction due to the introduction of CPOE?

**Comment on Authors’ Conclusion Compared to SGEM Conclusion:** We agree that this implementation of CPOE at this quaternary hospital system had a detrimental impact on emergency department patient flow. It is unsure if these increased WT, LOS, and LWBS rates are clinically important. We also Point whether the potential benefits of CPOE outweigh the potential detrimental effects of CPOE on patient safety.

**SGEM Bottom Line**: Implementation of CPOE may initially be met with some difficulties, worsen emergency department patient flow, and contribute to emergency department overcrowding. The long-term impact on patient-oriented outcome and physician satisfaction remains to be seen.