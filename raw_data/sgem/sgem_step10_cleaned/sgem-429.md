---
url: https://thesgem.com/2024/02/sgem-429-its-ct-angio-hi-im-the-problem-its-me-for-pediatric-oropharyngeal-trauma/
title: "SGEM #429: It’s CT Angio, Hi. I’m the Problem. It’s Me. For Pediatric Oropharyngeal Trauma"
date: 2024-02-03
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM429.mp3
download_date: 2025-08-11
summary: |
  In pediatric oropharyngeal trauma, particularly following incidents like a child falling with an object in their mouth, the risk of serious complications such as carotid artery injury is a concern, though rare. A systematic review and meta-analysis of studies on the use of CT angiography (CTA) in these cases found that routine CTA is not recommended due to its limited impact on management and outcomes, and the associated radiation risks. The review highlighted significant practice variation and a lack of high-quality evidence guiding the use of CTA, with most studies being retrospective and prone to bias. In clinical practice, a thorough physical examination is crucial, and imaging should be reserved for specific scenarios such as active bleeding or neurological changes. Shared decision-making with the family is essential, considering the child's current well-being and the potential risks and benefits of further imaging.
---
...
**Clinical Point:** What is the role of CT angiography (CTA) in the diagnosis and management of pediatric oropharyngeal trauma?
...
**Commentary:** 
**Heterogeneity:** Heterogeneity measurements in meta-analyses help us detect variations in the included studies. The authors use the I2 statistic which they report as 0%, meaning no heterogeneity amongst the included studies. This is not surprising as the included eight studies were all retrospective cohort studies with similar methodology in this systematic review.

**Funnel Plot Asymmetry:** When we look at the in Figure 3, there’s some asymmetry there. Sources of asymmetry can include publication bias, and a tendency to publish studies with positive findings. There is also English language bias where studies with “negative” findings are published in non-English journals.
...
**Practice Variation:** There is variation in practice based on institutional policies or individual practitioners. The authors report that the use of CTA ranged in studies from 0% to 100%. Between 4-100% of cases were admitted to the hospital. Antibiotic treatment (when it was reported) ranged from 58-100%. Operative management ranged from 1-23%.
...
**Clinical Decision Making:** The problem with the included studies in this systematic review is that we can’t determine what clinical factors influenced decisions to obtain imaging, start antibiotics, admit to the hospital for observation, or pursue operative management.
