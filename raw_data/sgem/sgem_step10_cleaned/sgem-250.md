---
url: https://thesgem.com/2019/03/sgem250-scribes-i-want-to-break-free-from-the-emr/
title: "SGEM#250: Scribes – I Want to Break Free (from the EMR)"
date: 2019-03-23
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM250.mp3
download_date: 2025-08-11
summary: |
  The document discusses the impact of using scribes in emergency departments to enhance physician productivity and patient throughput. It highlights the challenges posed by electronic medical records (EMRs), which consume significant physician time and contribute to burnout, potentially affecting patient care quality. A multicenter randomized trial in Australia demonstrated that scribes increased the number of patients seen per hour by 15.9% and reduced door-to-discharge times by 19 minutes, without compromising patient safety. The study suggests that scribes can alleviate the clerical burden on physicians, allowing them to focus more on patient care, and recommends further exploration of scribe use in various healthcare settings. Despite potential biases and the need for better EMR systems, scribes offer a pragmatic solution to improve efficiency in high-volume emergency departments.
---
...
**Background:** One in ten health high-income country consultations are now in Emergency Medicine. Most emergency physicians use some form of electronic medical records (EMRs) when seeing patients. The EMR tasks we undertake are expanding rapidly, far beyond simply documenting history and physical examination and every implementation slows us down. Research by Hill et al demonstrated that an ED shift can have 4,000 clicks. Physicians are spending more time on EMRs (40%) than any other activity including direct patient care (30%). The implementation of the EMR into clinical practice represents a very large, global, medical productivity loss. It could also have a negative impact on patient care. There are studies showing that EMRs are one of the biggest causes, if not the number one cause of physician burnout. Physicians suffering from burnout provide a lower quality and safety of care. This means there is an association between EMRs and worse patient care. If we have to use EMRs, how can we improve our productivity? Scribes are individuals who help physicians by doing the clerical tasks. There is a long list of things that they do including documentation of the clinical encounter, information retrieval, and discharge preparation. Most physicians (85%) prefer working with scribes and most patients tolerate scribes being involved in the clinical encounter. They have been used in US departments for years, but are only now beginning to be used in Canada and Australia.

**Clinical Point:** What is the impact of scribes on emergency medicine physicians’ productivity and patient throughput.
...
**Key Results:** There were 12 scribes and 88 physicians working at five sites. They compared 589 scribed shifts to 3,296 non-scribed shifts. This included 5,098 scribed consultations and 23,838 non-scribed consultations. Total patients seen per hour increased with scribes.
...
- **Secondary Outcomes:**
  ...
  - The cost analysis was in favor of employing scribes, given the productivity and throughput gains
...
**SGEM Bottom Line:** Scribes could have a positive impact on productivity and patient throughput depending on your practice environment.
...
**Clinical Application:** When working with a scribe, enjoy your work and get used to being enabled to see more patients, whilst feeling like you have done less. Enable your scribe to speak up if they see anything untoward happening in the department, they may be the only one to notice it. Check every time you open the EMR that you have selected the correct patient.

**What Do I Tell the Patient?** This is John, he is what is called a scribe. His job is to organize everything you need today and write down all my instructions for the emergency team. This will help me focus on being your physician.