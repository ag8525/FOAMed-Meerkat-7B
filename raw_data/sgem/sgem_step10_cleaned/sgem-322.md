---
url: https://thesgem.com/2021/03/sgem322-txa-for-sah-wont-stop-me-now/
title: "SGEM#322: TXA for SAH – Won’t Stop Me Now"
date: 2021-03-13
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM322.mp3
download_date: 2025-08-11
summary: |
  In the context of a 58-year-old female presenting with a sudden severe headache, a CT scan confirmed subarachnoid hemorrhage (SAH), raising the Point of whether tranexamic acid (TXA) could improve outcomes. The ULTRA trial, a randomized controlled study, evaluated the efficacy of ultra-early TXA administration in patients with CT-confirmed SAH. The study concluded that TXA did not improve clinical outcomes at six months, as measured by the modified Rankin Scale, with no significant difference in primary or secondary outcomes, including mortality and adverse events. The trial's open-label design and potential selection biases were noted, and while TXA showed no superiority over usual care, the study's findings challenge its routine use in SAH management. Current practice remains unchanged, emphasizing the importance of timely neurosurgical intervention and monitoring, with TXA not recommended for routine use in SAH due to insufficient evidence of benefit.
---
...
The guest skeptic for SGEM#201 was Dr. Chris Carpenter, who literally wrote the book on the diagnostic accuracy of clinical decision instruments in the ED with Dr. Jesse Pines. The SGEM bottom line from that episode was that the Ottawa SAH Rule needs external validation, a meaningful impact analysis performed, and patient acceptability of incorporating this rule into a shared decision-making instrument before being widely adopted.

Dr. Perry did publish a prospective implementation of the Ottawa SAH Rule (*Stroke* 2019). The results demonstrated that the Ottawa SAH Rule is highly sensitive (100%) but has very poor specificity (13%). It is unclear how it performs against unstructured clinical judgment or in non-urban, tertiary care teaching hospitals.

Another issue the case brings up is whether a CT scan is good enough to rule out an SAH. The debate has historically been about whether or not you also need to get a lumbar puncture on these patients after a non-contrast CT of the head.

This brings us back to more work done by Jeff Perry. His team published a prospective cohort study that suggested if you got the CT scan done within six hours of headache onset, it was a third-generation CT scanner, and it was read by a neuroradiologist, then you did not need to get an LP to rule out an SAH (*BMJ* 2011).

There were some limitations to this observational study. Another study was done in the UK that tried to address this issue of LP post-normal CT. It found that the NNTap (number needed to tap) to diagnose one aneurysm not identified by a CT scan was 250.

The final issue the case identified was the use of TXA in treating patients with an SAH. This was a structured critical review of the 2018 TICH trial published in *The Lancet*. The primary outcome showed no superiority of TXA compared to a placebo for the mRS at 90 days. The SGEM bottom line was that TXA does not currently have evidence of improving outcomes in hemorrhagic stroke, and routine administration cannot be recommended at this time.
...
TXA has been discussed numerous times for treating a variety of conditions, including trauma, isolated traumatic brain injury, gastrointestinal bleeding, post-partum hemorrhage, and epistaxis. Although some EM docs would like to believe TXA is one of the universal duct tapes of the ED, it has mixed results.

Patients suffering an aneurysmal SAH are at risk of rebleeding, which could worsen their long-term clinical outcome and chance of death. A hypothesis raised in the previous Sprigg et al. RCT was that perhaps by treating these people earlier with TXA, they would have a patient-oriented benefit.

**Clinical Point:** Does rapid administration of tranexamic acid in patients with CT confirmed SAH improve clinical outcome?
...
- **Open Label:** The patient, investigators, and clinicians treating the patient were all aware of the patient’s inclusion in the treatment arm of the trial. This opens the study to significant biases. It’s unknown why the authors elected to pursue an open-label study instead of providing the control group with a placebo, as this would have reduced the chances for bias significantly.

- **Patient Selection:** It was not stated in the methods section that these were ED patients, but it is likely that they were. They also did not explicitly say the patients were recruited consecutively 24/7/365. Twenty patients allocated to the TXA group did not receive treatment, with nine of the twenty for "unknown" reasons. Patients were also excluded on the subjective assessment that death was imminent within 24 hours. These factors could have introduced some selection bias into the cohort of included patients.

- **Subgroup Analysis:** The authors state that their findings show that the routine use of TXA in spontaneous SAH cannot be recommended. However, the fact that their secondary outcome of excellent clinical outcome (mRS 0-2) was worse in the TXA group by a statistically significant amount is concerning.

We need to be careful not to over-interpret subgroup analyses; they should generally be considered hypothesis-generating. If the subgroup had shown a benefit of TXA, would there have been a press release, an infographic, and an appeal from authorities to implement a protocol based on a subgroup, as was seen in the CRASH-3 trial and discussed on SGEM#270?

- **Adverse Events:** It is reassuring that they did not identify a statistical increase in adverse events. There was a 4% absolute (50% relative) increase in seizures reported in the TXA-treated group compared to the standard care group. This is most likely a spurious finding and represents noise in the data. The odds ratio was 1.52 (95% CI, 1.00 to 2.33), and this was only mentioned in a table and in the text of the results section. We wonder if this finding were reversed and TXA appeared protective against seizures, would it have been highlighted?

- **External Validity:** This was a large, multicentered RCT performed in the Netherlands. The median time from onset of stroke signs/symptoms to CT scans was 93 minutes. There are many sites in Canada and the USA where it would not be possible to get a CT scan that quickly due to the lack of a local CT scanner and geography.
...
Taken together, this challenges the generalizability of this study, as other hospital systems in more rural/remote settings may have more substantial delays in patient presentation and time to aneurysm treatment. It remains unknown what role TXA might play in these other systems, as it’s possible much of the benefit in rebleeding reduction isn’t seen when the aneurysm is treated in a timelier manner.
