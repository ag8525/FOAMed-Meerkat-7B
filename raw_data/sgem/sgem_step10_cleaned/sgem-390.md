---
url: https://thesgem.com/2023/01/sgem390-i-cant-feel-my-face-when-i-have-bell-palsy-but-will-steroids-help/
title: "SGEM#390:  I Can’t Feel My Face when I Have Bell Palsy, but will Steroids Help?"
date: 2023-01-21
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM390.mp3
download_date: 2025-08-11
summary: |
  A 9-year-old girl presents with unilateral facial paralysis, clinically diagnosed as Bell palsy, a common cause of 7th nerve palsy in children. Differential diagnoses include trauma, infections, and neurological conditions, necessitating a thorough history and physical examination. The BellPIC trial investigated the efficacy of prednisolone in children with Bell palsy, finding no significant improvement in complete recovery at one month compared to placebo, though the study was underpowered. Despite the lack of robust pediatric data, corticosteroids are often used based on adult studies suggesting potential benefits. Shared decision-making with families is crucial, considering the spontaneous recovery rate and potential side effects of corticosteroids.
---
...
- **Outcome:**
  ...
  - **Secondary Outcomes:**
    ...
    - Recovery of facial function (Sunnybrook scale score = 100) at 1, 3 and 6 months. This is a scale of 1 to 100 with 0 being complete paralysis and 100 being normal function.
    ...
    - Emotional and functional wellbeing at 1, 3 and 6 months using the Pediatric Quality of Life Inventory (PedsQL) and Child Health Utility 9D (CHU9D)
    - Adverse Outcomes
...
**What Do I Tell the Patient/Parent?** You have asked a fantastic Point that I wish we knew the Point to. For adults, there are some studies that would suggest treatment with corticosteroids may improve the likelihood of complete recovery from symptoms. However, the data surrounding the use of corticosteroids to treat Bell palsy in children is limited. Many children recover spontaneously without any kind of intervention. Treatment with prednisolone may increase the chances that she will recover fully in the long term. The most common side effects of treatment with corticosteroids are increased appetite and some behavioral changes. We can decide together what you would like to do.