...
summary: |
  In the study by Prekker et al., the efficacy of video laryngoscopy (VL) versus direct laryngoscopy (DL) for tracheal intubation in critically ill adults was evaluated, revealing that VL resulted in a higher first pass success (FPS) rate compared to DL (85.1% vs 70.8%). This multi-center, pragmatic randomized controlled trial included adult patients requiring intubation in emergency departments or ICUs, excluding those with clear indications or contraindications for either method. The study highlighted that while VL improves visualization, it may complicate tube passage, especially with hyperangulated blades. Despite the higher FPS with VL, the choice of intubation method should consider the clinician's experience and comfort with the device, as operator familiarity significantly influences success rates. The study underscores the importance of using the most familiar and practiced technique, particularly for clinicians with limited intubation experience.
---
...
**Background:** We have looked at this issue of intubation multiple times. The most recent discussion was about the use of etomidate as an induction agent. The conclusion from that episode was it’s still uncertain if using etomidate decreases the patient-oriented outcome of survival with good neurologic function in critically ill patients requiring emergent endotracheal intubation.

The SGEM has also covered prehospital intubation using supraglottic devices for out-of-hospital cardiac arrests. The take-home message from those episodes was that the airway is less important in adult OHCAs. We should focus more on high-quality CPR and early defibrillation for shockable rhythms and less on the type of supraglottic airway device.

Using a bougie to increase the first pass success (FPS) rate was discussed. It showed the use of a bougie was associated with an increase in FPS. A hypothesized option of adding point of care ultrasound (POCUS) to our various methods of confirming correct placement of the endotracheal tube was covered. We felt transtracheal sonography represents a potential fast and accurate way to help confirm endotracheal tube placement in conjunction with other methods.
...
The challenging part of intubation using DL is usually visualization of the laryngeal structures while tube passage is relatively easy. Video laryngoscopes (VL) have been developed to improve the challenging part of DL, i.e., visualization.
...
The debate of DL vs VL goes back over a decade. That was an RCT from Baltimore Shock Trauma center comparing the two modalities. The primary outcome was no statistical difference in survival to hospital discharge between the two groups. The SGEM bottom line at the time was VL leads to the same outcome as DL in trauma patients. VL takes longer to accomplish and may be associated with higher mortality in patients with severe head injuries, however, this relationship will require more study to confirm.

The literature comparing FPS between DL and VL is mixed with some trials, primarily earlier ones, demonstrated either no improvement with VL or superiority with DL, and others, primarily later ones, demonstrating improvement with VL. As the availability and experience with VL have grown, the Point remains… does DL or VL use result in higher FPS.

**Clinical Point:** In adult patients needing intubation in an ED or ICU, is FPS higher with DL or VL?
...
- **Comparison:** First attempt intubation using a video laryngoscope. For VL with standard geometry blades in which direct visualization of the airway structures is possible, operators were instructed to view the video screen.
  - **Note:** The use of bougie, stylet, blade geometry in both groups was at the discretion of the treating physician. The approach to subsequent attempts was also at the discretion of the treating physician. All attempts were reported by the operator and confirmed by an independent observer who noted the number of attempts at both laryngoscopy and tube passage, duration, and adverse events.
- **Outcome:**
  ...
  - **Secondary Outcomes:** Severe complications (SpO2 < 80%, SBP <65, new/increased use of pressors, arrest, death) occurring between induction and 2 minutes after intubation. Note that the time-period to define ‘peri-intubation’ varies widely in the literature. Lack of consistency makes it hard to compare between studies.
...
- **Secondary Outcomes:** The point estimates for the various outcomes generally favored VL
...
At this point, with current trainees, VL has a clear advantage in FPS over DL. This is almost certainly a function of the operator’s familiarity and experience with VL vs DL, although visualization is clearly better with VL. Those operators with little prior overall experience or little experience with DL did better with VL. We cannot extrapolate these results to those highly experienced with DL or anesthesiology. Interestingly there were no subgroups where DL showed an advantage and only operator experience with DL resulted in a non-significant advantage for VL.
...
The difference in definitions is roughly 5% lower than the traditional definition but likely better reflects the assumed challenges with VL, particularly with a hyperangulated blade (visualization is easier but tube passage is often harder).
