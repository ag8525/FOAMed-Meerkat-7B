...
- **Firm Grasp of Indications** – Knowing when and where to scan
- **Image Generation with Interpretation** – Generating the images and knowing when the image is adequate for interpretation and data extraction
- **Integration into Clinical Care** – Making decisions based on all the data (history, physical, and PoCUS images).
High-fidelity simulation (HFS) can then be combined with PoCUS to teach residents.

**Clinical Point:** What ultrasound simulation method is preferred by trainees and instructors in high fidelity simulation?
...
**Key Results:** 25 trainees with an average pre-intervention multiple choice Point exam of 72% based on the American College of Emergency Physician’s EMSONO online exam. This means they were familiar with PoCUS
...
Trainees and instructors rated these two studied interventions superior over previous critical care ultrasound simulation with edus2 being the preferred method of the two.
...
4. **Resuscitative PoCUS Competence Model.** You give a conceptual framework illustrating the key concepts supporting the use of PoCUS simulation in HFS. Can you take us through that model?
...
**Clinical Application:** PoCUS skills are useful at the bedside in real patients and this integration into high fidelity simulation is the last step prior to using them in real patient encounters.
