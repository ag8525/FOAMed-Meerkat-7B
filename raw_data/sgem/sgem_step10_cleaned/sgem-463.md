...
summary: |
  The document discusses a case of a 3-year-old boy with suspected sepsis, highlighting the use of the newly developed Phoenix Criteria for diagnosing pediatric sepsis and septic shock. The Phoenix Criteria, which focus on respiratory, cardiovascular, coagulation, and neurologic systems, offer improved diagnostic performance over the previous IPSCC criteria, particularly in diverse resource settings. The criteria demonstrated high sensitivity and positive predictive value for in-hospital mortality and early death or ECMO. The case resolution involved treating the child for presumed sepsis with BiPAP and empiric antibiotics, followed by intubation and ICU transfer due to declining mental status. The Phoenix Criteria are not intended for screening but for identifying life-threatening organ dysfunction due to infection.
---
...
**Clinical Point:** How accurately can a new clinical decision rule (The Phoenix Sepsis Score) diagnose pediatric sepsis and septic shock in hospitalized children within the first 24 hours?
...
**Commentary:**
They collected data from over three million emergency departments, inpatient, and intensive care unit encounters from ten health systems in the United States, Colombia, Bangladesh, China, and Kenya.
...
1. **Chosen Criteria:** The final Phoenix score focuses on four organ systems: respiratory, cardiovascular, coagulation, and neurologic. Some criteria are lab criteria which certain centers may not have or may not be able to get results in a timely fashion. We’re probably not calculating PaO2/SpO2: FiO2 ratios in the emergency department. Data on the use of lactate seems mixed. Inter-rater reliability of GCS scores can be quite variable.

2. **“Suspected Infection:”** The inclusion of patients based on “suspicion” of sepsis might lead to selection bias, affecting generalizability.
*“Suspected infection” was defined as the receipt of systemic antimicrobials or antimicrobial testing. This still creates quite a degree of subjectivity and possible variation amongst providers.

3. **Generalizability:** This study used data from many institutions across the world. They had an international sample that included both high and low-resource settings. They also included children with complex healthcare needs. All of these things make the results more generalizable.
*There was some missing data from one of the lower-resourced sites, and the higher-resourced sites were all tertiary children’s hospitals. 

4. **NOT a Screening Tool:** An accompanying paper states: “The Phoenix criteria for sepsis and septic shock were intended to identify life-threatening organ dysfunction due to infection in children. They were NOT designed for screening children at risk for developing sepsis or early identification of children with suspected sepsis.”
