...
summary: |
  The document discusses the use of corticosteroids in the management of community-acquired pneumonia (CAP), highlighting a systematic review and meta-analysis by Stern et al. that evaluates their efficacy. The review indicates that corticosteroids reduce mortality and morbidity in adults with severe CAP, with a number needed to treat (NNT) of 18 to prevent one death. While corticosteroids also reduce morbidity in non-severe CAP, they do not significantly impact mortality in these cases. The review notes an increased incidence of hyperglycemia as an adverse event, but the benefits of corticosteroid therapy are considered to outweigh these risks. The study's findings are based on 17 randomized controlled trials, with a significant reduction in all-cause mortality observed in adults with severe pneumonia. The document concludes with a clinical application suggesting the use of corticosteroids as an adjunct to antibiotics in severe CAP cases, while also acknowledging limitations such as variability in corticosteroid regimens and insufficient data for certain subgroups.
---

**Reference:** Stern A et al, Corticosteroids for pneumonia (Review). Cochrane Database of Systematic Reviews. December 2017.
...
**Background:** There have been a large number of trials on steroids for a variety of conditions in the last year. The Cochrane collaboration has come out with yet another paper on our favorite panacea, the steroid. This time, it is a systematic review and meta-analysis looking at the effects of steroids in patients presenting with community-acquired pneumonia.
...
**Clinical Point:** Do steroids safely reduce morbidity and mortality in patients with community-acquired pneumonia?
...
**Key Results:** They identified 17 RCTs (n=2,264) with community-acquired pneumonia to include in this SRMA. The majority of the trials (13) were in adults with only 4 (n=310) in children. All-cause mortality was significantly reduced with corticosteroid therapy.
...
3. **Bias:** Almost all of the trials (14/17) had a high risk of reporting bias. This type of bias when the nature and direction of the results influence the dissemination of the research. There are a number of types of reporting biases (publication bias, time lag bias, duplicate publication bias, location bias, citation bias, language bias, outcome reporting bias, etc). It is well recognized that positive trials are more likely to be published and published quicker than negative trials. This type of bias can be compounded when put into a SRMA. They authors explored the possibility of small-study and publication biases using a funnel plot. No small-studies effect was demonstrated in the funnel plot analysis.
...
5. **Unknowns:** Despite this new SRMA containing more data there is still a number of unknowns:
   ...
   * The trials used a variety of corticosteroids, doses, and duration. Therefore, while the effect is consistent across different regimens it is unclear what the optimal management would be.
