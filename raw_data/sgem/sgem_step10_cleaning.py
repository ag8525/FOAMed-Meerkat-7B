...
if __name__ == "__main__":
    # --- Configuration ---
    # Set the name of the folder containing your .md files to be processed.
    SOURCE_DIRECTORY = "sgem_step9_cleaned"
    # Set the name of the folder where the final, cleaned files will be saved.
    OUTPUT_DIRECTORY = "sgem_step10_cleaned"
    # -------------------
