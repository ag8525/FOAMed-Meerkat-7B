---
url: https://thesgem.com/2023/05/sgem403-unos-dos-tres-vertigo-the-grace-3-guidelines/
title: "SGEM#403: Unos, Dos, Tres – Vertigo: The GRACE-3 Guidelines"
date: 2023-05-13
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM403_GRACE3.mp3
download_date: 2025-08-11
---
**Date:** April 12, 2023

**Reference:** Edlow et al.Guidelines for Reasonable and appropriate care in the emergency department 3 (GRACE-3): Acute dizziness and vertigo in the emergency department. [AEM May 2023](https://onlinelibrary.wiley.com/doi/ftr/10.1111/acem.14728)
...
This is an [SGEM Xtra](https://thesgem.com/the-sgem-xtra/) and #SGEMHOP combined. We have reviewed the previous two [GRACE](https://www.saem.org/publications/grace) guidelines published by the Society for Academic Emergency Medicine (SAEM). GRACE stands for Guidelines for Reasonable and Appropriate Care in the Emergency Department.

[![](https://i0.wp.com/thesgem.com/wp-content/uploads/2023/05/Screen-Shot-2023-05-11-at-18.26.53.png?resize=1024%2C383&ssl=1)](https://www.saem.org/publications/grace)This is the third GRACE project. [GRACE-1](https://onlinelibrary.wiley.com/doi/10.1111/acem.14296) tackled the common issue of recurrent low risk chest pain ([SGEM#337](https://thesgem.com/2021/07/sgem337-amazing-grace-1-how-sweet-the-guidelines-recurrent-low-risk-chest-pain-in-the-emergency-department/)). This contrasts with other guidelines that only looked at a single emergency department presentation for chest pain. And [GRACE-2](https://onlinelibrary.wiley.com/doi/10.1111/acem.14495) was about low-risk recurrent abdominal pain ([SGEM#367](https://thesgem.com/2022/05/sgem367-grace2-low-risk-recurrent-abdominal-pain/)).

Now we come to [GRACE-3](https://onlinelibrary.wiley.com/doi/ftr/10.1111/acem.14728). This time it was not a recurrent condition like chest pain or abdominal pain but rather acute vertigo or dizziness. The objective of the GRACE-3 guideline is to provide an evidence-based framework intended to support patients, clinicians, and other health-care professionals in their decisions about the evaluation and management of adult ED patients with acute dizziness who do not have an obvious central cause with frank neurological findings or an obvious general medical one.
...
* **HINTS** stands for **H**ead **I**mpulse, **N**ystagmus, and **T**est of **S**kew. It was [initially touted](https://pubmed.ncbi.nlm.nih.gov/18541870/) as a [highly sensitive](https://pubmed.ncbi.nlm.nih.gov/19762709/), specific marker for cerebellar stroke in the ED. However, study results have been mixed and there is ongoing debate about how to train for and utilize this examination in the acute care setting.

A 2021 study [1] reported that EM physicians could be trained on the HINTS and it gave a sensitivity of 97% for central vertigo ([SGEM#376](https://thesgem.com/2022/09/sgem376-i-wonder-why-she-ran-away-from-the-hints-exam/)). However, a SRMA [2] that included EM physicians showed less impressive results with a sensitivity of 83. The authors of the review felt the use of HINTS by EM physicians had *“not been shown to be sufficiently accurate to rule out a stroke*.” ([SGEM#310).](https://thesgem.com/2020/12/sgem310-i-heard-a-rumour-er-docs-are-not-great-at-the-hints-exam/)

![](https://i0.wp.com/thesgem.com/wp-content/uploads/2022/09/HINTS-scaled-e1663367751246-1024x355.jpg?resize=1024%2C355&ssl=1)

There is a clear disconnect between what is possible for emergency physicians to do and what we currently do in real life. It is possible that emergency physicians can learn to use these techniques (not only the HINTS exam, but also bedside maneuvers to diagnose and treat BPPV). This is consistent with my own anecdotal experience. What is equally clear is that without some sort of training or intentional activity to learn it, we do a pretty bad job in routine practice. Dr. Peter Johns has some great videos on [YouTube](https://www.youtube.com/c/peterjohns) to show clinicians how to do the HINTS exam. I don’t know this for sure, but I suspect that Peter, like me, picked this up by active learning, not by attending a training session.
...
![](https://i0.wp.com/thesgem.com/wp-content/uploads/2023/05/Screen-Shot-2023-04-11-at-21.48.30.png?resize=1080%2C713&ssl=1)
...
![](https://i0.wp.com/thesgem.com/wp-content/uploads/2023/05/ABCT.jpg?resize=300%2C300&ssl=1)That goes against the EM physician alphabet. A-B-C-T. We like to send these patients to the *“donut of truth”*. What this recommendation says strongly is don’t use these imaging modalities (CT or CTA) to distinguish between central and peripheral vertigo.
...
[![](https://i0.wp.com/thesgem.com/wp-content/uploads/2022/09/vertigo.png?resize=300%2C169&ssl=1)](https://thesgem.com/2022/09/sgem376-i-wonder-why-she-ran-away-from-the-hints-exam/)A Triggered episodic vestibular syndrome (t-EVS) is a clinical syndrome of transient dizziness lasting seconds to minutes and generally including features suggestive of temporary, short-lived vestibular system dysfunction (e.g., nausea, nystagmus, and postural instability). There is usually a history of recurrent attacks, but patients may initially present after a first attack.
...
Dr. Peter Johns has another great [YouTube](https://www.youtube.com/watch?v=7ePecb9azS4) video to show the Dix-Hallpike test.
...
![](https://i0.wp.com/thesgem.com/wp-content/uploads/2023/05/Dix-hall.png?resize=1066%2C1052&ssl=1)
...
See Dr. Peter Johns [YouTube](https://www.youtube.com/watch?v=kvVnEsGVLUY) video doing the Dix-Hallpike test followed with the Epley maneuver.

---

Those are the 15 recommendations. Dr. Eldow had some final thoughts:

![](https://i0.wp.com/thesgem.com/wp-content/uploads/2023/05/JONATHANA.EDLOWMD.jpg?resize=150%2C150&ssl=1)
...
![](https://i0.wp.com/thesgem.com/wp-content/uploads/2023/05/Common-errors-dizzy.png?resize=468%2C255&ssl=1)

There is also a nice diagnostic algorithm for approaching adult ED patients with acute dizziness.

**![](https://i0.wp.com/thesgem.com/wp-content/uploads/2023/05/dizzy-protocol.png?resize=1080%2C691&ssl=1)**
...
![](https://i0.wp.com/thesgem.com/wp-content/uploads/2022/09/PJohns-headshot-green-background.png?resize=150%2C150&ssl=1)

Dr. Peter Johns

Dr. Peter Johns is a vertigo expert. He has been practicing emergency medicine since 1985 and has been passionate about vertigo education for the last two decades.  He co-authored the Vertigo chapter in the current edition of Tintinalli’s emergency medicine textbook and as we have mentioned many times Peter has a [YouTube](https://www.youtube.com/c/PeterJohns) channel about vertigo that has >16,000 subscribers and five million view. He was on [SGEM#310](https://thesgem.com/2020/12/sgem310-i-heard-a-rumour-er-docs-are-not-great-at-the-hints-exam/) talking about the HINTS exam.

Listen to what Peter thinks about the GRACE-3 guidelines using this [LINK](https://thesgem.com/wp-content/uploads/2023/05/Peter-Jonhs-GRACE3-Comments.m4a).
...
Listen to the SGEM podcast to hear this weeks’ question. If you know the answer, send an email to [TheSGEM@gmail.com](mailto:TheSGEM@gmail.com). The first correct answer will receive a cool skeptical prize.
...
1. DIFFERENTIATING CENTRAL FROM PERIPHERAL CAUSES OF ACUTE VERTIGO IN AN EMERGENCY SETTING WITH THE HINTS, STANDING, AND ABCD2 TESTS: A DIAGNOSTIC COHORT STUDY. Gerlier C, et al. Acad Emerg Med. doi: 10.1111/acem.14337. July 2021. Online ahead of print
2. CAN EMERGENCY PHYSICIANS ACCURATELY RULE OUT A CENTRAL CAUSE OF VERTIGO USING THE HINTS EXAMINATION? A SYSTEMATIC REVIEW AND META-ANALYSIS.  Ohle R, et al. Acad Emerg Med. 27(9):887-896, September 2021
3. DIAGNOSTIC ACCURACY OF THE HINTS EXAM IN AN EMERGENCY DEPARTMENT: A RETROSPECTIVE CHART REVIEW Dmitriew C, et al. Acad Emerg Med. 28(4):387-393, April 2021