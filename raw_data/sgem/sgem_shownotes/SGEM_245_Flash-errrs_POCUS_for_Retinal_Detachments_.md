...
**Reference:**Gottileb, Holladay and Peksa. Point-of-Care Ocular Ultrasound for the Diagnosis of Retinal Detachment: A Systematic Review and Meta-Analysis. [AEM January 2019](https://onlinelibrary.wiley.com/doi/abs/10.1111/acem.13682).
...
![](https://i0.wp.com/thesgem.com/wp-content/uploads/2019/02/Screen-Shot-2019-02-11-at-12.59.54-PM-150x150.png?resize=150%2C150)Traditionally posterior chamber pathologies are diagnosed with direct and indirect ophthalmoscopy. However, few doctors other than ophthalmologists are sufficiently expert enough to do this examination. So, in the majority of ocular cases in the ED the examination is skipped entirely.

In the [FOTO-ED](https://www.ncbi.nlm.nih.gov/pubmed/21906202) study, ED physicians only did fundoscopy in 14% of appropriate cases. In the study trained nurse practitioners took photos of patient’s funduscopic examination and the photos were reviewed by retina specialists in 24 hours. They enrolled 350 patients, but ED physicians only examined 33 patients whose findings were unknown and in whom fundoscopy may have had a role. In all 33 the diagnosis was missed. Granted that in two-thirds the findings were not in the posterior chamber (e.g. retinopathy and optic nerve pallor) but still, this observational study showed ED physicians haven’t developed or maintained fundoscopic skills.
...
5. There was low heterogeneity for estimates of sensitivity or specificity. No6. The summary diagnostic accuracy is sufficiently precise to improve upon existing clinical decision-making models. No
...
![](https://i0.wp.com/thesgem.com/wp-content/uploads/2019/02/Screen-Shot-2019-02-15-at-4.44.31-PM.png?resize=778%2C308)

The area under the receiver operating characteristic ([ROC](https://www.medcalc.org/manual/roc-curves.php)) curve demonstrated high accuracy (0.988; 95% CI = 0.974 to 0.994) while the [heterogeneity](https://handbook-5-1.cochrane.org/chapter_9/9_5_heterogeneity.htm) was moderate (I2 = 0.59). The [funnel plot](https://handbook-5-1.cochrane.org/chapter_10/10_4_1_funnel_plots.htm) did not show evidence of [publication bias](https://handbook-5-1.cochrane.org/chapter_10/10_2_1_publication_bias.htm).

![](https://i0.wp.com/thesgem.com/wp-content/uploads/2015/04/Screen-Shot-2015-04-25-at-3.11.12-PM.png?resize=889%2C162)

**1) Methods:**They did an excellent job with their methods. They followed the [PRISMA-DTA guidelines](http://www.prisma-statement.org/documents/PRISMA%20DTA%20Checklist.pdf) and registered their review with [PROSPERO](https://www.crd.york.ac.uk/prospero/). The search was exhaustive, and they used the talents of a medical librarian. This found four studies that were not discussed in the prior systematic review and added another four studies of pretty high quality.
...
Only one of the included studies followed the [STARD criteria](https://bmjopen.bmj.com/content/6/11/e012799) (Standards for Reporting of Diagnostic Accuracy Studies). The objective of the STARD initiative is “*to improve the completeness and transparency of reporting of studies of diagnostic accuracy, to allow readers to assess the potential for bias in the study (internal validity) and to evaluate its generalisability (external validity*)”. The lack of adherence to the STARD criteria suggests that the included studies were of lower quality. Seeing as the prevalence of disease seems to be high in all of the studies, the reader can assume this could have introduced some bias.
...
![](https://i0.wp.com/thesgem.com/wp-content/uploads/2019/02/rfxfvs01jz92b8eo82g1_400x400-150x150.jpeg?resize=150%2C150)
...
* [EM:RAP](https://www.youtube.com/watch?v=gNLTZipajwM) – Ultrasound of Retinal vs Vitreous Detachment
* [Mike and Matt](https://itunes.apple.com/us/book/introduction-to-bedside-ultrasound-volume-2/id647356692?mt=11) – Introduction to Bedside Ultrasound: Volume 2
