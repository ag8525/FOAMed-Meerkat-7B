...
**Reference:**Katsanos et al. Utility of Intravenous Alteplase Prior to Endovascular Stroke Treatment: A Systematic Review and Meta-analysis of RCTs. [Neurology 2021](https://pubmed.ncbi.nlm.nih.gov/34144996/)

**Guest Skeptic:**[Dr. Michal Krawczyk](https://twitter.com/4mmk36) is in his fifth year of neurology residency at Western University in London, Ontario, Canada. He is interested in acute neurological illness, including cerebrovascular disease and epilepsy. Next year he will be beginning a Neurohospitalist fellowship at the University of Texas at Houston.

**Case:** A 70-year-old male with a past medical history of hypertension and peripheral artery disease, last seen normal 1.5 hours ago, presenting with acute onset of aphasia and right sided face and arm weakness. He has a National Institute of Health Stroke Scale ([NIHSS](https://www.mdcalc.com/nih-stroke-scale-score-nihss)) score of 7. At 1am a CT angiogram is obtained that demonstrated a left M2 occlusion, and an Alberta Stroke Program Early CT Score ([ASPECTS](https://www.mdcalc.com/alberta-stroke-program-early-ct-score-aspects)) of 10. Given the recent publications of trials assessing if mechanical thrombectomy alone is non-inferior to a bridging approach with tPA in addition to mechanical thrombectomy, you wonder whether these trials apply to your patient and what is the best course of action.
...
* [SGEM#29](https://thesgem.com/2013/03/sgem29-stroke-me-stroke-me/): Stroke Me, Stroke Me
* [SGEM#70](https://thesgem.com/2014/04/sgem70-the-secret-of-ninds-thrombolysis-for-acute-stroke/): The Secret of NINDS (Thrombolysis for Acute Stroke)
* [SGEM#85](https://thesgem.com/2014/09/sgem85-wont-get-fooled-again-tpa-for-cva/): Won’t Get Fooled Again (tPA for AIS)
* [SGEM#137](https://thesgem.com/2015/11/sgem137-a-foggy-day-endovascular-treatment-for-acute-ischemic-stroke/): A Foggy Day – Endovascular Treatment for Acute Ischemic Stroke
* [SGEM#292](https://thesgem.com/2020/05/sgem292-with-or-without-you-endovascular-treatment-with-or-without-tpa-for-large-vessel-occlusions/): With or Without You – Endovascular Treatment with or without tPA for Large Vessel Occlusions
* [SGEM#297](https://thesgem.com/2020/07/sgem297-tpa-advocates-be-like-never-gonna-give-you-up/): tPA Advocates Be Like – Never Gonna Give You Up
* [SGEM#333](https://thesgem.com/2021/06/sgem333-do-you-gotta-be-starting-something-like-tpa-before-evt/): Do you Gotta Be Starting Something – Like tPA before EVT?

Mechanical thrombectomy is indicated only for patients with large vessel occlusions (LVOs) on imaging. There were a few earlier studies on MT that failed to demonstrate superiority, but it was the study MR CLEAN published in [NEJM 2015](https://www.nejm.org/doi/full/10.1056/nejmoa1411587) that really changed practice. It was a multicenter, randomized, unblinded trial treating 500 patients with an anterior circulation LVO within six hours of symptom onset. The primary outcome was mRS 0-2 at 90 days and it showed an absolute difference of 14% favoring MT. This gives a NNT of 7.

![](https://i0.wp.com/thesgem.com/wp-content/uploads/2021/06/mr-clean.png?resize=1080%2C607&ssl=1)

Six RCTs have been published since MR CLEAN.  All supported MT and all were stopped early ([SWIFT PRIME](https://www.nejm.org/doi/full/10.1056/nejmoa1415061), [EXTEND-IA](https://www.nejm.org/doi/full/10.1056/nejmoa1414792), [REVASCAT](https://www.nejm.org/doi/full/10.1056/nejmoa1503780), [ESCAPE](https://www.nejm.org/doi/full/10.1056/nejmoa1414905), [DAWN, and](https://www.nejm.org/doi/full/10.1056/nejmoa1706442) [DEFUSE](https://www.nejm.org/doi/full/10.1056/nejmoa1713973)).
...
Recently, three randomized control non-inferior trials on this topic have been published, two from China ([DIRECT-MT](https://www.nejm.org/doi/full/10.1056/NEJMoa2001123), and [DEVT](https://jamanetwork.com/journals/jama/fullarticle/2775279)) and one from Japan ([SKIP](https://jamanetwork.com/journals/jama/fullarticle/2775278)). Two trials demonstrated non-inferiority while one trial failed to show that direct MT was non-inferior.
...
**1. External Validity:** All three trials were from Asia and as such may not be directly applicable to North American populations and healthcare systems. In one of the trials, they used 0.6mg/kg of tPA ([SKIP](https://jamanetwork.com/journals/jama/fullarticle/2775278)) instead of the standard 0.9mg/kg. This could bias the trial to finding non-inferiority. In addition, these studies were all conducted at stroke centres with MT availability and do not address a drip and ship model of care.

**2. Non-Inferiority Margins:** All three studies included in the SRMA were non-inferiority trial designs. They were asking if direct to MT was non-inferior to the standard bridging with tPA before MT. Two out of three trials ([DIRECT-MT](https://www.nejm.org/doi/full/10.1056/NEJMoa2001123) and [DEVT](https://jamanetwork.com/journals/jama/fullarticle/2775279)) the non-inferiority was met, but the non-inferiority margin was set at ≤10% absolute clinical effect in DEVT, and 20% effect size in odds ratio in DIRECT-MT. Even if non-inferiority is demonstrated, it does not mean there is no clinical benefit from a bridging approach if the non-inferiority margin is too large, which may represent a clinically important difference. Many argue that the non-inferiority claim should only be reserved when a less conservative margin of 5% is utilized. None of the trials met this less conservative margin.

![](https://i0.wp.com/thesgem.com/wp-content/uploads/2021/06/Non-inferiority.png?resize=936%2C510&ssl=1)

**3. Performance Bias:** We have discussed different forms of bias many times on the SGEM. This is the first time we have mentioned performance bias. This type of bias is defined by [Cochrane Risk of Bias (RoB) Tool](https://training.cochrane.org/handbook) as the result of *“systematic differences between groups in the care that is provided, or in exposure to factors other than the interventions of interest.”*
...
![](https://i0.wp.com/thesgem.com/wp-content/uploads/2021/05/time-is-brain.jpg?resize=150%2C150&ssl=1)The concept of *“time is brain”*is initially based on animal studies (5-7). If the middle cerebral artery (MCA) is occluded in monkeys (5) or other animals (6), the duration of ischemia is directly related to volume of infarct up to a certain time point but not longer. These experiments formed the basis of our understanding of core and penumbra physiology and defined thresholds of cerebral ischemia (7).

![](https://i0.wp.com/thesgem.com/wp-content/uploads/2021/11/Gomez_Camilo.NPI__0.jpg?resize=150%2C150&ssl=1)

Dr. Camilo Gomez

[Dr. Camilo Gomez](https://pubmed.ncbi.nlm.nih.gov/26487071/) coined the term *“time is brain”* back in 1993. He has since modified his position: *“It is no longer reasonable to believe that the effect of time on the ischaemic process represents an absolute paradigm. It is increasingly evident that the volume of injured tissue within a given interval after the est**imated time of onset shows considerable variability in large part due to the beneficial effect of a robust collateral circulation.”* [(J Stroke Cerebrovasc Dis 2018)](https://pubmed.ncbi.nlm.nih.gov/29705088/)
...
Again, we need to be careful not to over-interpret observational data. Pushing the system to go too fast can lead to increased potential harm. This has been reported in the STEMI literature in trying to reduce door-to-balloon time ([Fanari et al 2015](https://pubmed.ncbi.nlm.nih.gov/26549506/)). We do not want to be too slow or to be too fast.
...
It is true that there is a strong association, but tissue factors are probably more important than the clock. In terms of tissue viability, the patient has an [ASEPCTS](https://www.mdcalc.com/alberta-stroke-program-early-ct-score-aspects) of 10, with no early ischemic changes, that is as good as it gets.
...
![](https://i0.wp.com/thesgem.com/wp-content/uploads/2021/11/247365.png?resize=150%2C150&ssl=1)Standard working hours for emergency medicine is 24/7/365. Patients can have acute ischemic stroke at any time of day. If there is a more effective/safer therapy, why should it be only offered during *“banking hours”?* Perhaps that means that the revascularization team needs to be available 24/7/365 in a timely fashion like we have with STEMI patients. We still do not know if a drip and ship model will have a patient oriented net benefit.
...
A study published in 2017 by [Prasanna Venkatesan Eswaradass et al in CMAJ Open](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5510287/) looked at eight Canadian provinces and estimated that 84.7%-99.8% have access to a current or proposed endovascular thrombectomy site within six hours by ground EMS.
...
Intervention bias is recognized as an issue in medicine ([Foy and Filippone Yale J Biol Med 2013](https://pubmed.ncbi.nlm.nih.gov/23766747/)). They defined this type of bias as *“**bias on the part of physicians and the medical community to intervene, whether it is with drugs, diagnostic tests, non-invasive procedures, or* *surgeries, when not intervening would be a reasonable alternative.”*  It is too bad we don’t have more high-quality evidence to guide whether we should be using tPA as a bridging therapy for MT. This is not an unusual problem in medicine. There is a lack of high-quality evidence to help inform our care in emergency medicine and often need to rely upon our good clinical judgment ([Parish et al AEM 2021](https://onlinelibrary.wiley.com/doi/abs/10.1111/acem.14312)).
...
It can take over ten years for high-quality, clinically relevant information to reach the patients’ bedside ([Morris et al J RSM 2011](https://journals.sagepub.com/doi/full/10.1258/jrsm.2011.110180)). However, new practices can be adapted too quickly as we have seen with [targeted temperature management](https://thesgem.com/2021/07/sgem336-you-cant-always-get-what-you-want-ttm2-trial/) (TTM) for out-of-hospital cardiac arrest (OHCA) or [TXA for epistaxis](https://thesgem.com/2021/03/sgem321-the-times-they-are-a-changin-for-txa-in-epistaxis/).
...
**Keener Kontest:** Last weeks’ winner was Erik Iszkula. He knew the half-life of dalbavancin is longer that one week. The range is between 6 and 10 days ([Zhanel et al Drugs 2010](https://pubmed.ncbi.nlm.nih.gov/20426497/)).

Listen to the [SGEM podcast](https://podcasts.apple.com/ca/podcast/the-skeptics-guide-to-emergency-medicine/id564247833) for this weeks’ question. If you know, then send an email to thesgem@gmail.com with keener in the subject line. The first correct answer will receive a cool skeptical prize.
...
1. Menon et al; INTERRSeCT Study Investigators. Association of Clinical, Imaging, and Thrombus Characteristics With Recanalization of Visible Intracranial Occlusion in Patients With Acute Ischemic Stroke. JAMA. 2018 Sep 11;320(10):1017-1026. doi: 10.1001/jama.2018.12498. PMID: 30208455; PMCID: PMC6143104.
2. Rha JH, Saver JL. The impact of recanalization on ischemic stroke outcome: a meta-analysis. Stroke. 2007 Mar;38(3):967-73. doi: 10.1161/01.STR.0000258112.14918.24. Epub 2007 Feb 1. PMID: 17272772.
3. Emberson et al; Stroke Thrombolysis Trialists’ Collaborative Group. Effect of treatment delay, age, and stroke severity on the effects of intravenous thrombolysis with alteplase for acute ischaemic stroke: a meta-analysis of individual patient data from randomised trials. Lancet. 2014 Nov 29;384(9958):1929-35. doi: 10.1016/S0140-6736(14)60584-5. Epub 2014 Aug 5. PMID: 25106063; PMCID: PMC4441266.
4. Goyal et al. Rapid Alteplase Administration Improves Functional Outcomes in Patients With Stroke due to Large Vessel Occlusions. Stroke. 2019 Mar;50(3):645-651. doi: 10.1161/STROKEAHA.118.021840. PMID: 30760169.
5. Young et al. Early reperfusion in the anesthetized baboon reduces brain damage following middle cerebral artery occlusion: a quantitative analysis of infarction volume. Stroke. 1997 Mar;28(3):632-7; discussion 637-8. doi: 10.1161/01.str.28.3.632. Erratum in: Stroke 1997 May;28(5):1092. PMID: 9056623.
