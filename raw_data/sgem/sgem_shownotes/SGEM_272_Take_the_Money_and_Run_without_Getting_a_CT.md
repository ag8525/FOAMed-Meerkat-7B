---
url: https://thesgem.com/2019/10/sgem272-take-the-money-and-run-without-getting-at-ct/
title: "SGEM#272: Take the Money and Run without Getting a CT"
date: 2019-10-26
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM272.mp3
download_date: 2025-08-11
---
**Date:** October 22nd, 2019

**Reference:** Iyengar R et al. The Effect of Financial Incentives on Patient Decisions to Undergo Low-value Head Computed Tomography Scans. [AEM October 2019](https://onlinelibrary.wiley.com/doi/abs/10.1111/acem.13823).
...
![](https://i0.wp.com/thesgem.com/wp-content/uploads/2019/10/Screen-Shot-2019-10-20-at-7.56.50-PM-150x150.png?resize=150%2C150)
...
One way to decrease CT scans of the head is to use a clinical decision instrument like the Canadian CT Head Rule (CCHR). The SGEM covered the classic paper on the CCHR by the Legend of Emergency Medicine [Dr. Ian Stiell](https://www.google.com/search?client=safari&rls=en&q=SGEM+ian+stiell&ie=UTF-8&oe=UTF-8) on [SGEM#106](http://thesgem.com/2015/02/sgem106-o-canada-canadian-ct-head-rule-for-patients-with-minor-head-injury/).

We also recently reviewed a paper that looked at increasing the CCHR age criteria from 65 years of age to 75 years of age ([SGEM#266](https://thesgem.com/2019/09/sgem266-old-man-take-a-look-at-the-canadian-ct-head-rule-im-a-lot-like-you-were/)). The bottom line was that this paper opens the door for further research to try to narrow the criteria in the CCHR to further reduce unnecessary head CT imaging in the emergency department. However, further, high quality prospective studies are required prior to clinical application.
...
![](https://i0.wp.com/thesgem.com/wp-content/uploads/2019/10/MEURER_William4x5-150x150.jpg?resize=150%2C150)
...
![](https://i0.wp.com/thesgem.com/wp-content/uploads/2019/10/Screen-Shot-2019-10-22-at-11.40.53-AM-150x150.png?resize=150%2C150)

Jessica Winkels

Jessica Winkels is the second author on this [AEM](https://www.saem.org/publications/aem-journal) publication and also joins us on the podcast. She is a fourth-year medical student at the [University of Michigan](https://medicine.umich.edu/medschool/home). Jessica is planning on going into emergency medicine after she graduates in the spring. Publishing in AEM should certainly help with her application.
...
Although this is an RCT, it is different from our usual RCTs, and some of the questions on our check list aren’t as applicable as when we look at RCTs of therapeutic interventions. Critical appraisal is always complex, and even the two of us had to turn to a true expert in [Dr. Chris Carpenter](https://twitter.com/SAEMEBM) to determine which checklist was the most appropriate to use.![](https://i0.wp.com/thesgem.com/wp-content/uploads/2014/04/checklist-cartoon-150x150.gif?resize=150%2C150)
...
* **Secondary Outcomes****:**The results remained consistent when adjusted for various potential confounders including age, gender, race, income, level of education, and prior history of health problems.

![](https://i0.wp.com/thesgem.com/wp-content/uploads/2015/04/Screen-Shot-2015-04-25-at-3.11.12-PM.png?resize=889%2C162)

You can listen to the podcast on [iTunes](https://itunes.apple.com/ca/podcast/skeptics-guide-to-emergency/id564247833) or Google Play to hear Will and Jessica answers to our ten nerdy questions.
...
### **SGEM Bottom Line: The potential risk, the potential benefit and m**oney can influence people’s behavior in making healthcare decisions.
...
**What Do I Tell My Patient****?** I am not sure if you need a CT scan at this point.I think chance that we are missing an important injury is about 1%. A CT would catch that injury, but it exposes you to radiation, and so your risk might be 0.1%. Another option would be to stay in the ED for a couple more hours so I can keep an eye on you and perform some repeat neurologic testing.

**Keener Kontest:** There was no winner last week. In 1949 Sir Robert R. Macintosh first used a device called the gum elastic bougie as a tracheal introducer. We wanted to know what was this device designed for and what is the proper name for the device we refer to as the bougie today? The answer is the gum elastic bougie was a urinary catheter that was originally used for dilation of urethral strictures. The device we call the bougie today is correctly named the [Eschmann tracheal tube introducer](https://anesthesiology.pubs.asahq.org/article.aspx?articleid=1942135).
...
**[![](https://i0.wp.com/thesgem.com/wp-content/uploads/2018/03/AEM-Podcasts-logo2-1-300x192.png?resize=300%2C192)](https://www.saem.org/education/saem-online-academic-resources/foamed-resources/podcasts)[SGEMHOP](http://thesgem.com/the-sgem-hot-off-the-press/):** Now it is your turn SGEMers. What do you think of this episode about financial incentives and head CTs? Tweet your comments using #SGEMHOP. What questions do you have for Will, Jessica and their team? Ask them on the SGEM blog. The best social media feedback will be published in AEM.
