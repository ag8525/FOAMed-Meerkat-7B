---
url: https://thesgem.com/2014/05/sgem76-and-the-beat-goes-on-azithromycin-and-risk-of-cardiovascular-death/
title: "SGEM#76: And the Beat Goes On (Azithromycin and Risk of Cardiovascular Death)"
date: 2014-05-25
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM76.mp3
...
**Guest Skeptics:**Dr. Salim Rezaie is an Assistant Professor in the Department of Emergency Medicine and Internal Medicine at the University of Texas at San Antonio. You may better know him from his website [REBEL EM](www.rebelem.com) or twitter handle @srrezaie.
...
**Background:**[Erythromycin](http://www.ncbi.nlm.nih.gov/pubmed/9842954) and [clarithromycin](http://www.fda.gov/Safety/MedWatch/SafetyInformation/ucm258816.htm) have been shown to have an increase risk of serious cardiac arrhythmias. It was thought that [Azithromycin](http://cid.oxfordjournals.org/content/43/12/1603.long) did not share these cardio toxic effects.
...
**Article**: Ray et al. Azithromycin and the Risk of Cardiovascular Death. [NEJM](http://www.nejm.org/doi/full/10.1056/NEJMoa1003833) 2012.
...
**![checklist-cartoon](https://i0.wp.com/thesgem.com/wp-content/uploads/2014/04/checklist-cartoon-150x150.gif?resize=150%2C150)Prognostic Study Quality Checklist:**
...
3. The patients were sufficiently homogeneous with respect to prognostic risk? **Yes**
4. Objective and unbiased outcome criteria were used? **Yes**
5. The follow-up was sufficiently long and complete? **Yes**
   * Patients were followed up to 10 days of antibiotics
6. The effect was large enough and precise enough to be clinically significant? **Yes**
...
**Statistical Analysis:** [Propensity Score Model](http://www.ncbi.nlm.nih.gov/pmc/articles/PMC2553527/pdf/bjgp58-687.pdf) (PMS) = statistical analysis of observational study that tries to remove confounding factors to remove bias from the analysis by comparing a treatment arm to a non-treatment arm. Check out this good review on the topic of [PMS](http://www.umanitoba.ca/faculties/medicine/units/mchp/protocol/media/propensity_score_matching.pdf)  in observational studies from the University of Manitoba.
...
An example of correlation not equaling causation was beautifully demonstrated in a recent blog called [Spurious Correlations](http://www.tylervigen.com ). It illustrated multiple examples of very strange things that seem to have a correlation.
...
![Screen Shot 2014-05-21 at 2.31.46 PM](https://i0.wp.com/thesgem.com/wp-content/uploads/2014/05/Screen-Shot-2014-05-21-at-2.31.46-PM.png?resize=595%2C395)

In [rebuttal](http://www.nejm.org/doi/full/10.1056/NEJMc1207269) commentaries to NEJM, various company and non-conflicted reviewers caution that prior randomized controlled trials with azithromycin have not shown increased cardiovascular deaths, and that observational study results need to be interpreted with caution.  There are possible differential factors that may be more associated/causal with cardiovascular death beyond azithromycin use (eg. Chlamydia Pneumonia infection) that are not captured in these data sets.

The [Food and Drug Administration](http://www.fda.gov/drugs/drugsafety/ucm341822.htm) did issue a safety announcement after this study was published. It issues a warning that azithromycin *“can cause abnormal changes in the electrical activity of the heart that may lead to potentially fatal irregular heart rhythm”.*
...
## BillyIdolRebelYellWe promised the audience not one but two critical reviews on the SGEM this week.

## So, with a REBEL-EM yell, *“he cried more, more, more…”*

**Reference #2****:** Svanstrom H et al. Use of Azithromycin and Death from Cardiovascular Causes. [NEJM](http://www.nejm.org/doi/full/10.1056/NEJMoa1300799) 2013.
...
**![Screen Shot 2014-05-24 at 10.28.54 AM](https://i0.wp.com/thesgem.com/wp-content/uploads/2014/05/Screen-Shot-2014-05-24-at-10.28.54-AM.png?resize=604%2C243)Commentary:** This is another observational study but of the entire Danish population aged 18-64. It used similar propensity score model to remove confounding factors (bias). As discussed before observational trials showing correlation does not equal causation.
...
An [editorial](http://www.nejm.org/doi/full/10.1056/NEJMp1302726) by Mosholder et al in this same NEJM issue reaffirms that, despite concerns about QTc prolongation with azithromycin in patients with higher cardiovascular risks, it seems that macrolides are, in fact, safer than other antibiotics (eg. fluoroquinolones) in hospitalized or ambulatory patients with Community Acquired Pneumonia.

There may be other cardiovascular effects of macrolide antibiotics besides arrhythmias. [SGEM#36](http://thesgem.com/2013/05/sgem36-mac-and-ccbs/) had discussed the risk of erythromycin and clarithromycin and its association with hypotension in patients taking calcium-channel blockers. This association did not seem to extend to azithromycin.
...
**![azithromycin](https://i0.wp.com/thesgem.com/wp-content/uploads/2014/05/azithromycin.jpg?resize=240%2C210)Bottom Line:**  Azithromycin is not associated with an increased risk of cardiovascular death in a general adult population when compared to other antibiotics, provided that there is a low baseline cardiovascular risk of arrhythmia/death.
...
Dr. Salim Rezaie covered this topic on his blog [REBEL EM](http://rebelem.com/stop-prescribing-azithromycin-ed/).
