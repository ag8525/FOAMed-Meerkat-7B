...
**commentary:** **1.** **Selection Bias:** These were patients that from an ENT emergency department of a referral academic-teaching otolaryngology center. It is unclear if these represent the same patients who present to a community emergency department. You could argue that patients with more severe nose bleeds would present to this subspecialized ED. If TXA works in these cases than it should work in milder cases. Or if disease severity is lower than the impact of TXA might be less and not be statistically different from usual care.
