...
The topic of SAH has been covered before on the SGEM with these bottom lines:
  + Ottawa SAH *Tool* is not ready for prime time to rule out low risk patients from investigations.
  + In this study, one patient would be diagnosed with SAH out of every 250 patients receiving a LP who presented to the emergency department with a headache that did not have their bleed identified on CT scan. So the NNTap 250.
  + These community radiologists were just as good at reading CT heads as academic radiologists when looking for blood using a third-generation scanner. The NNTap was 760 but the one patient they did identify as a perimesencephalic non-aneurysmal SAH with a benign clinical course.
