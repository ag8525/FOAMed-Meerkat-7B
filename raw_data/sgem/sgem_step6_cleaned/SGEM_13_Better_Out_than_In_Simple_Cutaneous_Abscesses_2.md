...
**Background:** Simple**c**utaneous abscesses (SCA) are a very common presentation to the emergency department (ED).  In 2005 there were 3.3 million ED visits for SCA and the numbers are increasing faster than the total number of ED visits.
