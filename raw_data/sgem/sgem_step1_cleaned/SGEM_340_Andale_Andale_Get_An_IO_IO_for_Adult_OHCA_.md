---
url: https://thesgem.com/2021/08/sgem340-andale-andale-get-an-io-io-for-adult-ohca/
title: "SGEM#340: Andale, Andale Get An IO, IO for Adult OHCA?"
date: 2021-08-14
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM340.mp3
download_date: 2025-08-11
---

**Reference:**Daya et al. Survival After Intravenous Versus Intraosseous Amiodarone, Lidocaine, or Placebo in Out-of-Hospital Shock-Refractory Cardiac Arrest. [Circulation 2020](https://pubmed.ncbi.nlm.nih.gov/31941354/)
...
**Background:** We have covered OHCA multiple times on the SGEM. This has included the classic paper from Legend of EM Dr. Ian Stiell on BLS vs. ACLS ([SGEM#64](http://thesgem.com/2014/03/sgem64-classic-em-papers-opals-study/)), the use of mechanical CPR ([SGEM#136](http://thesgem.com/2015/11/sgem136-cpr-man-or-machine/)), and pre-hospital hypothermia ([SGEM#183](http://thesgem.com/2017/06/sgem183-dont-rinse-dont-repeat/)).

![](https://i0.wp.com/www.thesgem.com/wp-content/uploads/2016/09/high-mountains-of-the-alps-150x150.jpg?resize=150%2C150)

ALPS Trail

The issue of amiodarone vs lidocaine has also been covered on [SGEM#162](http://thesgem.com/2016/10/sgem162-not-stayin-alive-more-often-with-amiodarone-or-lidocaine-in-ohca/). This was the ALPS randomized control trial published in [NEJM 2016](https://www.ncbi.nlm.nih.gov/pubmed/27043165). The bottom line from that SGEM critical appraisal was that neither amiodarone or lidocaine were likely to provide a clinically important benefit in adult OHCA patients with refractory VF or pulseless ventricular tachycardia.

We did do an episode on IO vs IV access for OHCA ([SGEM#231](https://www.thesgem.com/2018/09/sgem231-youre-so-vein-io-vs-iv-access-for-ohca/)). This was a critical appraisal of an observational study published in Annals of EM ([Kawano et al 2018](https://pubmed.ncbi.nlm.nih.gov/29310869/)). The key result was that significantly fewer patients had a favorable neurologic outcome in the IO group compared to the IV group. However, we must be careful not to over-interpret observational data. There could have been unmeasured confounders that explained the difference between the two groups.

In recent years there has been an effort to lower the cognitive load in the pre-hospital setting and focus resources on the interventions that positively effect patient outcomes. There has been a trend to place supraglottic devices over intubation with some evidence to support this move ([SGEM#247](https://www.thesgem.com/2019/03/sgem247-supraglottic-airways-gonna-save-you-for-an-ohca/)).  Another trend is to use IO access over IV access to free up pre-hospital providers to focus on more meaningful interventions.
...
* **Intervention:** Amiodarone, Lidocaine or placebo given IO
* **Comparison:** Amiodarone, lidocaine or placebo given IV
* **Outcome:**
  + **Primary Outcome:** Survival to hospital discharge
  + **Secondary Outcomes:** Survival to hospital admission, survival with favorable neurologic outcome (modified Rankin Scale score of 3 or less)
...
8. How precise are the results? There were wide 95% CI around the point estimate of risk ratios
...
There was no statistical difference between Amiodarone (24.4%), lidocaine (23.7%) and Placebo (21.0%) in the ALPS study. There was also no statistical difference in favourable neurologic function at discharge between groups.
...
![](https://i0.wp.com/www.thesgem.com/wp-content/uploads/2021/08/IV-IO-table-2.png?resize=1080%2C173)

* **Primary Outcome:** Survival to hospital discharge
  + Only amiodarone vs. placebo IV was statistically significant (p=0.014) \*
  + Adjusted Risk Ratio was 1.26 [95% CI, 1.06–1.50] for IV amiodarone vs placebo
  + No statistical difference for amiodarone or lidocaine compared to placebo when given IO

![](https://i0.wp.com/www.thesgem.com/wp-content/uploads/2021/08/IV-IO-table2-2.png?resize=1080%2C204)

* **Secondary Outcomes:**
  + **Survival to Hospital Admission:** Greater if drugs were given by IV compared to placebo but not with IO
  + **Survival with Favorable Neurologic Outcome:** Greater if drugs were given IV compared to placebo but not with IO
...
**2) Subgroup Analysis:**We should generally view subgroup analyses as hypothesis generating. Very few claims from RCT subgroups get tested in future trials. A study by [Wallach et al](https://pubmed.ncbi.nlm.nih.gov/28192563/) found that of 117 subgroup claims from RCT only ten percent were tested in a future study. Of those subgroup claims that were tested, zero percent confirmed the original claim.

* *“The overall trial result is usually a better guide to the direction of effect in subgroups than the apparent effect observed within a subgroup” (*[Yusuf et al JAMA 1991](https://pubmed.ncbi.nlm.nih.gov/2046134/)
...
**![](https://i0.wp.com/www.thesgem.com/wp-content/uploads/2021/08/ALPS-subgroup.png?resize=936%2C426)**
...
**Case Resolution:** You tell the paramedic that she was right to focus on high-quality CPR and defibrillation and you give an extra kudos for placing a supraglottic device on scene. When it comes to IV versus IO it is reasonable to place an IO if IV access is not practical. At this time the evidence to support IV over IO is weak and EMS providers should continue to focus on the interventions that matter most.

![](https://i0.wp.com/www.thesgem.com/wp-content/uploads/2019/02/Missy-Griffith-150x150.jpg?resize=150%2C150)

Missy Carter

**Clinical Application:** We should continue to decrease cognitive load when possible. Given the complexity of OHCA is it reasonable to give ACLS medications through the IV or IO route knowing it is unlikely that the drugs or route of administration will make a clinical difference. It is fine to use the IO route first if the IV route is not easily obtained.
...
**Keener Kontest:**Last weeks’ winner was Dr. Rob Parsons from Australia. He knew tuberculosis was previously treated by performing an iatrogenic, intentional pneumothorax to *“rest the lung?”* ([Childerhose Radiology 1936](https://pubs.rsna.org/doi/pdf/10.1148/27.6.741)).
...
[![](https://i0.wp.com/www.thesgem.com/wp-content/uploads/2021/01/SGEM-CME-Credit.png?resize=750%2C379)](https://sgem.ccme.org)
