---
url: https://thesgem.com/2019/04/sgem251-nothing-compares-to-youbecause-there-was-no-comparison-group/
title: "SGEM#251: Nothing Compares to You…Because there was No Comparison Group"
date: 2019-04-06
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM251.mp3
download_date: 2025-08-11
---

**Reference:**Connolly et al. Full Study Report of Andexanet Alfa for Bleeding Associated with Factor Xa Inhibitors. [NEJM 2019](https://www.nejm.org/doi/full/10.1056/NEJMoa1814051)
...
**Background:**More and more patients are being treated with direct oral anticoagulants (DOACs). This number will probably increase since the [AHA/ACC/HRS 2019](https://www.acc.org/~/media/Non-Clinical/Files-PDFs-Excel-MS-Word-etc/Guidelines/2019/2019-Afib-Guidelines-Made-Simple-Tool.pdf) updated guidelines for atrial fibrillation guidelines. It now contains the following recommendation:
...
One of the concerns clinicians had with DOACs was there was no way to reverse these new anti-coagulants when they were introduced. In contrast, [protamine](https://en.wikipedia.org/wiki/Protamine_sulfate) could be used for heparin and LMWH reversal and vitamin K, fresh frozen plasma and prothrombinase complex concentrate could be used to reverse coumadin ([Hunt and Levi BMJ 2018](https://www.bmj.com/content/360/bmj.j5424)).

This changed in 2015 when the [Food and Drug Administration](https://www.accessdata.fda.gov/drugsatfda_docs/nda/2015/0761025Orig1000TOC.cfm) (FDA) approved idarucizumab for the reversal of dabigatran. Dabigatran is a direct thrombin inhibitor. We covered the interim analysis of 90 patients included in a prospective cohort study by [Pollack et al NEJM 2015](https://www.ncbi.nlm.nih.gov/pubmed/26095746) on [SGEM#139](http://thesgem.com/2015/12/sgem139-one-thing-leads-to-another-idarucizumab-for-dabigatran-reversal/). Our bottom line for that episode was that idarucizumab is here (USA) and probably works but its patient-oriented efficacy and safety are still pending.

The full study cohort of 503 patients has since been published ([Pollack et al NEJM 2017](https://www.ncbi.nlm.nih.gov/pubmed/28693366)) and we are in the same place we were in 2015. Idarucizumab clearly and effectively removes dabigatran from circulation and this ought to be occasionally clinically useful. I would certainly exhaust all potential supportive and expectant management options first, as well as try to definitively confirm dabigatran as the culprit for abnormal hemostasis ([EM Lit of Note](https://www.emlitofnote.com/?p=3956)).

The FDA granted [accelerated approval](https://www.fda.gov/downloads/biologicsbloodvaccines/cellulargenetherapyproducts/approvedproducts/ucm606693.pdf) for andexanet alfa (Andexxa) in May of 2018. Andexxa is an antidote for factor Xa inhibitor like rivaroxaban, apixaban and edoxaban. It acts as a decoy and binds to the factor Xa inhibitors.

The [American College of Cardiology](https://www.acc.org/~/media/Non-Clinical/Images/Tools%20and%20Practice%20Support/Mobile%20Resources/ManageAnticoag/B18120_ManageAnticoag_App_Fact_Sheet.pdf) has published a fact sheet to provide some guidance for the use of anticoagulation reversal agents.
...
1. Did the study address a clearly focused issue? No
...
**Keener Kontest:**There were multiple correct answers to last keener questions. Clearly a lot of nerds listen to the SGEM. Marc Schieren knew the [Turing Test](https://en.wikipedia.org/wiki/Turing_test) was designed to determine, whether a computer shows signs of artificial intelligence ([Imitation Game](https://www.imdb.com/title/tt2084970/)).
...
* [First10EM:](https://first10em.com/andexanet-alfa/) Andexanet Alfa – More garbage science in the NEJM
* [EM Lit of Note:](http://www.emlitofnote.com/?p=4384) Disutility, Thy Name is ANEXXA-4
* [EMCrit:](http://emcrit.org/emcrit/issues-andexanet/) I Have Issues with Andexanet by K. Kipp, PharmD
* [St. Emlyn’s](https://www.stemlynsblog.org/jc-reversal-of-noacs-andexanet/): Reversal of DOACs with Andexanet Alfa. St.Emlyn’s
* [REBEL EM:](http://rebelem.com/annexa-4-andexanet-alfa-and-factor-xa-inhibitors/) ANNEXA-4: Andexanet Alfa and Factor Xa Inhibitors
