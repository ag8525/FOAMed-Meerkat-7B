---
url: https://thesgem.com/2021/07/sgem336-you-cant-always-get-what-you-want-ttm2-trial/
title: "SGEM#336: You Can’t Always Get What You Want – TTM2 Trial"
date: 2021-07-03
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM336.mp3
...
**Reference:** Dankiewicz et al: TTM2 Trial Investigators. Hypothermia versus Normothermia after Out-of-Hospital Cardiac Arrest. [NEJM 2021](https://www.nejm.org/doi/full/10.1056/NEJMoa2100591?rss=searchAndBrowse)
...
**Background:** Hypothermia has been a mainstay of post-arrest care after the publication of two trials in 2002 that both suggested a benefit. This trial by [Bernard](https://www.nejm.org/doi/full/10.1056/NEJMoa003289) and colleagues randomized 77 patients with an initial cardiac rhythm of ventricular fibrillation who had achieved return of spontaneous circulation (ROSC) but were persistently comatose. The trial was not truly randomized, as the groups were based on the day of the month, and they also weren’t blinded.
...
![](https://i0.wp.com/www.thesgem.com/wp-content/uploads/2013/11/cartoon_ambulance-300x255.gif?resize=300%2C255)The SGEM covered a few  trials looking at therapeutic hypothermia for OCHA in the pre-hospital setting. The bottom line is there is not good evidence that therapeutic hypothermia is superior to usual care and cannot be recommended.

* [SGEM#21](https://www.thesgem.com/2013/01/sgem21-ice-ice-baby/): Ice, Ice, Baby (Hypothermia post Cardiac Arrest)
* [SGEM#54:](https://www.thesgem.com/2017/12/sgem199-therapeutic-hypothermia-what-is-it-good-for/) Baby It’s Cold Outside (Pre-Hospital Therapeutic Hypothermia in Out of Hospital Cardiac Arrest)
* [SGEM#183](https://www.thesgem.com/2017/06/sgem183-dont-rinse-dont-repeat/): Don’t RINSE, Don’t Repeat
...
We did a structured critical appraisal of the TTM trial on [SGEM#82](https://www.thesgem.com/2014/07/sgem82-melt-with-you-targeted-temperature-management/). The bottom line was that the trial did not demonstrate a benefit of a targeted temperature of 33C vs. 36C for survival of OHCAs.
...
4. The patients were analyzed in the groups to which they were randomized (ITT analysis). Yes
...
* **Primary** **Outcome****:** At six months, 50% of the hypothermia group and 48% of the normothermia group had died. This gives a relative risk (RR) of 1.04 (95% CI; 0.94 to 1.14); P=0.37
* **Secondary Outcomes:**At six months, 55% of both groups had a poor functional outcome (mRS 4-6). RR 1.00 (95% CI; 0.92 to 1.09)
...
**5. Importance of Skepticism:** This story arc around therapeutic hypothermia for OHCA is a great reminder of why we should be skeptical of any claim. The time to accept a claim is when there is sufficient evidence. There are many examples in medicine that show we can fall prey to intervention bias ([Foy 2013](https://pubmed.ncbi.nlm.nih.gov/23766747/)). We can be overly optimistic about small studies that are nowhere close to scientifically definitive, and quickly crown borderline practices as “*silver bullets*” or “*standard of care*”.

Think [thrombolytics](https://first10em.com/the-ongoing-thrombolytics-debate-a-response/) for acute ischemic stroke, [TXA](https://first10em.com/does-txa-work-for-everything-for-anything/) for just about anything, or cardiac [stress testing](https://first10em.com/stress-test-evidence-intro/). Science is a process that requires replication. Single studies rarely, if ever, define the “*truth*”. The overzealous adoption of medical practices can hurt our patients. Time and time again, we adopt medical interventions that are unproven. In many cases, the harms end up outweighing the benefits, but we only acknowledge this decades later, when replication studies are finally done.

Then we act shocked about *“medical reversal”* that EBM experts were predicting all along ([Prasad and Cifu 2011](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3238324/)). We spend tremendous amounts of money completely overhauling parts of the medical systems to address a specific disease, ignoring the tremendous scientific uncertainty that remains. We balk at the time and effort required to complete confirmatory RCTs, but completely ignore the much larger expenditure we make adopting (and then de-adopting) unproven practices.

This overzealous adoption of medical practices also hurts evidence-based medicine. EBM experts who point out the uncertainty are labelled as nihilists. When every [Cochrane](https://www.cochrane.org) review concludes *“more studies are needed*”, people downplay the importance of science in medicine. They argue that we would never do anything if we waited on science. But the problem is, more studies are needed (especially in medicine, where we have adopted the laughable standard of p=0.05).
...
![](https://i0.wp.com/www.thesgem.com/wp-content/uploads/2019/01/Justin-Morgenstern-e1547853552685-150x150.jpg?resize=150%2C150)
...
* [First10EM](https://first10em.com/ttm2-the-big-chill-on-therapeutic-hypothermia/): TTM2 – The Big Chill on Therapeutic Hypothermia
* [The Bottom Line:](https://www.thebottomline.org.uk/summaries/icm/ttm2/) TTM2
* [CanadiEM](https://canadiem.org/targeted-temperature-management-2/): Targeted Temperature Management 2
* [EMCrit](https://emcrit.org/pulmcrit/ttm2/): A history of hypothermia for cardiac arrest, 2002-2021 (RIP)
