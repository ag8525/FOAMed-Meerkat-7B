---
url: https://thesgem.com/2019/08/sgem264-hooked-on-a-feeling-opioid-use-and-misuse-three-months-after-emergency-department-visit-for-acute-pain/
title: "SGEM#264: Hooked On A Feeling? Opioid Use and Misuse Three Months After Emergency Department Visit for Acute Pain"
date: 2019-08-17
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM264.mp3
download_date: 2025-08-11
---

**Reference**: Daoust et al. Opioid Use and Misuse Three Months After Emergency Department Visit for Acute Pain. [AEM August 2019](https://onlinelibrary.wiley.com/doi/full/10.1111/acem.13628)
...
ED physicians are among the most frequent prescribers of opioids. (Volkow et al. [JAMA](http://jama.jamanetwork.com/article.aspx?articleid=896134) 2011). Attempting to decrease a patient’s pain to zero is certainly well-intentioned but you have to ask yourself how many patients are being harmed by such a goal?
...
ACEP has a clinical policy regarding prescribing of opioids for adult ED patients that was published in 2012 ([Cantrill et al](https://www.acep.org/globalassets/new-pdfs/clinical-policies/opioids-2012.pdf)). They suggest that opioid use be carefully individualized and time-limited; that opioids are best left for patients with severe or refractory acute pain; and that exacerbations of chronic pain not be treated with opioids.
...
You can listen to the podcast on [iTunes](https://itunes.apple.com/ca/podcast/skeptics-guide-to-emergency/id564247833) or Google Play to hear Raoul’s answers to our five nerdy questions.
...
**3) Lost to Follow-up:** Another issue is the *“lost to follow-up”*. We usually like to see less than 20% and you had 18%. I learned from [Dr. Heather Murray](https://twitter.com/HeatherM211) that when the effect size is smaller than the lost to follow-up, we should be more skeptical of the results. Do you have any information on the characteristics of those lost to follow-up compared to those who completed the study?

**4) Recall Bias:**This is a form of [cognitive bias](https://en.wikipedia.org/wiki/List_of_cognitive_biases). It has been defined as *“a [systematic error](https://en.wikipedia.org/wiki/Systematic_error "Systematic error") caused by differences in the accuracy or completeness of the [recollections](https://en.wikipedia.org/wiki/Recollection "Recollection") retrieved (“recalled”) by study participants regarding events or experiences from the past”* ([Wikipedia](https://en.wikipedia.org/wiki/Recall_bias)). Is there any concern that the results are limited by recall bias?
...
Here is a link on state-by-state [opioid prescribing guidelines](https://www.affirmhealth.com/blog/opioid-prescribing-guidelines-a-state-by-state-overview) and one for the state of [Virginia](https://www.mitchell.com/mitchellnews/detail/lid/2042/virginia-adopts-opioid-prescribing-limits) specifically.
