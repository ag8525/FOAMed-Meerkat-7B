---
url: https://thesgem.com/2021/03/sgem323-momma-im-comin-home-for-outpatient-treatment-of-a-pulmonary-embolism/
title: "SGEM#323: Mama I’m Comin’ Home – For Outpatient Treatment of a Pulmonary Embolism"
date: 2021-03-20
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM323.mp3
...
**Reference:**Westafer et al. Outpatient Management of Patients Following Diagnosis of Acute Pulmonary Embolism. [AEM March 2021](https://onlinelibrary.wiley.com/doi/10.1111/acem.14181)

**Case:** You are evaluating a 48-year-old female for pleuritic chest pain. She is low risk by [Wells Criteria](https://www.mdcalc.com/wells-criteria-pulmonary-embolism) but [PERC Rule](https://www.mdcalc.com/perc-rule-pulmonary-embolism) positive because of an appendectomy last month. Her d-dimer comes back elevated, so you order a CT-PA to evaluate for pulmonary embolism (PE). The radiologist notes a distal sub-segmental PE on the right. The patient has normal vital signs and no comorbidities.

**Background:** Historically most patients with PEs have been admitted to the hospital in the USA. This is in contrast to Canada where papers in the early 2000 demonstrated the safety of out-patient management of PEs ([Kovacs](http://www.ncbi.nlm.nih.gov/pubmed/10739374)). A study from 2010 showed that half of PE patient from one centre in Ontario were safely being treated as outpatients ([Kovacs](http://www.ncbi.nlm.nih.gov/pubmed/20626624)).

![](https://i0.wp.com/www.thesgem.com/wp-content/uploads/2018/04/Jeff-Kline-lab-150x150.png?resize=150%2C150)

Dr. Jeff Kline

PE guru, creator of the PERC Rule and Editor-in-Chief of Academic Emergency Medicine, Dr. Jeff Kline, was senior author on a paper that looked at treating VTE with outpatient management using a DOAC ([Bean et al AEM 2015](https://onlinelibrary.wiley.com/doi/full/10.1111/acem.12711)). This relatively small study (n=106) reported successfully treating 51% of DVT patients and 27% of PE patients with rivaroxaban ([SGEM#126](https://www.thesgem.com/2015/07/sgem126-take-me-to-the-rivaroxaban-outpatient-treatment-of-vte/)).

Literature from the USA reports that 90% of patients diagnosed with PE are admitted ([Singer et al 2016](https://pubmed.ncbi.nlm.nih.gov/27752630/)). Another study showed less than 10% of PE patients are discharged home from the ED for out-patient therapy ([Vinson et al 2017](https://www.annemergmed.com/article/S0196-0644(17)31806-1/fulltext)).

A couple of international guidelines support the outpatient treatment of ED patients with low-risk PE. This includes the European Cardiology Society ([ECS 2019](https://watermark.silverchair.com/ehz405.pdf?token=AQECAHi208BE49Ooan9kkhW_Ercy7Dm3ZL_9Cf3qfKAc485ysgAAAqswggKnBgkqhkiG9w0BBwagggKYMIIClAIBADCCAo0GCSqGSIb3DQEHATAeBglghkgBZQMEAS4wEQQMl9n9tzeZBdx0fUZwAgEQgIICXq7vuv_pxMJ1jiYg5Nw5SXqgK5VCiltFMOlqwLyY9BH-joTi8cWXATY_XjLVSmdUE92zHi_ankcVjOnGcxx89ydZfNejwJndCFkPX7pwcX0_xH1zr3vmsB-UsAqDTl_FYFYvlUnrPGaKhfN1_GjEPsCquFTzos4pBE4fXHcIFyOg7gWqkXD0K_2EhFetIknIy-KVIAFKoOoW_Ng-A4H1AmDI-YfLoSonoUdv_HpoM4s1VTmoPQLaUGyGjib2YBNb5hI0B8ZAw2BlC1381RlXuqzp__sS24UgNTlULw5jUrXGbM3dGKVpRnEzaBd9duErBO0wT5tSb0jze4amW-NBvkRG5cycQ047AsUMALHKXqURyZwcHM0dxmdujlhXFo5Gv5_0QyvcsMHu8-4wpbxwWV_WXgZOXciMrDCHLBrYVMToRdGQz2-LkvoDbO-Pu5Tpj_5-LP7DXhVdmA59dDBw9j_fPs_tGYX-UJtJR7XySkVjyxqy3SNhj78ByzqRFoOLPQsdgJrEaVAyz2QXxm1aDOCu-gfutVk3ohLVcvD4d_yh60jShGJL_rET0Qmfiw4EwFQKQb3ctJ8TK67jZylL1CFjUZf9hz50hn5_JP97vhXnMhW9Rdi6L7HYhL2R3AIAubne2XBErN-Ih5ymIXwgHEIhY8KqrMC9E1JWQ_yC2jqzJhQ0y9BByA6Jngo1OuLM8LRacdBAVnTRODGP5YxOuv_QHMY0e2SszzPxJQtnFp9nwLB8sX0_4i6eRQVCf4plhEjH1QaRCsZ-XrJ4EHdPcMDFhGehrIpEUZD0oJNOhw)) and the British Thoracic Society ([Howard et al 2018](https://bmjopenrespres.bmj.com/content/5/1/e000281)).

The American College of Emergency Physicians (ACEP) has a clinical policy that addresses this issue ([Wolf et al 2018](https://www.annemergmed.com/article/S0196-0644(18)30224-5/fulltext)). The ACEP policy give outpatient management of PE patients a Level C recommendation:
...
![](https://i0.wp.com/www.thesgem.com/wp-content/uploads/2021/03/PESI-300x263.png?resize=300%2C263)PESI ([Pulmonary Embolism Severity Index](http://pmid.us/16020800)) is a risk stratification tool based upon studies by [Donzé et al 2008](http://pmid.us/18989542) and [Choi et al 2009](http://pmid.us/19543490).  The PESI consists of eleven criteria with a different number of points awarded for each variable. This can be complicated and there is an online calculator to help ([MDCalc PESI Score](https://www.mdcalc.com/pulmonary-embolism-severity-index-pesi)).

The PESI score has been made even easier to use with the creation of the Simplified PESI. It only has six criteria, each has only one point and can also be computed online using [MDCalc sPESI](https://www.mdcalc.com/simplified-pesi-pulmonary-embolism-severity-index).

T![](https://i0.wp.com/www.thesgem.com/wp-content/uploads/2021/03/Hestia-300x215.png?resize=300%2C215)he Hestia Criteria is another scoring system to identify low risk PE patients that could be considered for outpatient PE treatment. Like the PESI score it has eleven criteria and an online calculator ([MDCalc Hestia Criteria](https://www.mdcalc.com/hestia-criteria-outpatient-pulmonary-embolism-treatment)). If all eleven criteria are negative the patient is low risk with a predicted mortality of 0% and VTE recurrence of 2%. However, if any one of the criteria is positive the patient is not low risk. These patients are not considered eligible for outpatient management based on this score and it is recommended they be admitted for inpatient therapy.
...
![](https://i0.wp.com/www.thesgem.com/wp-content/uploads/2018/10/Lauren-150x150.png?resize=150%2C150)

Dr. Lauren Westafer

This is an [SGEMHOP](http://thesgem.com/the-sgem-hot-off-the-press/) episode which means we have the lead author on the show. Dr. Lauren Westafer is an Assistant Professor in the Department of Emergency Medicine at the University of Massachusetts Medical School – Baystate. She is the cofounder of [FOAMcast](http://www.foamcast.org/) and is a pulmonary embolism and implementation science researcher. Dr. Westafer serves as the Social Media Editor and a research methodology editor for *Annals of Emergency Medicine* and is an Associate Editor for the *NEJM Journal Watch Emergency Medicine*. She is also the newest member of the SGEMHOP faculty.
...
**![](https://i0.wp.com/www.thesgem.com/wp-content/uploads/2014/04/checklist-cartoon-150x150.gif?resize=150%2C150)Quality Checklist for** **Observational Study:**
...
**Keener Kontest:** Last weeks’ winner was another win for Dr. Steven Stelts from New Zealand. He knew that approximately 3-5% of Americans have a brain aneurysm at some point in their lifetime ([NINDS](https://www.ninds.nih.gov/Disorders/Patient-Caregiver-Education/Fact-Sheets/Cerebral-Aneurysms-Fact-Sheet)).
...
**![](https://i0.wp.com/www.thesgem.com/wp-content/uploads/2018/03/AEM-Podcasts-logo2-1-300x192.png?resize=300%2C192)SGEMHOP:** Now it is your turn SGEMers. What do you think of this episode on the outpatient management of PE patients? Tweet your comments using #SGEMHOP.  What questions do you have for Lauren and her team? Ask them on the SGEM blog. The best social media feedback will be published in AEM.

Those of you who subscribe to [Academic Emergency Medicine](http://onlinelibrary.wiley.com/journal/10.1111/(ISSN)1553-2712) can get CME credit for this podcast and article.
