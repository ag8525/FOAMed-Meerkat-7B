...
1.  We pick a manuscript in conjunction with the Editorial Boards of each journal that has been submitted, peer-reviewd, and ultimately accepted for AEM/CJEM put not published yet.
2. The SGEM then put a skeptical eye upon the manuscript using the BEEM critical appraisal tool.
...
5. The SGEM audience will get a chance to respond via the blog, twitter or on Facebook.
