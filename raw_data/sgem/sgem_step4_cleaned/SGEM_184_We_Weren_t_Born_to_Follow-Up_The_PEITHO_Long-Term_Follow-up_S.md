...
Previous trials have suggested a reduction in clinical decompensation (MAPPET-3) and long-term pulmonary hypertension (MOPETT02205-9/pdf)) in patients who are given systemic thrombolytics. The largest trial to date was the Pulmonary Embolism Thrombolysis (PEITHO) trial published in the NEJM 2014. It showed an number needed to treat (NNT) of 33 to prevent death or haemodynamic decompensation in the first 7 days but an number needed to harm (NNH) of 11 for major bleeding. The authors of the PEITHO trial conclude:
