...
**Summary:**
In the evaluation of febrile infants ≤60 days old, radiographic pneumonia is uncommon and primarily associated with respiratory distress, as demonstrated in a secondary analysis of a prospective cohort study. The study found no significant demographic differences among infants with no, possible, or definite pneumonia, but clinical signs such as tachypnea and respiratory distress were more prevalent in those with pneumonia. Elevated inflammatory markers like ANC and PCT were noted in cases of definite pneumonia, though their utility in guiding chest X-ray (CXR) decisions remains limited. The study emphasizes the importance of considering CXR in infants with clinical signs of respiratory distress, while also highlighting the overlap between pneumonia and bronchiolitis, suggesting that viral testing and clinical history can aid in differentiation. The findings support a cautious approach to CXR use, advocating for shared decision-making to balance potential harms and benefits, particularly in the absence of respiratory distress.
...
**Background:**
Pneumonia in very young children is difficult to diagnose solely through clinical examination due to symptom overlap with bronchiolitis. The absence of evidence-based guidelines for determining when to perform a chest X-ray (CXR) results in significant variability in clinical practice.

**Clinical Point:**
What factors (demographic, clinical, laboratory) are associated with radiographic pneumonia in febrile infants?
