...
summary: |
  The document discusses the inadequacy of the "cardiac box" as a predictive tool for cardiac injury from gunshot wounds (GSWs) to the thorax. The study, based on autopsy data from Fulton County, Georgia, found no significant difference in the risk of cardiac injury between GSWs inside versus outside the cardiac box, challenging the traditional reliance on this anatomical concept. The study highlights the limitations of using autopsy data, including death bias and lack of power calculation, which may affect the generalizability of the findings to living patients. Clinically, the document emphasizes that physicians should maintain a high suspicion for cardiac injury in all thoracic GSWs, regardless of their location relative to the cardiac box, and underscores the importance of rapid assessment and intervention following Advanced Trauma Life Support (ATLS) protocols.
---
...
**Background:** Penetrating trauma is a major disease burden in the United States, and gunshot wounds cause 30,000 deaths annually. As a country, penetrating trauma accounts for about 10% of all trauma cases, but at some trauma centers, it can reach much higher numbers.
...
Although it may be obvious to some that injury outside the cardiac box doesn’t rule out injury to the heart, the existence of such a tool colors our language and shifts the perceived risk in the clinician’s head. According to a recent study in the Journal of Surgical Research, 44% of all penetrating thoracic trauma patients presented to a non-trauma center (not a level 1 or level 2 ACS defined trauma center). For clinicians in these settings, use of the “cardiac box” nomenclature can have a significant impact on the perceived injuries when communicating with an on-call surgeon or when transferring the patient to another facility.
...
Unfortunately, you will still see some journals request a post-hoc power calculation mistakenly thinking it will help them distinguish between “true negatives” from “false negatives.” In other words, to differentiate between the lack of observed effect is due to an ineffective treatment or the study shows no effect because it is too small. If you understand how that is not the case you can see how doing these post-hoc power calculations can be misleading, misinterpreted, and ultimately not helpful.

4. **2D vs. 3D:** The authors used a two-dimensional definition of the cardiac box looking at the anterior and posterior surface of the thorax. However, a box is three-dimensional and there are illustrations of the cardiac box using this third dimension.
