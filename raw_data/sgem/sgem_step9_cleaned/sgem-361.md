...
summary: |
  The document discusses the prevalence of low-quality evidence in emergency medicine, highlighting that many interventions lack strong, unbiased support for improved outcomes. It critiques the reliance on underpowered and methodologically flawed studies, emphasizing the need for more robust, well-powered trials. Key findings include the limited number of interventions with high-level evidence, such as mechanical CPR and transfer for angioplasty, which show some mortality benefits. The document underscores the importance of scientific skepticism and critical appraisal in clinical practice, advocating for a balance between evidence-based medicine and clinical judgment. It concludes that while literature informs care, it should not dictate it, and emphasizes the need for ongoing research to strengthen the evidence base in emergency medicine.
---
...
- Topical anesthetic uses of 24-48 hours for mild cornea abrasions will cause blindness- No
- Epinephrine for adult out-of-hospital cardiac arrests (OHCAs) results in better neurologic outcomes – No
- TXA for intracranial hemorrhage, isolated traumatic brain injury, post-partum hemorrhage, or gastrointestinal bleed results in better primary outcomes – No
- Therapeutic hypothermia in adult OHCA saves lives – No
- Electrolyte solutions are needed in mild pediatric gastroenteritis – No
...
This lack of evidence is not isolated to cardiology. A recent study looked at the top ten elective orthopedic procedures. It was an umbrella review of meta-analyses of randomized control trials (RTCs) or other study designs if no RCTs existed (Blom et al BMJ 2021). The comparison was the clinical efficacy of the most common orthopedic procedures with no treatment, placebo, or non-operative care. The primary outcome was the quality of the evidence for each procedure. Only two out of ten common procedures, carpal tunnel decompression and total knee replacement, showed superiority over non-operative care.
...
We would expect the p-values to cluster just below 0.05 due to publication bias. Those studies reaching this low bar are more likely to be published than those that do not reach statistical significance (Hopewell et al 2008, Sune et al 2013, and Dwan et al 2013). How do you think we could make results in EM research more “robust”?

**4. Thrombolysis:** One of our “*favorite*” topics is thrombolysis for stroke, so I was interested to see what was reported in the umbrella review. Appendix S2 lists the topics of redundant MAs found in the EM literature. The total number of MAs on this subject was 3. The data supplement 1 on this subject only lists the Donaldson et al 2016 SRMA.

The conclusion from that SRMA was: *“The available data are unlikely to resolve the controversy regarding the use of intravenous thrombolysis in this population, and further randomized controlled trials are urgently required.”* This topic of thrombolysis vs no thrombolysis for stroke did not make it into table 1 (the adequately powered studies). What are your thoughts on thrombolysis for AIS?
...
Here are some of the concepts mentioned in your paper that we would like you to comment further upon:

- *“early results need to be seen with caution, as the postulated treatment benefits may diminish with additional evidence.”*
- *“given that some harms are also recognized only after substantial time has elapsed, a vigilant approach to early evidence about new interventions is warranted.”*
...
**Clinical Application:** The literature guides and informs our care but should not dictate our care. There are few interventions in EM with high-quality, unbiased evidence. We still need to apply our clinical judgment and ask the patients about their values and preferences. *“It is instructive to note that most people make patient-centered decisions every day without high-quality (e.g., RCT) evidence, and these decisions are not always wrong. Furthermore, foundational papers in EBM make it explicitly clear that EBM was never meant to exclude information derived from experience and intuition.”* (Braithwaite RS. JAMA 2013).

**What Do I Tell the Resident:** Much of what we do in emergency medicine is based upon low-quality biased evidence. We are often standing on pillars of salt and sand. Stay skeptical, develop your critical appraisal skills, and try to avoid nihilism.