...
summary: |
  A 55-year-old man with chest pain and shortness of breath was diagnosed with a segmental pulmonary embolism (PE) after an elevated d-dimer and CT scan. The case explores the feasibility of outpatient management of low-risk venous thromboembolism (VTE) patients using rivaroxaban, based on a study by Beam et al. which found low recurrence and bleeding rates in such patients. The study involved 106 patients, with 27% of PE and 51% of DVT patients managed as outpatients, showing no major bleeding events and a 3% recurrence rate post-therapy discontinuation. Despite promising results, the study's non-randomized nature and reliance on specialized anticoagulation clinics highlight the need for further research before broad implementation. The patient, deemed low-risk, opted for outpatient management with rivaroxaban after a shared decision-making process.
---
...
Historically, these patients were all admitted to hospital for initial treatment. Washington University currently discharges about 1% of PE patients (and a few more DVT patients), but are asked to do so by admitting services in 21% of cases.
This situation is different in Canada. Papers starting coming out in the early 2000s demonstrating the safety of out-patient management of PEs. A pragmatic evaluation of the ambulatory management of PEs in Canada came out in 2010. This showed 50% of patients being safely treated as out-patients.
Washington University in 2013 conducted a Knowledge Translation Journal Club on this topic with Hospitalists in an attempt to develop a mutually agreeable algorithm to those individuals appropriate for outpatient management. We developed an algorithm for outpatient management of low risk, non-pregnant, newly diagnosed PE patients that we still use today. One of our biggest uncertainties was if and how to manage these patients with newer anticoagulants.

**Clinical Question:** Can low-risk emergency department patients with acute venous thromboembolism be safely discharged home on rivaroxaban?
...
- **Population:** Low-risk adult patients with newly diagnosed PE or DVT in academic emergency department (Modified Hestia Exclusion Criteria to identify low risk patients).
  ...
  - 6. Pregnancy.
  - 7. Incarceration.
- **Intervention:** Rivaroxaban 15 mg orally twice daily x 21 days then 20 mg daily for unspecified duration. Patients optionally got a first dose of enoxaparin 1mg/kg subcutaneous.
- **Comparison:** None
...
- You report two approaches that could be difficult to replicate. You did not use a one-size-fits-all duration of rivaroxaban therapy. Instead, "we used a combination of published criteria, evidence, clinician judgment, and shared-decision making to decide the duration of anticoagulation for each patient."
