...
summary: |
  In the context of out-of-hospital cardiac arrest (OHCA), the choice between intravenous (IV) and intraosseous (IO) access for epinephrine administration remains a critical consideration, as highlighted by the Paramedic 3 Trial. This multi-center, randomized trial found no significant difference in 30-day survival rates between IO and IV access, with survival rates of 4.5% and 5.1% respectively. Despite the challenges of securing IV access in the field, the study suggests that both methods are comparable in terms of survival and neurological outcomes, although the trial faced limitations such as potential selection bias and early termination due to low enrollment. The findings emphasize the importance of focusing on high-quality CPR and early defibrillation over the choice of vascular access, as the overall impact of epinephrine on long-term outcomes remains uncertain.
---
...
**Background:** OHCA remains one of the most challenging and time-sensitive emergencies faced by prehospital and emergency medicine teams. With a survival rate to discharge often below 10% globally, rapid, effective interventions are needed to improve patient outcomes. Epinephrine has long been a cornerstone in the management of OHCA. Multiple studies have demonstrated how the administration of epinephrine can improve short-term outcomes, such as return of spontaneous circulation (ROSC). However, the evidence regarding its impact on long-term survival and neurological outcomes is mixed. Studies like PARAMEDIC-2 have raised questions about whether epinephrine’s benefits in achieving ROSC are offset by potential adverse effects on neurological recovery. One critical consideration in prehospital epinephrine administration is the method of vascular access. IV administration has been the preferred route, but securing IV access can be challenging in the field and in patients with compromised vascular systems. Intraosseous (IO) access provides an alternative in challenging clinical scenarios. However, there has been limited research comparing the efficacy of IO versus IV administration of epinephrine in terms of both survival and neurological outcomes in OHCA patients. Given these complexities, ongoing research continues to explore the most effective methods of delivering epinephrine to optimize outcomes. Recent randomized trials are now evaluating whether the speed and reliability of IO access provide significant benefits over the traditional IV route. Most EMS providers are choosing the proximal tibial as their go-to IO access. The current evidence has not given a definitive answer as to which type of access is best for OHCAs.
...
- **Secondary Outcomes:**
  ...
  - No statistical difference in survival to hospital discharge, favorable outcome or length of hospital stay

**Commentary:** 
1. **Exclusions:** Almost four thousand patients were excluded from the trial because they already had vascular access. The authors suspect it was because paramedics who were not trained in the protocol arrived first. This could have introduced a few potential biases.
