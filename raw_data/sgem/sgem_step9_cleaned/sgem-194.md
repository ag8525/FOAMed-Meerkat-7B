---
url: https://thesgem.com/2017/11/sgem194-highway-to-the-dexamethasone-for-pediatric-asthma-exacerbations/
title: "SGEM#194: Highway to the Dexamethasone – For Pediatric Asthma Exacerbations"
date: 2017-11-12
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM194a.mp3
download_date: 2025-08-11
summary: |
  A randomized trial compared single-dose oral dexamethasone to a three-day course of prednisolone for treating acute asthma exacerbations in children aged 2 to 16 in the emergency department. The study found that dexamethasone was non-inferior to prednisolone in terms of the Pediatric Respiratory Assessment Measure (PRAM) scores on day four, with no significant differences in secondary outcomes such as hospital admissions, emergency department length of stay, or return visits. Notably, dexamethasone was associated with less vomiting, a common side effect of prednisolone, which can lead to treatment failure. Despite some methodological limitations, the study supports the use of dexamethasone as a more tolerable alternative, with the potential for a second dose at 48 hours post-discharge for more severe cases. This aligns with the Canadian Guidelines, suggesting dexamethasone as a viable option for moderate asthma exacerbations.
---
...
**Background:** Until recently, prednisolone has been the standard of care for oral steroids used in the treatment of an asthma exacerbation. But this medication has a bitter taste which can make it very hard to administer to a younger child. Also, it is associated with a significant amount of vomiting and this is one of the leading reasons for treatment failure for outpatient asthma.

Dexamethasone has been widely used for a number of pediatric conditions including croup, has a longer half-life, and is much better tolerated than prednisolone.

There have been a number of recent studies that have compared prednisolone to dexamethasone for outpatient treatment of asthma. A systematic review and meta-analysis demonstrated a single or two-dose regimen of dexamethasone is as effective as a 5-day course of prednisone/prednisolone with less vomiting in the dexamethasone group.

The Canadian Guidelines now include the option of giving oral prednisolone or dexamethasone for moderate asthma.

While all these studies have shown that dexamethasone was as good as prednisolone for the treatment of asthma, of the seven randomized control trials that have been done, they all have issues with methodology and utilizing different doses of steroids.

This study was designed to address these issues and look at a single dose of dexamethasone compared to three days of prednisolone and all the patients were assessed using the Pediatric Respiratory Assessment Measure (PRAM) to control for some of these variations.
...
**Population:** All patients between the ages of 2 to 16 with a history of asthma presenting to the emergency department with an acute asthma exacerbation.
- **Excluded:** Anyone with critical or life-threatening exacerbation; varicella or HSV infection; TB exposure; fevers > 39.5C; steroid use within the last 4 weeks; those with metabolic disease; or any comorbid condition.
...
**Commentary:**
1. **Blinding:** This was an open label study. The lack of blinding could have introduced some bias. It would have been better if the participants and providers did not know what treatment they were receiving.
2. **Selection Bias:** They do not explicitly state patients were selected consecutively. In addition, some of the exclusion criteria were based on subjective assessment. There were significantly fewer boys in the dexamethasone group vs the prednisolone group (61% vs 75%). This could have been due to chance or selection bias. It is unclear if this difference in boys vs. girls would have impacted the results.
3. **Prognostic Factors:** There were higher rates of atopic dermatitis, stronger family histories for both atopic dermatitis and asthma, and higher rates of daily usage of salbutamol, in the dexamethasone group. This might have indicated that this group was sicker than the other group and could have skewed the data to make it less significant when compared to the prednisolone group.
