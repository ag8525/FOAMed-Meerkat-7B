...
summary: |
  In the context of acute, non-traumatic headaches suggestive of subarachnoid hemorrhage (SAH), the traditional diagnostic approach of non-contrast CT followed by lumbar puncture (LP) is scrutinized. A study involving 2,248 patients with negative CT scans revealed that LPs have a low diagnostic yield for SAH, with only 4% positive results and a number needed to tap (NNTap) of 250 to identify one aneurysm. The Ottawa SAH Tool, a clinical decision aid, may reduce missed SAH diagnoses but requires further validation. The study highlights the limitations of LP, including inconclusive results and potential complications, suggesting that modern multi-slice CT scans may suffice in ruling out SAH, thus questioning the necessity of routine LPs in this setting.
---
...
Dr. Jeff Perry and his team have tried to create a clinical decision tool to rule out SAH for acute headaches. The Ottawa SAH Tool contains six variables to decide if a CT scan is necessary.
...
Traditional methods of working up a SAH have been non-contrast CT followed by a lumbar puncture (LP). Dr. David Newman has questioned this dogma on his SMART-EM podcast. He suggested LPs are not always needed after a negative CT scan.
...
**Clinical Question:** In emergency department acute headache patients, how frequently does LP diagnose SAH after an unremarkable CT scan?
...
This was a retrospective study including acute, non-traumatic adult headache patients with suspected SAH presenting to one of six urban training EDs in the UK between 2006 and 2011. Eligible subjects had a non-diagnostic head CT and had a lumbar puncture performed.

**Five Limitations/Questions:**
...
**SGEM Bottom Line:** In this study, one patient would be diagnosed with SAH out of every 250 patients receiving an LP who presented to the emergency department with a headache that did not have their bleed identified on CT scan.
...
**Clinical Application:** Contrary to classic teaching, LP in the setting of acute, non-traumatic headache of <12 hours duration concerning for SAH rarely yields the elusive cerebral aneurysm diagnosis and is often falsely positive or inconclusive.
