...
summary: |
  The study by McLean et al. investigates the prevalence of interphysician weight bias, focusing on implicit, explicit, and professional biases among physicians in North America. Utilizing adapted survey instruments, including the Implicit Association Test and the Anti-fat Attitudes Questionnaire, the study found a significant presence of implicit weight bias (IWB) among physicians, with 87% of participants demonstrating bias against colleagues with obesity. Explicit weight bias (EWB) and professional weight bias (PWB) were also present, with positive correlations between these biases and factors such as male gender and increased age. The study highlights the need for implicit bias training to foster a more inclusive medical workplace, as these biases can impact professional relationships and patient care. The findings underscore the importance of addressing weight bias in the medical community to improve team dynamics and healthcare outcomes.
---
...
**Background:** We have talked about biases many times. Usually, when we use the term bias, it is in the context of something that systematically moves us away from the “truth”. Science does not make truth claims, and the term is used as a shorthand for the best point estimate of an observed effect size.
...
Implicit weight bias (IWB) was measured using the Implicit Association Test (IAT) based on work from Project Implicit which is a Harvard-based research organization. The weight bias IAT has been previously validated for the general population. This was adapted by adding the theme of physicians in the medical workplace. Project Implicit’s silhouette images of people with obesity were modified to add stethoscopes and clipboards, and adjust clothing to look like scrubs, white coats, or professional clothing. The good and bad layperson descriptor words were also replaced with words used to describe good and bad doctors, based on Stern’s medical professionalism framework.
...
The r value represents the strength of correlations. It also ranges from (-1) to (+1), with 0 representing no association, (-1) representing maximal negative association, and (+1) representing maximal positive association. Correlations simply represent the manner and extent to which two things are related. They don’t touch on causality.
...
**SGEM Bottom Line:** Forms of intraphysician bias exist, including implicit, explicit, and professional bias. It is important to recognize these biases to understand how to overcome them and keep negative impacts on patient care and physician to physician relationships from occurring.
