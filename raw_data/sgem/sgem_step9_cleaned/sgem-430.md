...
summary: |
  The DAShED study investigates the diagnostic challenges of acute aortic syndrome (AAS) in the emergency department, highlighting the condition's high mortality and frequent misdiagnosis. Despite the low incidence of AAS (0.3%) among patients presenting with potential symptoms, 7% underwent CT angiography (CTA). The study evaluates clinical decision tools (CDTs) like the Aortic Dissection Detection Risk Score (ADD-RS) and their integration with clinical gestalt and D-dimer testing, finding that CDTs did not significantly outperform clinical judgment alone. The study underscores the need for improved diagnostic strategies to prevent delays and misdiagnoses, as current CDTs are not yet sufficiently reliable. The case resolution emphasizes the importance of clinical gestalt in suspecting AAS, leading to a CTA that confirmed a thoracic aortic dissection, necessitating urgent surgical intervention.
---
...
**Background:** The diagnosis of acute aortic syndrome (AAS) is commonly delayed or missed in the ED. AAS has been referred to as the *“lethal triad”* that incorporates aortic dissection (AD), intramural hematoma (IMH), and penetrating aortic ulcer (PAU). It is a rare condition with a high mortality rate and can present in atypical ways. It affects approximately 4,000 people per year in the United Kingdom and 43,000 to 47,000 people per year in the USA. The annual incidence rate of AD ranges between 2.9 and 7.2 per 100,000.

The misdiagnosis rate is estimated to be between 16% and 38% with a diagnostic delay of up to 24 hours for 25% of cases, and mortality follows a linear increase of 0.5% per hour in the first 48 hours.
...
When looking specifically at atraumatic chest pain presentations to the ED, it is estimated the incidence of AAS is one in 980. The gold standard for diagnosing AAS is to perform a CT aorta angiogram (CTA). However, scanning everyone chest pain patient would have a very low diagnostic yield, expose many patients to unnecessary ionizing radiation and end up being very costly. It would be great if there was a validated clinical decision tool (CDT) to help clinicians be more selective in using CTA to diagnose AAS.

Some CDTs have been devised and tested for diagnosing AAS. The Aortic Dissection Detection Risk Score (ADD-RS) is one CDT that has been derived and tested. Four studies with methodologic limitations were included in an SRMA of the ADD-RS and published in AEM 2020. The authors concluded that patients with an ADD-RS score of ≤ 1 with d-dimer < 500 ng/mL have high sensitivity for ruling out AASs. However, it is unclear if it is good enough for clinicians to use, better than clinical gestalt, and an impact analysis has not been done to determine if it would lead to fewer CTAs and d-dimers being performed.
