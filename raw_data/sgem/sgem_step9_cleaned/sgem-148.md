---
url: https://thesgem.com/2016/03/sgem148-stuck-on-you-skin-glue-for-peripheral-ivs/
title: "SGEM#148: Stuck on You – Skin Glue for Peripheral IVs"
date: 2016-03-13
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM148.mp3
download_date: 2025-08-11
summary: |
  The document discusses the use of skin glue to secure peripheral intravenous (IV) catheters in the emergency department (ED) to reduce failure rates. A randomized controlled trial by Simon Bugden et al. demonstrated that applying cyanoacrylate glue to IV sites significantly decreased the failure rate from 27% to 17% at 48 hours, with a number needed to treat (NNT) of 10. The study highlights that while skin glue is effective in reducing dislodgement, its application may not be necessary for all patients, particularly those not admitted for extended periods. The trial's limitations include its single-center design, exclusion of certain patient groups, and lack of cost analysis. Despite these limitations, the study supports considering skin glue for high-stakes IVs where catheter retention is critical.
---
...
We still need to question whether we need to place as many IVs in the ED as we do. A paper reviewed on the St.Emlyn’s website back in 2013 showed that in an Australian ED fewer than 60% of peripheral IVs were used for anything more than taking blood. So clearly they are not as high stakes as our CVC and arterial lines.
...
- **Primary Outcome:** Failure rate at 48hrs: 17% (glue) vs. 27% (standard) NNT=10
...
So on to the nerdy stuff: the bits that we need to discuss not to wreck a paper, but to understand how we can interpret the results in the paper and also its applicability to our own practice.

- **External Validity:** This is a paper from Australia, which has a similar EM practice to the UK and much of the developed world, including Canada. This means that the decisions about IVs and the reasons for their placement are likely to be similar to our practice.

- **Single Centre:** This will always limit the generalizability of the findings. We do not know much about the patients in this study; they are likely to be similar to ours, but we do not really know.

- **Most ED Patients:** We need to think deeper about the patients. The patients in this study are those admitted for more than 48 hours. That’s a subset of my patients who get IVs, and so I’m not sure that we can apply this to every patient who might need an IV at the door of the ED. The patients themselves looked similar in Table 1 in terms of their characteristics, but there are only 360 patients in that table, yet they randomized 380. It is unclear where the missing 20 are.

- **Exclusion:** They excluded agitated patients and yet suggested these patients may have benefited the most. However, agitated patients often have superhuman strength, and I am not sure a "little dab will do ya."

- **Randomization:** The randomization process itself was good in terms of the process; they used a computer-generated randomization sequence, but there is some work out there that tells us that certain sites and uses of IVs are likely predisposed to failure. For example, some studies suggest that the use of antibiotics increases the failure rate. The authors could have stratified their randomization for factors such as this, though that may have led to the need for a larger study.

- **Consecutive Patients:** This was not consecutive recruitment, and that may bias the results. Admittedly, they recruited 16 hours/day, 7 days a week, which is better than most EM studies, but there are problems with this. Firstly, patients overnight (I am guessing that’s where those missing 8 hours were) are different. Secondly, the fact that it had to be when the research nurses were present may have influenced the cases. I cannot see any data on the number of patients "screened" for inclusion in this trial, and so it is possible that patients deemed "unsuitable" for whatever reason may have had different outcomes.

- **Blinding:** As this is a therapeutic trial and an RCT, a key question is blinding, or "masking" as we like to say in my house. Ideally, in a therapeutic trial, everyone should be unaware of which group the patient has been assigned to until the very end. Now, clearly, patients and staff could not be blinded here as it is obvious who gets the glue. However, they could have blinded those doing the data analysis, just giving them the data but not telling them which group they were allocated. This is Nerd level–EXPERT but is increasingly seen in RCTs.

- **Follow-Up:** The follow-up was fantastic, at over 97%. In Virchester, we would struggle to find 97% of our patients 48 hours after seeing them in the ED! You could question the outcome measure of 48 hours, as many admitted patients require an IV for more than two days. In addition, 209/369 (57%) of patients were discharged home before being reviewed by the research nurse. These patients did not have direct visualization of their IV but rather a telephone interview with a standardized questionnaire, a chart review, and a discussion with ward staff.

- **Harm:** Harm is often underreported in studies. They did not report any incidents of adverse skin events, but patients did comment on a "pulling" feeling during removal. This seemed to occur when the glue was not wiped off properly or in patients with very hairy arms.

- **Cost:** It’s also worth mentioning that there is no assessment of cost here. Wound glue is expensive, and the wipes to remove it are similarly so. Having said that, the time, effort, and equipment required to re-site IVs are also expensive, and so there is a balance here. We simply don’t know from the data presented how that would pan out in different health economies. In the UK, the ED would bear the increased cost, and the wards would reap the benefits, with the patients stuck in the middle. Such insanities exist in the financial world of medicine, and so this would need to be a carefully negotiated intervention if we were to take it forward.

- **Effect Size and Precision:** Lastly, we need to think about the size of this study, and I think the final question on the checklist is telling. The effect size is great, really great. The failure rate in the glue group was 17% as compared to 27% in the standard care group. That is an absolute reduction of 10% and thus a number needed to treat of just 10. If this study is true, then we would save one re-siting of a cannula for every ten that we put in. That effect size is huge as compared to most of the interventions that we deliver in the ED. So it is a big effect, but sadly it is not a very precise one. If we look at the confidence intervals for the effect, they are pretty broad, ranging from an absolute risk reduction of 18% (an NNT of just over 5) through to 2% (an NNT of 50). That range would have a real impact on whether this is a worthwhile, routine ED intervention.

**Comment on authors’ conclusion compared to SGEM Conclusion:** We generally agree with the authors’ conclusions that skin glue reduces the failure rate of peripheral IVs for adult ED patients admitted to the hospital.
