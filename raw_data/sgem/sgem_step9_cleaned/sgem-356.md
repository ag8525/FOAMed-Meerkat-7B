...
This circles back to nerdy point #4 and raises another question about generalizability. If these complications are encountered in other practice settings, such as the pre-hospital setting where there are fewer resources, would the patient receive the same aggressive post-intubation management for these complications and might that change the outcomes.
