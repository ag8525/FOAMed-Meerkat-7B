...
In this case, patients with a negative CT did not always undergo an LP. Since not all patients underwent the gold standard testing this can influence the diagnostic accuracy of the test in question. In this case, the 6-hr CT may appear more accurate than it is in reality because if some SAH are missed on CT and having not undergone the LP there is the potential they will be counted as a true negative result.
