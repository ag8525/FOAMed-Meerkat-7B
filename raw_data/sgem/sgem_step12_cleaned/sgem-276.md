...
## Summary
In the emergency department setting, focused cardiac ultrasound (FOCUS) is evaluated for its utility in diagnosing pulmonary embolism (PE) in patients with abnormal vital signs, specifically those who are tachycardic or hypotensive. The study by Daley et al. found that FOCUS has a sensitivity of 92% for detecting PE in patients with a heart rate ≥100 bpm or systolic blood pressure <90 mmHg, and 100% sensitivity in those with a heart rate ≥110 bpm. Despite this, the specificity was only 64%, indicating that while FOCUS may help guide initial management, it lacks the diagnostic accuracy to definitively rule in or out PE. Consequently, FOCUS should be used as an adjunct to clinical judgment and not as a standalone diagnostic tool, with CT angiography remaining the gold standard for PE diagnosis. In practice, a negative FOCUS may reduce the likelihood of PE, but definitive treatment decisions should await confirmatory imaging results.
...
**Case Resolution**: Your FOCUS exam on your patient shows an essentially normal RV. You delay anticoagulation therapy at this time, choosing to await the CTA results. We face this all the time with patients needing to be transported to another facility for the CTA. This typically takes about three hours. It is my routine not to anticoagulate prior to transportation.
...
: The ultrasound I just performed tells me that you likely do not have a pulmonary embolism, and I think it’s too risky to provide anticoagulation at this time. Once the CTA results are back, we can decide on definitive therapy.
