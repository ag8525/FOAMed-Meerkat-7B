...
**Reference:**Baharoglu et al30392-0/abstract). Platelet transfusion versus standard care after acute stroke due to spontaneous cerebral haemorrhage associated with antiplatelet therapy (PATCH): a randomised, open-label, phase 3 trial. Lancet 2016.
...
1.  The study population included or focused on those in the emergency department. **Unsure**. Not explicitly stated.
...
* **Secondary Outcomes:**
  + ** **Transfusion issues (reactions and thrombotic complications: One patient had a minor transfusion reaction while there was no difference in thrombotic complicaitons (four in treatment vs. one in standard)
