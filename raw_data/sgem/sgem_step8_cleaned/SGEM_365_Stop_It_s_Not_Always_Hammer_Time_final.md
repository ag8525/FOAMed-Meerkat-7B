---
url: https://thesgem.com/2022/04/sgem365-stop-its-not-always-hammer-time/
title: "SGEM#365: Stop! It’s Not Always Hammer Time"
date: 2022-04-16
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM365.mp3
download_date: 2025-08-11
summary: |
  The document discusses the effectiveness of common elective orthopedic procedures, highlighting a case of a 55-year-old man with severe tri-compartment knee arthritis. It emphasizes the limited high-quality evidence supporting the superiority of most elective orthopedic surgeries over non-operative care, with only carpal tunnel decompression and total knee replacement showing clear benefits. The document critiques the reliance on surgical interventions without robust evidence, referencing studies like the KANON trial, which found no superiority of early ACL reconstruction over rehabilitation. It underscores the importance of considering potential surgical risks and exhausting conservative treatments before opting for surgery, aligning with the American Academy of Orthopaedic Surgeons guidelines. The case resolution involves referring the patient to an orthopedic surgeon to explore treatment options, emphasizing conservative management before considering joint replacement.
---
...
**Background:** Musculoskeletal complaints are one of the most common presentations to emergency departments. Often emergency physicians are assessing, treating, and answering patients' questions about orthopedic surgical procedures. How good is the evidence for the most common elective procedures? Before we answer that question, let’s remind everyone that only a small number (2.8%) of interventions published in SRMA and relevant to emergency medicine have unbiased and strong evidence for improved outcomes. This is a broader problem in medicine. Tricoci et al. JAMA Feb 2009 looked at the ACC/AHA guidelines from 1984 to 2008. They found 53 guidelines with 7,196 recommendations. Only 11% of recommendations were considered Level A, 39% were Level B, and 50% were Level C. An update was published by Fanaroff et al in JAMA 2019. The level of high-quality evidence had not changed much when looking at the ACC/AHA guidelines from 2008-2018. There were 26 guidelines with 2,930 recommendations. Now Level A recommendations were down to 9%, Level B 50%, and Level C 41%. Time to turn our skeptical eye to the evidence for elective orthopedic procedures.

**Clinical Question:** What is the effectiveness of common elective orthopedic procedures compared with no treatment, placebo, or non-operative care?

**Reference:** Blom et al. Common elective orthopedic procedures and their clinical effectiveness: umbrella review of level 1 evidence. BMJ 2021

- **Population:** Meta-analyses of randomized controlled trials
...
- **Outcome:** Quality and quantity of evidence behind the ten most common elective orthopedic surgeries and comparisons with the strength of recommendations in relevant national clinical guidelines.
...
**Results:** The ten most common elective orthopedic procedures were identified using a literature search, an assessment of Hospital Episode Statistics procedure frequency counts, and discussions with expert orthopedic surgeons.
Ten Most Common Elective Orthopedic Procedures:
