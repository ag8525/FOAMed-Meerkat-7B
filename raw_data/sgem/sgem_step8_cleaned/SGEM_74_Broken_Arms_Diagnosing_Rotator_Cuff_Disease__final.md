---
url: https://thesgem.com/2014/05/sgem74-broken-arms-diagnosing-rotator-cuff-disease/
title: "SGEM#74: Broken Arms (Diagnosing Rotator Cuff Disease)"
date: 2014-05-11
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM74.mp3
download_date: 2025-08-11
summary: |
  The document discusses the evaluation of a 54-year-old man with shoulder pain, focusing on the likelihood of rotator cuff disease (RCD), a prevalent cause of shoulder pain. The systematic review by Hermans et al. in JAMA evaluates diagnostic tests for RCD, highlighting the painful arc test and external rotation resistance test as accurate for detecting RCD, while the external and internal rotation lag tests are most accurate for diagnosing full-thickness tears. The review notes a high prevalence of RCD in referred populations, suggesting potential verification bias and limited generalizability to emergency department settings. Management typically involves rest, ice, NSAIDs, and physical therapy, with imaging and specialist referral as needed. The study emphasizes the importance of clinical examination skills in diagnosing RCD, despite the limitations in external validity.
---
...
- Subscapularis – Some ADdcution and internally rotates the arm (upper and lower subscapular nerve C5-6)

Patients with rotator cuff disease can present with pain, loss of function, decreased range of motion, weakness, stiffness, crepitus, and difficulty sleeping.
...
- **Outcome:** Partial or full tear of rotator cuff
  ...
  - **Included Studies:** Description of history, physical or clinical tests detailing sensitivity and specificity. Use of a reference standard with diagnostic criteria pre-specified. Presentation of original data or available. Language of one of the authors (Danish, Dutch, English, French, German, Norwegian, Spanish, Swedish)
...
**Painful Arc Test:** The patient holds arm straight out at the side of their body. Examiner brings the patient’s shoulder into full ABduction. The study is positive if the patient has pain between 60-120 degrees. This indicates subacromial or rotator cuff disorder.
- +LR 3.7 (95% CI, 1.9-7.0)
- -LR 0.36 (95% CI, 0.23-0.54).

**External Rotation Lag Test:** Elbow bent 90 degrees with hand out front. Examiner passively rotates the patient’s arm to full external rotation. Positive test is when the patient is unable to maintain a position of full external rotation.
- +LR, 7.2 (95% CI, 1.7-31)
- -LR 0.57 (95% CI, 0.35-0.92)

**Internal Rotation Lag Test:** The hand is behind the back with elbow flexed 90 degrees. The arm is lifted off the back by the examiner and the patient is asked to maintain the position. Positive test is when the patient is unable to maintain the position.
- +LR, 5.6 (95% CI, 2.6-12)
- -LR 0.4 (95% CI, 0.00-0.58)

**Drop Arm Test:** The patient holds their arm straight out to the side at shoulder level. They are asked to lower the arm slowly from this ABducted position. The test is positive if the patient immediately drops the arm and complains of pain.
- +LR, 3.3 (95% CI, 1.0-11)
...
These are physical examination techniques which can be learned and done easily in the emergency department to assess and diagnose RCD. Because of the verification bias in the available studies, we are not sure how accurate these tests would be in the emergency department.

**Bottom Line:** Take an x-ray if you are concerned about bone injury or involvement. Conduct an examination you are confident in performing. Treat the patient's pain. Arrange for appropriate follow-up.

**Clinical Application:** This study will not change my clinical practice. I will get an x-ray if concerned about bone injury or involvement. Conduct my typical shoulder examination without the specialized tests. Provide appropriate pain medication. Arrange for imaging studies depending on my clinical concern and resources (US vs. MRI). Suggest follow-up with a primary care physician or specialist depending on local practice patterns.

You can also consider referring these types of patients to your friendly neighborhood physiotherapist. Remember that it can take three months to treat rotator cuff pathology with this treatment modality.

**What Do I Tell My Patient?** It appears you may have rotator cuff disease. Rest your arm, apply ice, and take some NSAIDs for the pain. Follow-up with your primary care doctor in the next week or so. If it is still sore, they may suggest getting an US here or sending you to the city for an MRI. Your doctor may suggest seeing a physiotherapist if it is not improving quickly.