---
url: https://thesgem.com/2023/08/sgem-412-i-cant-choose-from-all-the-head-injury-prediction-rules/
title: "SGEM#412: I Can’t Choose…from all the Head Injury Prediction Rules"
date: 2023-08-05
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM412.mp3
download_date: 2025-08-11
summary: |
  In evaluating the diagnostic accuracy of clinical decision rules versus physician judgment for identifying clinically important traumatic brain injuries (TBI) in children with minor head injuries, the study compared PECARN, CATCH, CHALICE, and physician practices. Conducted at a level 2 pediatric trauma center, the study found that only PECARN and physician practice achieved 100% sensitivity in detecting clinically important TBIs, with PECARN being slightly more specific. CHALICE was the most specific but less sensitive, while CATCH had the poorest specificity. The study highlighted the importance of integrating clinical decision tools with physician judgment and patient preferences, acknowledging the limitations and potential biases in the study, such as selection and verification biases. The findings suggest that while decision tools are valuable, they should complement rather than replace clinical judgment in managing pediatric head injuries.
---

**Background:** Children have big heads proportionally to their body compared to adults, which makes them more at risk of traumatic brain injury (TBI). Computerized tomography (CT) is commonly used in the emergency department in the diagnosis of TBI. However, we’re always trying to balance the potential harms and benefits in medicine. A CT scan does mean radiation to the pediatric brain, which can increase the risk of leukemia or brain cancer later. Thankfully, clinically important intracranial injuries are rare in children. So, should we CT scan children with minor head injury? Today we’re talking about three other popular clinical decision rules (PECARN, CATCH, and CHALICE). But we also want to know, how do those rules compare to physician judgment?
...
- **Outcomes:**
  ...
  - **Secondary Outcomes:** TBI on scan  
...
In summary, the enrolled group was a little bit older, with a slightly higher proportion being male, and a bit fewer having GCS of 15.
They ended up excluding another 53 mostly because they presented >24 hours from the time of injury, ending up with a total of 1,009 children included in the study.
...
**Commentary:** 
**Selection Bias:** This study had some inclusion criteria that may have led to selection bias. Specifically, the physician concern for potential TBI is very subjective. They also excluded anyone who was not seen within 24 hours with the reasoning that the risk of clinically important TBI decreases with time. 
...
**Verification Bias:** Verification bias occurs when only a proportion of the study participants receive confirmation of the diagnosis by the reference standard test (CT scan). Approximately half of the patients were discharged after initial evaluation. A third of the patients were observed for a median of three hours. The remainder underwent CT scan.
...
**Inter-Rater Reliability:** The authors looked at agreement amongst physicians on the study variables. They considered a kappa value of >0.5 to be acceptable.
There are other sources that suggest a different interpretation: values ≤ 0 as indicating no agreement and 0.01–0.20 as none to slight, 0.21–0.40 as fair, 0.41– 0.60 as moderate, 0.61–0.80 as substantial, and 0.81–1.00 as almost perfect agreement.
They looked at 180 observations total and most variables have good agreement. Worsening headache and intoxication have the lowest kappa’s of 0.49 and 0.43 respectively but there is no further discussion.
GCS only had a kappa of 0.65. Previous studies show that agreement among physicians on GCS scores is quite variable. In children, there are modifications to the GCS scoring based on age which poses additional challenges. This also potentially impacts the patients who were included in this study. Were there patients inappropriately excluded or inappropriately included if there was variation in how GCS was determined amongst physicians?
...
**Clinical Decision “Tools”:** We know that evidence-based medicine has three pillars, clinical judgment, scientific literature, and patient/family value and preferences. There is a lot of room for shared decision making here.
