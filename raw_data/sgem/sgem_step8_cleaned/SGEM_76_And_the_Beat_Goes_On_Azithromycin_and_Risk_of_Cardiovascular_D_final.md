...
summary: |
  A 56-year-old man with community-acquired pneumonia and a penicillin allergy was considered for azithromycin treatment, raising concerns about its cardiovascular safety. Recent studies, including Ray et al. (NEJM 2012), suggest a small increase in cardiovascular deaths with azithromycin, particularly in patients with high baseline cardiovascular risk. However, a Danish study (Svanstrom et al. NEJM 2013) found no increased risk in a younger population, highlighting the importance of assessing individual cardiovascular risk. The FDA has issued warnings about azithromycin's potential to cause arrhythmias, but it remains a viable option for patients with low cardiovascular risk, especially when alternatives are limited due to allergies. In this case, after evaluating the patient's low cardiac risk, azithromycin was deemed appropriate.
---
...
**Background:** Erythromycin and clarithromycin have been shown to have an increased risk of serious cardiac arrhythmias. It was thought that Azithromycin did not share these cardiotoxic effects.

Some recent literature has called into question whether or not azithromycin can lead to serious cardiac arrhythmias and/or death.
...
**Statistical Analysis:** Propensity Score Model (PMS) = statistical analysis of observational study that tries to remove confounding factors to remove bias from the analysis by comparing a treatment arm to a non-treatment arm.
...
- Risk of cardiovascular death from Azithromycin use (5 days of treatment) vs. no antibiotics = RR 2.85 (CI 1.13 – 7.24), but this may be attributable to the increased risk of death associated with acute infection
...
**Commentary:** This is another observational study but of the entire Danish population aged 18-64. It used a similar propensity score model to remove confounding factors (bias). As discussed before, observational trials showing correlation does not equal causation.

This study seems to find the opposite to the previous study by Ray et al which showed a higher risk of cardiovascular death with the use of azithromycin. This effect, however, seemed to be linked to higher cardiovascular risk profiles in that US Medicaid cohort (up to age 74), who were not included in this younger Danish population study.
...
Local guidelines, pathogen isolates frequencies, and resistance patterns should be coupled to the patient's cardiovascular risk profile to make the best choice about azithromycin usage. Consider the potential risks and potential benefit when prescribing antibiotics:
