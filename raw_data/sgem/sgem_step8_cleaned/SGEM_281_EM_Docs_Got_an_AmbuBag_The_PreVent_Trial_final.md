---
url: https://thesgem.com/2020/01/sgem281-em-docs-got-an-ambubag-the-prevent-trial/
title: "SGEM#281: EM Docs Got an AmbuBag – The PreVent Trial"
date: 2020-01-25
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM281.mp3
download_date: 2025-08-11
summary: |
  In critically ill adults undergoing tracheal intubation, bag-mask ventilation (BMV) during the apneic period of rapid sequence intubation (RSI) is associated with higher oxygen saturations and a reduced incidence of severe hypoxemia compared to no ventilation, as demonstrated by Casey et al. in a study involving 401 patients. The primary outcome showed a statistically significant difference in the lowest oxygen saturation between the BMV group (96%) and the no-ventilation group (93%), with a secondary outcome indicating a lower incidence of severe hypoxemia in the BMV group (11% vs. 23%). Despite these findings, the study's limitations, including potential selection bias and differences in preoxygenation methods, raise questions about the generalizability and clinical significance of these results, particularly regarding patient-oriented outcomes such as survival with good neurologic function. Clinicians are advised to use clinical judgment in the absence of definitive evidence for the efficacy and safety of BMV during RSI.
---
...
- **Consecutive Patients:** They claim that patients were recruited consecutively. However, selection bias could have been introduced. Patients could be excluded if they required immediate intubation or if the treating clinicians felt that ventilation was indicated or contraindicated between induction and laryngoscopy.
...
- **Prognostic Factors:** A quality indicator for an RCT is that both the intervention group and control group are similar with regards to prognostic factors. There were statistical differences between the two groups with 10% more patients having pneumonia and 6% less having a gastrointestinal bleeding in the control group.

- **Treated Equally:** Another quality indicator is that both groups are treated equally except for the intervention. That was not the case in this trial. The BMV group was more likely to be preoxygenated with a BMV (40% vs 11%) while the no ventilation group was more likely to be preoxygenated with NiPPV (24% vs 16%). Preoxygenation can have an impact on the likelihood of desaturation during intubation.
...
- **DOOs, MOO and POO:** Their primary and secondary outcomes were disease-oriented outcomes (DOOs) or monitor-oriented outcomes (MOOs). The median lowest oxygen saturation and incidence of severe hypoxia are surrogate markers and do not represent a patient-oriented outcome (POO).
