...
**Background:** Use of CT scanning has increased more than 20-fold since 1980. Although the CT is certainly a valuable tool, it is likely overused in emergency medicine. CT has downstream harms, including radiation, incidental findings, over-diagnosis, financial costs, and negative impacts on emergency department throughput. Numerous clinical decision rules, such as the Canadian CT Head Rule, the NEXUS c-spine tool, the PERC Rule, and the Well’s Criteria, have been developed to help guide appropriate imaging. However, uptake and appropriate use of these tools is not universal. These authors question whether integration of a clinical decision support tool into the ordering system of the EHR would influence CT usage rates.
...
**Key Results:** There was a total of 235,858 patient visits during the study period. There was approximately a 6% decrease in targeted CTs (non-contrast head, c-spine, and CTPA) ordered during the period after the intervention.
