...
summary: |
  The document humorously explores the concept of applying evidence-based medicine principles to dating, specifically for medical professionals who may struggle with relationships due to their demanding careers. It introduces the Early Goal Directed Dating (EGDD) protocol, a playful analogy to Early Goal Directed Therapy in sepsis management, aimed at improving relationship outcomes such as marriage or cohabitation. The study, though speculative and limited by its retrospective design, suggests that early application of the EGDD algorithm may provide clarity in romantic relationships. The authors acknowledge the need for a prospective study to validate their claims, while emphasizing the importance of appropriate study design and skepticism towards evidence, even in parody studies. The narrative concludes with a fictional case resolution where the protagonist successfully applies the EGDD algorithm, highlighting the importance of communication in relationships.
---

**Case:** Jason is a fellow in Cardiology, despite knowing everything about the heart he finds himself struggling with his own. He can easily recite the path of the electrical current from the SA node, through the atria, to the AV node, through the bundle of HIS and Purkinje fibers but he becomes easily lost when required to navigate the path of a relationship. He has recently been on a couple of dates with a person of interest but doesn’t know what the next step is.
...
- **Intervention:** Derivation of the EGDD protocol and then applied in a post hoc retrospective manner
- **Comparison:** Those that were or were not in a relationship
- **Outcome:** Marriage or cohabitation

**Authors’ Conclusions:** "We conclude that the use of goal-directed dating at the earliest stages of a nascent interpersonal romantic relationship may result in more clarity and results with regards to the outcome measures of marriage or cohabitation. A prospective study on this algorithm compared to standard dating practices is needed in order to determine the veracity of our claims."
...
There were budgetary limitations which precluded a more robust study, but admittedly, a more robust study with a randomized, controlled, prospectively gathered design would require a substantial population, akin to the subject enrollment of the CRASH-2 study.

**Comment on Authors’ Conclusion Compared to SGEM Conclusion:** We agree with the author’s conclusion but we eagerly anticipate the results of the ProCESS EGDD Trial and ARISE EGDD Trial that will compare EGDD to usual dating practices in a head-to-head prospective trial.
...
- Need to pick appropriate study design – This study design may help you derive an algorithm it may not be sufficient to prove the effectiveness of an algorithm.
- Need to be skeptical of the evidence – Even parody studies.

**Case Resolution:** Jason, being up to date on the evidence-based dating literature (Johnson-Purdy nomogram and Canadian ITAD Decision Tool) and decided to apply the EGDD algorithm. He realized that the next best step was to communicate clearly with the person of interest about the status of their relationship. Together they decided that they would change their Facebook statuses and they have been progressing down the EGDD algorithm since. The authors expect an invite to their wedding.
