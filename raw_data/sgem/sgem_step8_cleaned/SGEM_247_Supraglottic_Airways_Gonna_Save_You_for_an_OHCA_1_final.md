...
title: "SGEM#247: Supraglottic Airways Gonna Save You for an OHCA? Part 1"
date: 2019-03-03
audio_url: https://media.blubrry.com/thesgem/content.blubrry.com/thesgem/SGEM247.mp3
download_date: 2025-08-11
summary: |
  The AIRWAYS-2 trial compared the use of supraglottic airway (SGA) devices to endotracheal intubation (ETI) in out-of-hospital cardiac arrest (OHCA) and found that SGA was non-inferior to ETI regarding neurological outcomes at 30 days. The study involved 9,296 patients and showed no significant difference in primary outcomes between the two groups, with a slightly higher initial ventilation success rate in the SGA group. Despite a lower first-pass success rate for ETI, the trial suggests that airway management strategy may not significantly impact patient outcomes compared to the critical importance of early defibrillation and high-quality CPR. The study highlights that while SGA devices are easier and faster to use, they do not necessarily improve patient outcomes, emphasizing the need for paramedics to focus on proven interventions like defibrillation and CPR.
---

**Reference:** Benger et al. Effect of a Strategy of a Supraglottic Airway Device vs. Tracheal Intubation During Out-of-Hospital Cardiac Arrest on Functional Outcome. The AIRWAYS-2 Randomized Clinical Trial. JAMA 2018
...
**Background:** We have covered OHCA many times. Key to survival is high-quality CPR and early defibrillation. There is no evidence for a patient-oriented benefit with epinephrine, other ACLS drugs, pre-hospital therapeutic hypothermia, or mechanical CPR. One issue we have not discussed is endotracheal intubation.
...
**Clinical Question:** Are superglottic airway devices non-inferior to endotracheal intubation in OHCA with regards to neurologic outcome?
...
**Key Results:** They enrolled 9,296 patients with OHCA. The median age was 73 years and just over 1/3 (36.3%) were women. Supraglottic airway was non-inferior to endotracheal intubation.
...
- **Cluster Randomization:** Cluster randomization trials (CRTs) have been around for a long time. Rather than randomizing individual patients, this method randomizes groups of patients to the intervention or control. There are strengths and weaknesses to any trial design. One strength is avoiding contamination between interventions when trial participants are managed within the same setting. One weakness is that CRTs have decreasing returns in power and precision as the cluster size increases. They attempted to mitigate this limitation by having a large number of clusters to increase the accuracy of the results.

- **Cross-Over:** Paramedics had the clinical freedom to adapt from their assigned treatment groups. Only 81% of patients received an advanced airway, and this was equal between groups. There was more crossover observed from the endotracheal intubation (ETI) group to the supraglottic airway (SGA) group (18.6% vs. 2.9%). To mitigate the problem of crossover, they performed an intention-to-treat (ITT) analysis.

- **Bias Against Endotracheal Intubation:** There did seem to be a bias against obtaining an advanced airway in paramedics who were randomized to the ETI group. They were less likely to perform an advanced airway (14.1% vs. 22.2%) compared to the SGA group. This bias could have impacted the results.

- **First-Pass Success:** Multiple prior studies have shown an association between increased intubation attempts and increased mortality. This trial showed a 69% success rate in the ETI group compared to an 89% success rate in the SGA group. Although this trial had a low first-pass ETI success rate (69%) compared to prior meta-analyses (91%), it’s much higher than the 51% listed in the Wang et al. trial.

- **Sensitivity and Subgroup Analyses for the Primary Outcome:** The patients who received advanced airway management (81%) were grouped by the first type of advanced airway intervention received. This accounts for crossover and excludes patients who did not receive an advanced airway. SGA insertion as the first method showed better outcomes compared to ETI (4.2 vs. 2.0), which was statistically significant. However, these subgroup analyses should be viewed only as hypothesis-generating.

**Comment on Authors’ Conclusion Compared to SGEM Conclusion:** This trial provides a large dataset suggesting that supraglottic devices are not inferior to endotracheal intubation.
